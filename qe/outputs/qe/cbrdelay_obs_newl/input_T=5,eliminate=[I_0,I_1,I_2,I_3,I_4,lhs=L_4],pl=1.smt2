...
(assert
 ...
 (let (($x39 (>= C ?x38)))
 (let (($x34 (>= L_0 0.0)))
 (and $x34 (<= I_0 ?x35) $x39 $x40 $x42 $x190 $x186 $x182 $x178 $x174 $x170 $x166 $x162 $x190 $x186 $x182 $x178 $x174 $x170 $x166 $x162 (= I_1 (ite (< (+ I_0 ?x83) ?x85) (+ I_0 ?x83) ?x85)) (= I_2 (ite (< ?x151 ?x90) ?x151 ?x90)) (= I_3 (ite (< (+ I_2 ?x83) ?x95) (+ I_2 ?x83) ?x95)) (= I_4 (ite (< ?x143 ?x100) ?x143 ?x100)) (>= S_0 (- I_0 ?x83)) (<= S_0 I_0) (>= S_1 I_0) $x108 (<= S_1 I_1) (>= S_2 I_1) $x111 (<= S_2 I_2) (>= S_3 I_2) $x114 (<= S_3 I_3) (>= S_4 I_3) $x117 (<= S_4 I_4) $x119 $x120 $x121 $x122 $x123 $x124 $x125))))))))))))))))))))))))))))))))))))))))))
 )
(check-sat)
