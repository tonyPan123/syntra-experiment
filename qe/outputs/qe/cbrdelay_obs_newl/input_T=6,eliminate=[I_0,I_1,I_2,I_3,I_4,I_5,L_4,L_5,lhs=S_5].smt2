...
(declare-fun a () Real)
(assert
 (exists ((I_0 Real) (I_1 Real) (I_2 Real) (I_3 Real) (I_4 Real) (I_5 Real) (L_4 Real) (L_5 Real) )(let ((?x110 (- A_3 L_3)))
 (let (($x148 (<= ?x110 S_4)))
 (let (($x146 (>= A_5 A_4)))
 (let (($x145 (>= A_4 A_3)))
 (let (($x144 (>= A_3 A_2)))
 ...
 (let (($x44 (>= C ?x43)))
 (let (($x39 (>= L_0 0.0)))
 (and $x39 (<= I_0 (- A_0 L_0)) $x44 $x45 $x47 $x236 $x232 $x228 $x224 $x220 $x216 $x212 $x208 $x203 $x199 $x236 $x232 $x228 $x224 $x220 $x216 $x212 $x208 $x203 $x199 (= I_1 (ite (< ?x190 ?x100) ?x190 ?x100)) (= I_2 (ite (< ?x186 ?x105) ?x186 ?x105)) (= I_3 (ite (< (+ I_2 ?x98) ?x110) (+ I_2 ?x98) ?x110)) $x181 (= I_5 (ite (< ?x174 ?x173) ?x174 ?x173)) (>= S_0 (- I_0 ?x98)) (<= S_0 I_0) (>= S_1 I_0) $x128 (<= S_1 I_1) (>= S_2 I_1) $x131 (<= S_2 I_2) (>= S_3 I_2) $x134 (<= S_3 I_3) (>= S_4 I_3) $x137 (<= S_4 I_4) (>= S_5 I_4) $x140 (<= S_5 I_5) $x142 $x143 $x144 $x145 $x146 (> (- A_4 L_4) S_4) $x148)))))))))))))))))))))))))))))))))))))))))))))))
 )
(check-sat)
