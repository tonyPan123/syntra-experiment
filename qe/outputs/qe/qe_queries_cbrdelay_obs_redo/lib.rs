...
pub fn compute_c_t_5_l_1(
    ...
    assert!(!(s[4] + l[0] + -a[1] * 1 >= RealNumRep::new(0, 1)));
    let tmp = IntervalList::new(vec![Interval::interval_upper(s[4] + -s[2] * 1)]);
    ret = ret.intersection(&tmp);
    let tmp = IntervalList::new(vec![Interval::interval_lower(-a[0] * 1 + l[0] + s[1])]);
    ret = ret.intersection(&tmp);
...
pub fn compute_b_t_5_l_1(
    ...
    assert!(-s[4] * 1 / 2 + -a[0] * 1 + l[0] + s[1] * 3 / 2 <= RealNumRep::new(0, 1));
...
pub fn compute_q_4_t_5_l_1(
    ...
    let tmp = IntervalList::new(vec![
        Interval::interval_point(RealNumRep::new(0, 1)),
        Interval::interval_upper(a[0] + -l[0] * 2 + a[4] + -s[2] * 2),
    ]);
    ret = ret.intersection(&tmp);
    if !(!(RealNumRep::new(0, 1) <= -s[4] * 1 + a[4] + -a[1] * 1 + s[2])) {
        let tmp = IntervalList::new(vec![Interval::interval_lower(RealNumRep::new(0, 1))]);
        ret = ret.intersection(&tmp);
    }
    assert!(s[4] * 1 / 2 + -s[3] * 1 + s[0] * 1 / 2 <= RealNumRep::new(0, 1));
    if !(RealNumRep::new(0, 1) <= -a[3] * 1 / 2 + a[2] + -a[1] * 1 / 2) {
        let tmp = IntervalList::new(vec![
    ...
    let tmp = IntervalList::new(vec![
        Interval::interval_point(RealNumRep::new(0, 1)),
        Interval::interval_upper(a[0] * 1 / 3 + -l[0] * 4 / 3 + a[4] + -s[3] * 4 / 3),
    ]);
    ret = ret.intersection(&tmp);
    let tmp = IntervalList::new(vec![
        Interval::interval_point(RealNumRep::new(0, 1)),
    ...
    let tmp = IntervalList::new(vec![
        Interval::interval_point(RealNumRep::new(0, 1)),
        Interval::interval_upper(a[0] * 3 + -l[0] * 4 + a[4] + -s[1] * 4),
    ]);
    ret = ret.intersection(&tmp);
    let tmp = IntervalList::new(vec![
        Interval::interval_lower(-s[4] * 1 / 2 + a[4] + -a[1] * 1 + s[1] * 1 / 2),
    ...
    let tmp = IntervalList::new(vec![
        Interval::interval_lower(s[4] + a[4] + -a[3] * 1 + -s[3] * 1),
        Interval::interval_lower(s[4] + -a[0] * 1 / 2 + l[0] * 1 / 2 + -s[3] * 1 / 2),
        Interval::interval_lower(s[4] + a[4] + -a[2] * 1 + -s[3] * 2 + s[1]),
        Interval::interval_lower(s[4] + a[4] + -a[1] * 1 + -s[3] * 3 + s[1] * 2),
    ]);
    ret = ret.intersection(&tmp);
    ...
    ret = ret.intersection(&tmp);
    if !(RealNumRep::new(0, 1) <= s[4] + -a[3] * 1 + a[2] + -s[2] * 1) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(s[4] + a[4] + -a[3] * 1 + -s[3] * 1),
    ...
    ret = ret.intersection(&tmp);
    if !((!(RealNumRep::new(0, 1) <= -a[3] * 1 + a[1] + s[3] + -s[0] * 1))
        || (!(RealNumRep::new(-5, 1) <= -a[2] * 1 + a[1])))
    {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(s[4] + a[4] + -a[1] * 1 + -s[3] * 2 + s[0]),
            Interval::interval_lower(s[4] + -a[0] * 1 / 2 + l[0] * 1 / 2 + -s[3] * 1 / 2),
    ...
    let tmp = IntervalList::new(vec![
        ...
        Interval::interval_lower(s[4] * 1 / 3 + -a[0] * 1 / 3 + l[0] * 1 / 3 + a[4] + -a[3] * 1),
    ]);
    ret = ret.intersection(&tmp);
    if !(RealNumRep::new(0, 1) <= s[4] + -a[3] * 1 + a[2] + -s[2] * 1) {
        let tmp = IntervalList::new(vec![
    ...
    ret = ret.intersection(&tmp);
    if !((RealNumRep::new(0, 1) <= -a[4] * 1 + a[3] + s[3] * 1 / 2 + -s[0] * 1 / 2)
        || (!(RealNumRep::new(-5, 1) <= -a[2] * 1 + a[1])))
    {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(s[4] + a[4] + -a[1] * 1 + -s[3] * 2 + s[0]),
...
pub fn compute_s_4_t_5_l_1(
    ...
    let tmp = IntervalList::new(vec![
        ...
        Interval::interval_lower(-a[0] * 2 + l[0] * 2 + s[1] * 3),
    ]);
    ret = ret.intersection(&tmp);
    let tmp = IntervalList::new(vec![Interval::interval_upper(
        s[3] + -l[0] * 1 + a[3] + -s[1] * 1,
    ...
    let tmp = IntervalList::new(vec![
        Interval::interval_lower(s[3] + a[3] + -a[1] * 1),
        Interval::interval_lower(-a[0] * 1 / 2 + l[0] * 1 / 2 + s[2] * 3 / 2),
    ]);
    ret = ret.intersection(&tmp);
    let tmp = IntervalList::new(vec![
        Interval::interval_lower(s[3] + a[3] + -a[1] * 1),
    ...
    ret = ret.intersection(&tmp);
    assert!(l[0] >= RealNumRep::new(0, 1));
    assert!(!(s[3] + l[0] + -a[1] * 1 >= RealNumRep::new(0, 1)));
    assert!(-a[0] * 1 + l[0] + s[0] <= RealNumRep::new(0, 1));
    assert!(-s[3] * 1 / 2 + s[0] * 1 / 2 <= RealNumRep::new(-5, 1));
    assert!(-s[3] * 1 + s[1] <= RealNumRep::new(-5, 1));
    ...
    ret = ret.intersection(&tmp);
    assert!(-a[0] * 1 + -s[3] * 1 + l[0] + s[1] * 2 <= RealNumRep::new(0, 1));
...
pub fn compute_sim_s_4_t_5_l_1(
    ...
    assert!(!(RealNumRep::new(0, 1) <= -a[0] * 1 + s[3] + l[0] + -B * 1 + -C * 1));
    if !(-C * 1 + a[2] + -a[1] * 1 <= RealNumRep::new(0, 1)) {
        let tmp = IntervalList::new(vec![Interval::interval_lower(s[3] + -B * 1 + C * 2)]);
        ret = ret.intersection(&tmp);
    }
    let tmp = IntervalList::new(vec![Interval::interval_upper(-l[0] * 1 + a[4])]);
    ret = ret.intersection(&tmp);
    ...
    ret = ret.intersection(&tmp);
    let tmp = IntervalList::new(vec![Interval::interval_upper(
        a[0] + -l[0] * 1 + B + C * 2 + a[4] + -a[2] * 1,
    )]);
    ret = ret.intersection(&tmp);
    if !(!(-a[3] * 1 + a[2] + C <= RealNumRep::new(0, 1))) {
        let tmp = IntervalList::new(vec![Interval::interval_lower(s[3] + -B * 1 + C * 2)]);
        ret = ret.intersection(&tmp);
    }
    ...
    let tmp = IntervalList::new(vec![Interval::interval_upper(s[3] + B + a[4] + -a[2] * 1)]);
    ret = ret.intersection(&tmp);
    let tmp = IntervalList::new(vec![Interval::interval_upper(
        B + C + a[4] + -a[2] * 1 + s[2],
    )]);
    ...
    ret = ret.intersection(&tmp);
    let tmp = IntervalList::new(vec![Interval::interval_upper(s[3] + B + a[3] + -a[1] * 1)]);
    ret = ret.intersection(&tmp);
    if !(!(-s[3] * 1 + -l[0] * 1 + a[1] + C + -B * 1 <= RealNumRep::new(0, 1))) {
        let tmp = IntervalList::new(vec![
    ...
    if !((RealNumRep::new(0, 1) <= -B * 1 + C * 2 + -a[3] * 1 + a[1])
        || (-l[0] * 1 + a[1] + -s[2] * 1 + -B * 1 <= RealNumRep::new(0, 1)))
    {
        let tmp = IntervalList::new(vec![Interval::interval_lower(C * 2 + s[1])]);
        ret = ret.intersection(&tmp);
    }
    if !((!(l[0] + -a[3] * 1 + C + s[2] + B <= RealNumRep::new(0, 1)))
        || (!(-l[0] * 1 + a[1] + -s[2] * 1 + -B * 1 <= RealNumRep::new(0, 1))))
    {
        let tmp = IntervalList::new(vec![Interval::interval_lower(C * 2 + s[1])]);
        ret = ret.intersection(&tmp);
    ...
    if !(!(-l[0] * 1 + a[1] + -C * 1 + -s[0] * 1 + -B * 1 <= RealNumRep::new(0, 1))) {
        let tmp = IntervalList::new(vec![
    ...
    if !((RealNumRep::new(0, 1) <= -B * 1 + C * 2 + -a[3] * 1 + a[1])
        || (-s[3] * 1 + -l[0] * 1 + a[1] + C + -B * 1 <= RealNumRep::new(0, 1)))
    {
        let tmp = IntervalList::new(vec![Interval::interval_lower(C * 3 + s[0])]);
        ret = ret.intersection(&tmp);
    }
    ...
    ret = ret.intersection(&tmp);
    if !(!(RealNumRep::new(0, 1) <= -B * 1 + C * 2 + -a[3] * 1 + a[1])) {
        let tmp = IntervalList::new(vec![Interval::interval_lower(s[3] + a[3] + -a[1] * 1)]);
        ret = ret.intersection(&tmp);
    }
    if !(-s[3] * 1 + -l[0] * 1 + a[1] + C + -B * 1 <= RealNumRep::new(0, 1)) {
        let tmp = IntervalList::new(vec![
    ...
    ret = ret.intersection(&tmp);
    assert!(-a[0] * 1 + l[0] + -C * 1 + s[1] <= RealNumRep::new(0, 1));
    assert!(-s[3] * 1 + C + s[1] <= RealNumRep::new(0, 1));
    let tmp = IntervalList::new(vec![Interval::interval_upper(a[0] + -l[0] * 1 + C * 4)]);
    ret = ret.intersection(&tmp);
    assert!(-a[0] * 1 + l[0] + s[0] <= RealNumRep::new(0, 1));
    ...
    ret = ret.intersection(&tmp);
    assert!(-a[0] * 1 + s[3] + l[0] + -C * 3 <= RealNumRep::new(0, 1));
    assert!(!(s[3] + -B * 1 + -C * 2 + -s[0] * 1 >= RealNumRep::new(0, 1)));
    assert!(!(s[3] + -B * 1 + -s[2] * 1 >= RealNumRep::new(0, 1)));
    assert!(s[3] + -C * 2 + -s[2] * 1 <= RealNumRep::new(0, 1));
    assert!(-a[0] * 1 + l[0] + -C * 2 + s[2] <= RealNumRep::new(0, 1));
    assert!(-C * 2 + s[2] + -s[1] * 1 <= RealNumRep::new(0, 1));
    assert!(!(s[3] + -B * 1 + -C * 1 + -s[1] * 1 >= RealNumRep::new(0, 1)));
...
pub fn compute_c_t_5_l_2(
    ...
    ret = ret.intersection(&tmp);
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![Interval::interval_lower(l[1] + -a[1] * 1 + s[4])]);
        ret = ret.intersection(&tmp);
    }
    let tmp = IntervalList::new(vec![Interval::interval_lower(
        s[4] * 1 / 4 + -a[0] * 1 / 4 + l[0] * 1 / 4,
    ...
    ret = ret.intersection(&tmp);
    assert!(l[0] >= RealNumRep::new(0, 1));
    assert!(!(l[1] + s[4] + -a[2] * 1 >= RealNumRep::new(0, 1)));
    assert!(-a[0] * 1 + s[0] + l[0] <= RealNumRep::new(0, 1));
    let tmp = IntervalList::new(vec![Interval::interval_lower(s[3] * 1 / 2 + -s[2] * 1 / 2)]);
    ret = ret.intersection(&tmp);
    let tmp = IntervalList::new(vec![Interval::interval_lower(l[1] + -a[1] * 1 + s[2])]);
    ret = ret.intersection(&tmp);
...
pub fn compute_b_t_5_l_2(
    ...
    let tmp = IntervalList::new(vec![Interval::interval_lower(
        -l[1] * 1 + a[1] + -s[4] * 1 / 3 + -a[0] * 2 / 3 + l[0] * 2 / 3,
    )]);
    ret = ret.intersection(&tmp);
    let tmp = IntervalList::new(vec![Interval::interval_lower(
        -l[1] * 1 + a[1] + -s[4] * 1 / 2 + -s[0] * 1 / 2,
    )]);
    ret = ret.intersection(&tmp);
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![Interval::interval_upper(
    ...
    assert!(
        (-s[4] * 1 / 3 + s[0] * 1 / 3 <= RealNumRep::new(-5, 1))
            || (RealNumRep::new(0, 1) <= l[1] + -a[1] * 1 + s[4] * 1 / 3 + s[0] * 2 / 3)
    );
    let tmp = IntervalList::new(vec![Interval::interval_lower(
        RealNumRep::new(10, 1) + -l[1] * 1 + a[1] + -s[4] * 1,
    )]);
    ret = ret.intersection(&tmp);
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![Interval::interval_upper(
    ...
    ret = ret.intersection(&tmp);
    let tmp = IntervalList::new(vec![Interval::interval_lower(
        -l[1] * 1 + a[1] + -a[0] * 1 / 2 + -s[3] * 1 / 2 + l[0] * 1 / 2,
    )]);
    ret = ret.intersection(&tmp);
    let tmp = IntervalList::new(vec![Interval::interval_lower(
        -l[1] * 1 + a[1] + -s[3] * 2 / 3 + -s[0] * 1 / 3,
    )]);
    ret = ret.intersection(&tmp);
    let tmp = IntervalList::new(vec![Interval::interval_lower(
        RealNumRep::new(5, 1) + -l[1] * 1 + a[1] + -s[3] * 1,
    )]);
    ret = ret.intersection(&tmp);
    let tmp = IntervalList::new(vec![Interval::interval_lower(
        -l[1] * 1 + a[1] + -s[3] * 1 / 2 + -s[1] * 1 / 2,
    )]);
    ret = ret.intersection(&tmp);
    assert!(
        (-s[4] * 1 / 3 + s[0] * 1 / 3 <= RealNumRep::new(-5, 1))
    ...
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![Interval::interval_upper(
            -l[1] * 2 + a[1] * 2 + -s[4] * 1 + -s[0] * 1,
        )]);
        ret = ret.intersection(&tmp);
    }
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![Interval::interval_upper(
            -l[1] * 1 + a[1] + -s[2] * 1 / 2 + -s[0] * 1 / 2,
        )]);
        ret = ret.intersection(&tmp);
    }
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![Interval::interval_upper(
            -l[1] * 1 + a[1] + -s[3] * 1 / 3 + -s[0] * 2 / 3,
        )]);
        ret = ret.intersection(&tmp);
    }
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![Interval::interval_upper(
            -l[1] * 1 + a[1] + -s[4] * 1 / 4 + -s[0] * 3 / 4,
        )]);
        ret = ret.intersection(&tmp);
    }
    if !(l[1] == l[0]) {
...
pub fn compute_q_4_t_5_l_2(
    ...
    ret = ret.intersection(&tmp);
    if !(RealNumRep::new(0, 1) <= -a[3] * 1 + a[2] + s[3] + -s[1] * 1) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(-l[1] * 1 + a[1] + -s[2] * 1),
            Interval::interval_lower(-l[1] * 1 + a[4] + -s[3] * 3 + s[1] * 2),
            Interval::interval_lower(-l[1] * 1 + a[1] + a[4] + -a[3] * 1 + -s[3] * 1),
        ]);
        ret = ret.intersection(&tmp);
    }
    assert!(
        (-l[1] * 1 + a[1] + -s[2] * 1 <= RealNumRep::new(0, 1))
            || (-s[2] * 2 + s[0] * 2 <= RealNumRep::new(-10, 1))
    );
    ...
    let tmp = IntervalList::new(vec![
        Interval::interval_point(RealNumRep::new(0, 1)),
        Interval::interval_upper(-l[1] * 3 / 2 + a[1] * 1 / 2 + a[4] + -s[3] * 3 / 2),
    ]);
    ret = ret.intersection(&tmp);
    assert!(
        (-l[1] * 1 + a[1] + -s[2] * 1 <= RealNumRep::new(0, 1))
    ...
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_upper(
                -l[1] * 1 + a[1] + -s[4] * 3 / 4 + a[4] + -a[2] * 1 + -s[0] * 1 / 4,
            ),
            Interval::interval_lower(
                -l[1] * 4 + a[1] * 4 + -s[4] * 3 + a[4] + -a[2] * 1 + -s[0] * 1,
            ),
        ]);
        ret = ret.intersection(&tmp);
    }
    ...
    assert!(
        (l[1] == l[0]) || (!(RealNumRep::new(0, 1) <= l[1] + -a[1] * 1 + s[4] + -s[2] * 1 + s[0]))
    );
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![Interval::interval_upper(
            RealNumRep::new(-5, 1) + -l[1] * 1 + a[1] + a[4] + -a[3] * 1 + -s[1] * 1,
        )]);
        ret = ret.intersection(&tmp);
    }
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![Interval::interval_upper(
            -l[1] * 1 + a[1] + a[4] + -a[3] * 1 + -s[2] * 1,
        )]);
        ret = ret.intersection(&tmp);
    }
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_point(RealNumRep::new(0, 1)),
            Interval::interval_upper(-l[1] * 1 + a[1] + a[4] + -a[2] * 1 + -s[3] * 1),
        ]);
        ret = ret.intersection(&tmp);
    }
    let tmp = IntervalList::new(vec![
    ...
    if !(!(l[1] == l[0])) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(a[1] + -s[4] * 1 + a[4] + -a[2] * 1 + -l[0] * 1),
            Interval::interval_lower(-l[1] * 1 + a[1] + -s[3] * 2 / 3 + -s[0] * 1 / 3),
    ...
    let tmp = IntervalList::new(vec![
        ...
        Interval::interval_upper(RealNumRep::new(-15, 1) + -a[1] * 1 + a[4]),
        Interval::interval_upper(a[4] + -a[3] * 1),
    ]);
    ret = ret.intersection(&tmp);
    assert!(
        (-s[4] * 2 / 3 + s[0] * 2 / 3 <= RealNumRep::new(-10, 1))
            || (-l[1] * 1 + a[1] + -s[4] * 1 <= RealNumRep::new(-10, 1))
    );
    if !(-a[1] * 1 + -s[4] * 1 + a[2] + s[2] <= RealNumRep::new(0, 1)) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(-l[1] * 1 + a[1] + -s[3] * 1 / 2 + -s[1] * 1 / 2),
            Interval::interval_lower(-l[1] * 1 + a[1] + -s[4] * 1 + a[4] + -a[2] * 1),
            Interval::interval_lower(-l[1] * 1 + a[1] + a[4] + -a[3] * 1 + -s[3] * 1),
        ]);
        ret = ret.intersection(&tmp);
    }
    ...
    let tmp = IntervalList::new(vec![
        ...
        Interval::interval_lower(-l[1] * 1 + a[1] + -s[4] * 1 + a[4] + -a[2] * 1),
        Interval::interval_lower(-l[1] * 1 + a[1] + a[4] + -a[3] * 1 + -s[3] * 1),
        Interval::interval_lower(RealNumRep::new(5, 1) + -l[1] * 1 + a[1] + -s[3] * 1),
    ]);
    ret = ret.intersection(&tmp);
    assert!(
        (l[1] == l[0]) || (!(RealNumRep::new(0, 1) <= l[1] + -a[1] * 1 + s[4] + -s[3] * 1 + s[1]))
    );
    if !((-a[1] * 1 + -s[4] * 1 + a[2] + s[2] <= RealNumRep::new(0, 1))
        || (RealNumRep::new(0, 1) <= s[4] * 1 / 2 + -a[4] * 1 + a[3] + -s[1] * 1 / 2))
    {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(-l[1] * 1 + a[1] + -s[3] * 2 / 3 + -s[0] * 1 / 3),
            Interval::interval_lower(-l[1] * 1 + a[1] + a[4] + -a[2] * 1 + -s[3] * 2 + s[1]),
        ]);
        ret = ret.intersection(&tmp);
    }
    ...
    let tmp = IntervalList::new(vec![
        Interval::interval_upper(-l[1] * 3 + a[1] * 2 + a[4] + -s[2] * 3),
        Interval::interval_upper(a[4] + -a[3] * 1),
    ]);
    ret = ret.intersection(&tmp);
    let tmp = IntervalList::new(vec![
    ...
    if !(!(RealNumRep::new(0, 1) <= -l[1] * 1 + l[0])) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(a[1] + -s[4] * 1 + a[4] + -a[2] * 1 + -l[0] * 1),
            Interval::interval_lower(-l[1] * 1 + -s[4] * 4 / 3 + a[4] + s[0] * 1 / 3),
            Interval::interval_lower(a[1] + -l[0] * 1 + -s[2] * 1),
            Interval::interval_lower(a[4] + -a[3] * 1),
        ]);
        ret = ret.intersection(&tmp);
    }
    ...
    if !(!(l[1] == l[0])) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(-l[1] * 1 + -s[4] * 4 / 3 + a[4] + s[0] * 1 / 3),
            Interval::interval_lower(-l[1] * 1 + a[1] + -s[4] * 1 + a[4] + -a[2] * 1),
            Interval::interval_lower(a[1] + -l[0] * 1 + -s[3] * 1 / 2 + -s[1] * 1 / 2),
            Interval::interval_lower(-l[1] * 1 + a[1] + a[4] + -a[3] * 1 + -s[3] * 1),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !(!(l[1] == l[0])) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(a[1] + a[4] + -a[2] * 1 + -s[3] * 2 + s[1] + -l[0] * 1),
            Interval::interval_lower(-l[1] * 1 + a[4] + -s[3] * 3 + s[1] * 2),
            Interval::interval_lower(a[1] + -l[0] * 1 + -s[2] * 1),
            Interval::interval_lower(-l[1] * 1 + a[1] + a[4] + -a[3] * 1 + -s[3] * 1),
        ]);
    ...
    if !(!(l[1] == l[0])) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(-l[1] * 1 + -s[4] * 4 / 3 + a[4] + s[0] * 1 / 3),
            Interval::interval_lower(a[1] + -l[0] * 1 + -s[2] * 1),
            Interval::interval_lower(-l[1] * 1 + a[1] + a[4] + -a[2] * 1 + -s[2] * 3 + s[0] * 2),
            Interval::interval_lower(-l[1] * 1 + a[1] + a[4] + -a[3] * 1 + -s[2] * 2 + s[0]),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !(RealNumRep::new(0, 1) <= s[4] * 1 / 2 + -a[4] * 1 + a[3] + -s[1] * 1 / 2) {
    ...
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![Interval::interval_upper(
            -l[1] * 1 + a[1] + a[4] * 1 / 2 + -a[2] * 1 / 2 + -s[2] * 1,
        )]);
        ret = ret.intersection(&tmp);
    }
    let tmp = IntervalList::new(vec![
    ...
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![Interval::interval_upper(
            -l[1] * 3 + a[1] * 3 + -s[4] * 2 + a[4] + -a[3] * 1 + -s[0] * 1,
        )]);
        ret = ret.intersection(&tmp);
    }
    let tmp = IntervalList::new(vec![
    ...
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![Interval::interval_upper(
            -l[1] * 1 + a[1] + -s[4] * 1 / 3 + a[4] + -a[3] * 1 + -s[1] * 2 / 3,
        )]);
        ret = ret.intersection(&tmp);
    }
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![Interval::interval_upper(
            -l[1] * 1 + a[1] + -s[4] * 1 / 2 + a[4] + -a[3] * 1 + -s[0] * 1 / 2,
        )]);
        ret = ret.intersection(&tmp);
    }
    let tmp = IntervalList::new(vec![
    ...
    assert!(
        (l[1] == l[0])
            || (!(RealNumRep::new(0, 1) <= l[1] + -a[1] * 1 + s[4] * 1 / 2 + s[1] * 1 / 2))
    );
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_upper(-l[1] * 1 + a[1] * 1 / 2 + a[4] + -a[3] * 1 / 2 + -s[3] * 1),
            Interval::interval_upper(a[4] + -a[3] * 1),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_upper(-l[1] * 1 + a[1] * 1 / 3 + a[4] * 2 / 3 + -s[3] * 1),
            Interval::interval_upper(a[4] + -a[3] * 1),
        ]);
        ret = ret.intersection(&tmp);
    }
    let tmp = IntervalList::new(vec![
        Interval::interval_lower(-l[1] * 1 + -s[4] * 4 / 3 + a[4] + s[0] * 1 / 3),
        Interval::interval_lower(-l[1] * 1 + a[1] + -s[4] * 1 + a[4] + -a[2] * 1),
        Interval::interval_lower(RealNumRep::new(10, 1) + -l[1] * 1 + a[1] + -s[4] * 1),
        Interval::interval_lower(-l[1] * 1 + a[1] + -s[4] * 1 + a[4] * 2 + -a[3] * 2),
    ]);
    ret = ret.intersection(&tmp);
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![Interval::interval_upper(
            RealNumRep::new(-10, 1) + -l[1] * 1 + a[1] + a[4] + -a[3] * 1 + -s[0] * 1,
        )]);
        ret = ret.intersection(&tmp);
    }
    let tmp = IntervalList::new(vec![
    ...
    let tmp = IntervalList::new(vec![
        ...
        Interval::interval_lower(
            -l[1] * 1 + a[1] + a[4] + -a[2] * 1 + -s[3] * 3 / 2 + s[0] * 1 / 2,
        ),
    ]);
    ret = ret.intersection(&tmp);
    if !(-a[1] * 1 + -s[4] * 1 + a[2] + s[2] <= RealNumRep::new(0, 1)) {
    ...
    ret = ret.intersection(&tmp);
    if !((-l[1] * 1 + a[1] + -s[2] * 1 <= RealNumRep::new(0, 1))
        || (a[3] + -a[2] * 1 + -s[2] * 1 + s[0] <= RealNumRep::new(0, 1)))
    {
        let tmp = IntervalList::new(vec![
    ...
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_upper(
                -l[1] * 1 + a[1] + -s[4] * 1 / 2 + a[4] + -a[2] * 1 + -s[2] * 1 / 2,
            ),
            Interval::interval_upper(a[4] + -a[3] * 1),
        ]);
        ret = ret.intersection(&tmp);
    ...
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_upper(
                -l[1] * 1 + a[1] + -s[4] * 2 / 3 + a[4] + -a[2] * 1 + -s[1] * 1 / 3,
            ),
            Interval::interval_upper(a[4] + -a[3] * 1),
        ]);
        ret = ret.intersection(&tmp);
    ...
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_point(RealNumRep::new(0, 1)),
            Interval::interval_upper(
                RealNumRep::new(-10, 1) + -l[1] * 1 + a[1] + a[4] + -a[2] * 1 + -s[1] * 1,
            ),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![Interval::interval_upper(
            -l[1] * 1 + a[1] + a[4] + -a[3] * 1 + -s[3] * 1 / 2 + -s[1] * 1 / 2,
        )]);
        ret = ret.intersection(&tmp);
    }
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_upper(
                -l[1] * 1 + a[1] + a[4] + -a[2] * 1 + a[0] * 2 + -s[1] * 3 + -l[0] * 2,
            ),
            Interval::interval_upper(a[4] + -a[3] * 1),
        ]);
        ret = ret.intersection(&tmp);
    ...
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_upper(
                -l[1] * 1 + a[1] + a[4] + -a[2] * 1 + a[0] * 1 / 2 + -s[2] * 3 / 2 + -l[0] * 1 / 2,
            ),
            Interval::interval_upper(a[4] + -a[3] * 1),
        ]);
        ret = ret.intersection(&tmp);
    ...
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_point(RealNumRep::new(0, 1)),
            Interval::interval_upper(
                RealNumRep::new(-5, 1) + -l[1] * 1 + a[1] + a[4] + -a[2] * 1 + -s[2] * 1,
            ),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !(RealNumRep::new(0, 1) <= -l[1] * 1 + l[0]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_upper(
                -l[1] * 3 + a[1] * 3 + -s[4] * 2 + a[4] + -a[2] * 1 + -s[1] * 1,
            ),
            Interval::interval_upper(a[4] + -a[3] * 1),
        ]);
        ret = ret.intersection(&tmp);
    ...
    assert!(
        (l[1] == l[0])
            || (!(RealNumRep::new(0, 1) <= l[1] * 2 + -a[1] * 2 + s[4] * 2 + -s[3] * 1 + s[0]))
    );
    if !(-l[1] * 1 + a[1] + -s[2] * 1 <= RealNumRep::new(0, 1)) {
        let tmp = IntervalList::new(vec![
            Interval::new(None, None),
    ...
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![Interval::interval_upper(
            -l[1] * 1 + a[1] + a[4] + -a[3] * 1 + a[0] + -s[1] * 2 + -l[0] * 1,
        )]);
        ret = ret.intersection(&tmp);
    }
    let tmp = IntervalList::new(vec![
    ...
    let tmp = IntervalList::new(vec![
        Interval::interval_lower(-l[1] * 1 + -s[4] * 2 + a[4] + s[2]),
        Interval::interval_lower(-l[1] * 1 + a[1] + -s[4] * 1 + a[4] + -a[2] * 1),
        Interval::interval_lower(-l[1] * 1 + a[1] + -s[4] * 1 / 3 + -a[0] * 2 / 3 + l[0] * 2 / 3),
        Interval::interval_lower(
            -l[1] * 1 + a[1] + -s[4] * 2 / 3 + a[4] + -a[3] * 1 + -a[0] * 1 / 3 + l[0] * 1 / 3,
        ),
    ]);
    ret = ret.intersection(&tmp);
    let tmp = IntervalList::new(vec![
    ...
    ret = ret.intersection(&tmp);
    let tmp = IntervalList::new(vec![
        Interval::interval_lower(-l[1] * 1 + a[1] + -a[0] * 1 / 2 + -s[3] * 1 / 2 + l[0] * 1 / 2),
        Interval::interval_lower(-l[1] * 1 + -s[4] * 4 / 3 + a[4] + s[0] * 1 / 3),
        Interval::interval_lower(-l[1] * 1 + a[1] + -s[4] * 1 + a[4] + -a[2] * 1),
        Interval::interval_lower(-l[1] * 1 + a[1] + -s[4] * 1 + a[4] * 2 + -a[3] * 2),
    ]);
    ...
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_point(RealNumRep::new(0, 1)),
            Interval::interval_upper(
                -l[1] * 1 + a[1] + a[4] + -a[2] * 1 + -s[2] * 4 / 3 + s[0] * 1 / 3,
            ),
        ]);
        ret = ret.intersection(&tmp);
    }
    let tmp = IntervalList::new(vec![
        Interval::interval_lower(-l[1] * 1 + -s[4] * 2 + a[4] + s[2]),
        Interval::interval_lower(-l[1] * 1 + a[1] + -s[4] * 1 + a[4] + -a[2] * 1),
        Interval::interval_lower(-l[1] * 1 + a[1] + -s[4] * 1 / 2 + -s[0] * 1 / 2),
        Interval::interval_lower(
            -l[1] * 1 + a[1] + -s[4] * 3 / 4 + a[4] + -a[3] * 1 + -s[0] * 1 / 4,
        ),
    ]);
    ret = ret.intersection(&tmp);
    if !(-l[1] * 1 + a[1] + -s[2] * 1 <= RealNumRep::new(0, 1)) {
    ...
    let tmp = IntervalList::new(vec![
        ...
        Interval::interval_lower(RealNumRep::new(10, 1) + -l[1] * 1 + a[1] + -s[4] * 1),
        Interval::interval_lower(
            RealNumRep::new(5, 1) + -l[1] * 1 + a[1] + -s[4] * 1 + a[4] + -a[3] * 1,
        ),
    ]);
    ret = ret.intersection(&tmp);
    let tmp = IntervalList::new(vec![
    ...
    if !(RealNumRep::new(0, 1) <= -l[1] * 1 + l[0]) {
        let tmp = IntervalList::new(vec![Interval::interval_upper(
            -l[1] * 2 + a[1] * 2 + -s[4] * 1 + a[4] + -a[3] * 1 + -s[1] * 1,
        )]);
        ret = ret.intersection(&tmp);
    }
    if !(RealNumRep::new(0, 1) <= s[4] * 1 / 2 + -a[4] * 1 + a[3] + -s[1] * 1 / 2) {
        ...
        || (RealNumRep::new(0, 1) <= s[4] * 1 / 2 + -a[4] * 1 + a[3] + -s[1] * 1 / 2))
    {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(-l[1] * 1 + -s[4] * 3 / 2 + a[4] + s[1] * 1 / 2),
            Interval::interval_lower(-l[1] * 1 + a[1] + -s[4] * 1 + a[4] + -a[2] * 1),
            Interval::interval_lower(l[1] + -a[1] * 1 + s[4]),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !(RealNumRep::new(0, 1) <= -a[3] * 1 + a[2] + s[3] + -s[1] * 1) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(-l[1] * 1 + a[1] + s[4] * 1 / 2 + -s[3] * 3 / 2),
            Interval::interval_lower(-l[1] * 1 + a[4] + -s[3] * 3 + s[1] * 2),
            Interval::interval_lower(-l[1] * 1 + a[1] + a[4] + -a[3] * 1 + -s[3] * 1),
        ]);
        ret = ret.intersection(&tmp);
    ...
    if !((!(RealNumRep::new(-5, 1) <= -a[3] * 1 + a[2]))
        || (RealNumRep::new(0, 1) <= a[1] + -a[2] * 1 + s[3] * 1 / 2 + -s[0] * 1 / 2))
    {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(-l[1] * 1 + a[1] + -s[3] * 2 / 3 + -s[0] * 1 / 3),
            Interval::interval_lower(
    ...
    assert!(
        (l[1] == l[0])
            || (!(RealNumRep::new(0, 1) <= l[1] + -a[1] * 1 + s[4] * 2 / 3 + s[0] * 1 / 3))
    );
    let tmp = IntervalList::new(vec![
        Interval::interval_lower(-l[1] * 1 + -s[4] * 3 / 2 + a[4] + s[1] * 1 / 2),
        Interval::interval_lower(-l[1] * 1 + a[1] + -s[4] * 1 + a[4] + -a[2] * 1),
    ...
    if !((-l[1] * 1 + a[1] + -s[2] * 1 <= RealNumRep::new(0, 1))
        || (!(-a[2] * 2 + a[3] * 2 + -s[2] * 2 + s[0] * 2 <= RealNumRep::new(0, 1)))
        || (!(a[4] + -a[2] * 1 + -s[2] * 2 + s[0] * 2 <= RealNumRep::new(0, 1))))
    {
        let tmp = IntervalList::new(vec![Interval::interval_lower(
            s[4] + a[4] + -a[2] * 1 + -s[2] * 4 + s[0] * 3,
        )]);
        ret = ret.intersection(&tmp);
    }
    if !((-l[1] * 1 + a[1] + -s[2] * 1 <= RealNumRep::new(0, 1))
        || (a[4] + -a[3] * 1 + -s[2] * 1 + s[0] <= RealNumRep::new(0, 1)))
    {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(s[4] + a[4] + -a[2] * 1 + -s[2] * 4 + s[0] * 3),
            Interval::interval_lower(s[4] + -s[2] * 2 + s[0]),
    ...
    if !(!(l[1] == l[0])) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(a[1] + -s[4] * 1 + a[4] + -a[2] * 1 + -l[0] * 1),
            Interval::interval_lower(-l[1] * 1 + -s[4] * 2 + a[4] + s[2]),
            Interval::interval_lower(-l[1] * 1 + a[1] + -s[4] * 1 / 3 + -s[1] * 2 / 3),
            Interval::interval_lower(a[4] + -a[3] * 1),
        ]);
        ret = ret.intersection(&tmp);
    }
    ...
    if !(-a[1] * 1 + -s[4] * 1 + a[2] + s[2] <= RealNumRep::new(0, 1)) {
        let tmp = IntervalList::new(vec![
            ...
            Interval::interval_lower(-l[1] * 1 + a[1] + -s[4] * 1 / 3 + -s[1] * 2 / 3),
            Interval::interval_lower(
                -l[1] * 1 + a[1] + -s[4] * 2 / 3 + a[4] + -a[3] * 1 + -s[1] * 1 / 3,
            ),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !(!(RealNumRep::new(-5, 1) <= a[1] + -a[2] * 1)) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(-l[1] * 1 + -s[4] * 4 / 3 + a[4] + s[0] * 1 / 3),
            Interval::interval_lower(RealNumRep::new(10, 1) + -l[1] * 1 + a[1] + -s[4] * 1),
            Interval::interval_lower(
    ...
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_point(RealNumRep::new(0, 1)),
            Interval::interval_upper(
                RealNumRep::new(-15, 1) + -l[1] * 1 + a[1] + a[4] + -a[2] * 1 + -s[0] * 1,
            ),
        ]);
        ret = ret.intersection(&tmp);
    }
    ...
    if !(!(l[1] == l[0])) {
        let tmp = IntervalList::new(vec![
            ...
            Interval::interval_lower(a[1] + -l[0] * 1 + -s[2] * 1),
            Interval::interval_lower(
                -l[1] * 1 + a[1] + -s[4] * 1 / 2 + a[4] + -a[3] * 1 + -s[2] * 1 / 2,
            ),
        ]);
        ret = ret.intersection(&tmp);
    }
    ...
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_upper(
                -l[1] * 1 + a[1] + a[4] + -a[2] * 1 + -s[2] * 3 / 2 + s[1] * 1 / 2,
            ),
            Interval::interval_upper(a[4] + -a[3] * 1),
        ]);
        ret = ret.intersection(&tmp);
    ...
    ret = ret.intersection(&tmp);
    if !(RealNumRep::new(0, 1) <= a[1] + -a[2] * 1 + s[3] * 1 / 2 + -s[0] * 1 / 2) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(-l[1] * 1 + a[1] + -s[3] * 1 / 2 + -s[1] * 1 / 2),
            Interval::interval_lower(
                -l[1] * 1 + a[1] + a[4] + -a[2] * 1 + -s[3] * 3 / 2 + s[0] * 1 / 2,
    ...
    if !(!(l[1] == l[0])) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(a[1] + -s[4] * 1 + a[4] + -a[2] * 1 + -l[0] * 1),
            Interval::interval_lower(-l[1] * 1 + -s[4] * 3 / 2 + a[4] + s[1] * 1 / 2),
            Interval::interval_lower(a[1] + -a[0] * 1 / 2 + -l[0] * 1 / 2 + -s[3] * 1 / 2),
            Interval::interval_lower(-l[1] * 1 + a[1] + a[4] + -a[3] * 1 + -s[3] * 1),
        ]);
        ret = ret.intersection(&tmp);
    }
    ...
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![Interval::interval_upper(
            -l[1] * 1 + a[1] + a[4] + -a[3] * 1 + -s[1] * 3 / 2 + s[0] * 1 / 2,
        )]);
        ret = ret.intersection(&tmp);
    }
    let tmp = IntervalList::new(vec![
    ...
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![Interval::interval_upper(
            -l[1] * 1 + a[1] + a[4] + -a[3] * 1 + -s[3] * 2 / 3 + -s[0] * 1 / 3,
        )]);
        ret = ret.intersection(&tmp);
    }
    let tmp = IntervalList::new(vec![
    ...
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_point(RealNumRep::new(0, 1)),
            Interval::interval_upper(-l[1] * 1 + a[1] + a[4] + -a[2] * 1 + -s[1] * 2 + s[0]),
        ]);
        ret = ret.intersection(&tmp);
    }
    let tmp = IntervalList::new(vec![
    ...
    if !(RealNumRep::new(0, 1) <= -l[1] * 1 + l[0]) {
        let tmp = IntervalList::new(vec![
            ...
            Interval::interval_upper(
                -l[1] * 2 + a[1] * 2 + -s[4] * 1 + a[4] + -a[2] * 1 + -s[2] * 1,
            ),
        ]);
        ret = ret.intersection(&tmp);
    }
    ...
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_upper(-l[1] * 1 + a[1] * 1 / 3 + a[4] * 2 / 3 + -s[3] * 1),
            Interval::interval_upper(-l[1] * 1 + a[4] * 1 / 2 + a[2] * 1 / 2 + -s[3] * 1),
        ]);
        ret = ret.intersection(&tmp);
    }
    let tmp = IntervalList::new(vec![
...
pub fn compute_s_4_t_5_l_2(
    ...
    assert!((!(RealNumRep::new(0, 1) <= -l[1] * 1 + l[0])) || (l[1] == l[0]));
    assert!(
        (RealNumRep::new(-5, 1) <= l[1] + -a[1] * 1 + s[0])
            || (-s[2] * 1 + s[0] <= RealNumRep::new(-5, 1))
    );
    assert!((l[1] == l[0]) || (l[1] + -a[1] * 1 + s[0] <= RealNumRep::new(-10, 1)));
    assert!(
        (-s[3] * 1 / 2 + s[0] * 1 / 2 <= RealNumRep::new(-5, 1))
            || (RealNumRep::new(5, 1) <= l[1] + -a[1] * 1 + s[3])
    );
    let tmp = IntervalList::new(vec![
        Interval::interval_lower(RealNumRep::new(5, 1) + s[2]),
    ...
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![Interval::interval_upper(
            -l[1] * 1 + a[1] + s[3] * 2 + a[4] + -a[3] * 1 + -s[1] * 2,
        )]);
        ret = ret.intersection(&tmp);
    }
    assert!(
    ...
    assert!(
        (l[1] == l[0])
            || (l[1] + -a[1] * 1 + s[2] * 1 / 2 + s[0] * 1 / 2 <= RealNumRep::new(-5, 1))
    );
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![Interval::interval_upper(
            RealNumRep::new(-10, 1) + -l[1] * 3 + a[1] * 3 + a[4] + -a[3] * 1 + -s[0] * 2,
        )]);
        ret = ret.intersection(&tmp);
    }
    assert!((l[1] == l[0]) || (!(RealNumRep::new(-5, 1) <= l[1] * 2 + -a[1] * 2 + s[3] + s[0])));
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![Interval::interval_upper(
            RealNumRep::new(-20, 1) + -l[1] * 4 + a[1] * 4 + -s[0] * 3,
        )]);
        ret = ret.intersection(&tmp);
    }
    assert!(
        (l[1] == l[0]) || (!(RealNumRep::new(0, 1) <= l[1] + -a[1] * 1 + s[3] + -s[2] * 1 + s[0]))
    );
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![Interval::interval_upper(
            -l[1] * 1 + a[1] + a[4] + -a[3] * 1 + s[2] * 2 + -s[0] * 2,
        )]);
        ret = ret.intersection(&tmp);
    }
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![Interval::interval_upper(
            -l[1] * 1 + a[1] + s[3] + a[4] + -a[3] * 1 + -s[0] * 1,
        )]);
        ret = ret.intersection(&tmp);
    }
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![Interval::interval_upper(
            -l[1] * 1 + a[1] + a[3] + -a[2] * 1 + s[2] * 2 + -s[0] * 2,
        )]);
        ret = ret.intersection(&tmp);
    }
    assert!(
    ...
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![Interval::interval_upper(
            RealNumRep::new(-5, 1) + -l[1] * 2 + a[1] * 2 + a[4] + -a[2] * 1 + -s[0] * 1,
        )]);
        ret = ret.intersection(&tmp);
    }
    let tmp = IntervalList::new(vec![
    ...
    let tmp = IntervalList::new(vec![
        Interval::interval_lower(-l[1] * 1 + a[3]),
        Interval::interval_lower(-l[1] * 3 + a[1] * 3 + -a[0] * 2 + l[0] * 2),
        Interval::interval_lower(
            -l[1] * 1 + a[1] + a[3] + -a[2] * 1 + -a[0] * 1 / 2 + s[2] * 1 / 2 + l[0] * 1 / 2,
        ),
    ...
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![Interval::interval_upper(
            RealNumRep::new(-10, 1) + -l[1] * 3 + a[1] * 3 + a[3] + -a[2] * 1 + -s[0] * 2,
        )]);
        ret = ret.intersection(&tmp);
    }
    let tmp = IntervalList::new(vec![
        Interval::interval_upper(l[1] * 2 + -a[1] * 2 + s[3] * 3),
    ...
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![Interval::interval_upper(
            -l[1] * 1 + a[1] + s[3] * 1 / 2 + a[4] + -a[2] * 1 + -s[0] * 1 / 2,
        )]);
        ret = ret.intersection(&tmp);
    }
    if !(l[1] == l[0]) {
    ...
    let tmp = IntervalList::new(vec![
        ...
        Interval::interval_lower(s[2] * 4 / 3 + -s[0] * 1 / 3),
        Interval::interval_lower(
            -l[1] * 1 + a[1] + a[3] + -a[2] * 1 + s[2] * 1 / 3 + -s[0] * 1 / 3,
        ),
    ]);
    ret = ret.intersection(&tmp);
    let tmp = IntervalList::new(vec![
        ...
        Interval::interval_lower(s[1] * 2 + -s[0] * 1),
        Interval::interval_lower(
            -l[1] * 1 + a[1] + a[3] + -a[2] * 1 + s[1] * 1 / 2 + -s[0] * 1 / 2,
        ),
    ]);
    ret = ret.intersection(&tmp);
    let tmp = IntervalList::new(vec![
    ...
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(s[3] + a[3] + -a[2] * 1),
            Interval::interval_lower(l[1] + -a[1] * 1 + s[3] + s[2]),
        ]);
        ret = ret.intersection(&tmp);
    }
    let tmp = IntervalList::new(vec![
    ...
    let tmp = IntervalList::new(vec![
        Interval::interval_lower(-l[1] * 1 + a[3]),
        Interval::interval_lower(-a[0] * 2 + s[1] * 3 + l[0] * 2),
        Interval::interval_lower(-l[1] * 1 + a[1] + a[3] + -a[2] * 1 + -a[0] * 1 + s[1] + l[0]),
    ]);
    ret = ret.intersection(&tmp);
    let tmp = IntervalList::new(vec![
        Interval::interval_lower(-l[1] * 1 + a[3]),
    ...
    let tmp = IntervalList::new(vec![
        ...
        Interval::interval_lower(s[2] * 3 / 2 + -s[1] * 1 / 2),
        Interval::interval_lower(
            -l[1] * 1 + a[1] + a[3] + -a[2] * 1 + s[2] * 1 / 2 + -s[1] * 1 / 2,
        ),
    ]);
    ret = ret.intersection(&tmp);
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(s[3] + a[3] + -a[2] * 1),
            Interval::interval_lower(l[1] * 2 + -a[1] * 2 + s[3] * 2 + s[1]),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![Interval::interval_upper(
            -l[1] * 1 + a[1] + s[3] * 2 + a[3] + -a[2] * 1 + -s[1] * 2,
        )]);
        ret = ret.intersection(&tmp);
    }
    let tmp = IntervalList::new(vec![
        Interval::interval_upper(-l[1] * 1 + s[3] * 1 / 2 + a[3] + -s[0] * 1 / 2),
        Interval::interval_upper(-a[1] * 1 + s[3] + a[3]),
    ]);
    ret = ret.intersection(&tmp);
    let tmp = IntervalList::new(vec![
        Interval::interval_lower(s[2] * 4 / 3 + -s[0] * 1 / 3),
    ...
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(s[3] + a[3] + -a[2] * 1),
            Interval::interval_lower(l[1] * 3 + -a[1] * 3 + s[3] * 3 + s[0]),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![Interval::interval_upper(
            RealNumRep::new(-5, 1) + -l[1] * 2 + a[1] + a[3] + -s[0] * 1,
        )]);
        ret = ret.intersection(&tmp);
    }
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![Interval::interval_upper(
            -l[1] * 1 + a[1] + s[3] + a[3] + -a[2] * 1 + -s[0] * 1,
        )]);
        ret = ret.intersection(&tmp);
    }
    assert!(l[0] >= RealNumRep::new(0, 1));
    assert!(-a[0] * 1 + s[0] + l[0] <= RealNumRep::new(0, 1));
    assert!(!(l[1] + s[3] + -a[2] * 1 >= RealNumRep::new(0, 1)));
...
pub fn compute_sim_s_4_t_5_l_2(
    ...
    assert!(-l[1] * 1 + a[1] + -s[3] * 1 + C + -B * 1 <= RealNumRep::new(0, 1));
    ...
    assert!((l[1] == l[0]) || (!(RealNumRep::new(0, 1) <= l[1] + -a[1] * 1 + s[3] + -C * 1)));
    assert!((l[1] == l[0]) || (l[1] + -a[1] * 1 + s[3] + B + -C * 2 <= RealNumRep::new(0, 1)));
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![Interval::interval_upper(
            -l[1] * 1 + a[1] + -B * 1 + C * 3,
        )]);
    ...
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![Interval::interval_upper(
            -l[1] * 1 + a[1] + C * 2 + a[4] + -a[3] * 1,
        )]);
        ret = ret.intersection(&tmp);
    }
    if !(-a[1] * 1 + a[2] + -C * 1 <= RealNumRep::new(0, 1)) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(-l[1] * 1 + a[1] + -B * 1 + C * 2),
            Interval::interval_lower(-l[1] * 1 + a[1] + C + a[3] + -a[2] * 1),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !(!(-a[1] * 1 + a[2] + -C * 1 <= RealNumRep::new(0, 1))) {
    ...
    assert!(
        (RealNumRep::new(0, 1) <= l[1] + -a[1] * 1 + s[3] + -C * 1)
            || (-s[3] * 1 + C * 2 + s[0] <= RealNumRep::new(0, 1))
    );
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![Interval::interval_upper(
            -l[1] * 1 + a[1] + C * 2 + a[3] + -a[2] * 1,
        )]);
        ret = ret.intersection(&tmp);
    }
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![Interval::interval_upper(
            -l[1] * 1 + a[1] + C + a[4] + -a[2] * 1,
        )]);
        ret = ret.intersection(&tmp);
    }
    ...
    ret = ret.intersection(&tmp);
    assert!(-a[0] * 1 + s[2] + -C * 2 + l[0] <= RealNumRep::new(0, 1));
    assert!(-C * 1 + -a[0] * 1 + s[1] + l[0] <= RealNumRep::new(0, 1));
    assert!(!(RealNumRep::new(0, 1) <= s[3] + -B * 1 + -C * 2 + -a[0] * 1 + l[0]));
    let tmp = IntervalList::new(vec![Interval::interval_upper(C * 5 + s[0])]);
    ret = ret.intersection(&tmp);
    assert!(!(RealNumRep::new(0, 1) <= s[3] + -B * 1 + -C * 3 + -s[0] * 1));
    let tmp = IntervalList::new(vec![Interval::interval_upper(C * 4 + a[0] + -l[0] * 1)]);
    ret = ret.intersection(&tmp);
    assert!(s[3] + -C * 3 + -s[1] * 1 <= RealNumRep::new(0, 1));
    assert!(s[3] + -C * 3 + -a[0] * 1 + l[0] <= RealNumRep::new(0, 1));
    assert!(s[2] + -C * 3 + -s[0] * 1 <= RealNumRep::new(0, 1));
    assert!(s[3] + -C * 4 + -s[0] * 1 <= RealNumRep::new(0, 1));
    assert!(-C * 2 + s[1] + -s[0] * 1 <= RealNumRep::new(0, 1));
    assert!(!(RealNumRep::new(0, 1) <= s[3] + -B * 1 + -C * 2 + -s[1] * 1));
    assert!(
        (-l[1] * 1 + a[1] + -s[2] * 1 <= RealNumRep::new(0, 1))
    ...
    let tmp = IntervalList::new(vec![
        Interval::interval_lower(s[3] + a[3] + -a[2] * 1),
        Interval::interval_lower(s[3] + -B * 1 + C),
    ]);
    ret = ret.intersection(&tmp);
    let tmp = IntervalList::new(vec![
        Interval::interval_lower(-l[1] * 1 + a[3]),
    ...
    ret = ret.intersection(&tmp);
    assert!(l[1] + -a[1] * 1 + s[1] <= RealNumRep::new(0, 1));
    assert!(!(l[1] + -a[1] * 1 + s[3] + -B * 1 + -C * 1 >= RealNumRep::new(0, 1)));
    let tmp = IntervalList::new(vec![Interval::interval_upper(-l[1] * 1 + a[4])]);
    ret = ret.intersection(&tmp);
    assert!(!(s[3] + -B * 1 + -C * 1 + -s[2] * 1 >= RealNumRep::new(0, 1)));
    let tmp = IntervalList::new(vec![Interval::interval_upper(-l[1] * 1 + a[1] + C * 3)]);
    ret = ret.intersection(&tmp);
    assert!(s[2] + -C * 2 + -s[1] * 1 <= RealNumRep::new(0, 1));
    assert!(l[1] + -a[1] * 1 + s[3] + -C * 2 <= RealNumRep::new(0, 1));
...
pub fn compute_c_t_5_l_3(
    ...
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_point(a[2] + -l[2] * 1 + -a[1] * 1 + l[1]),
    ...
    let tmp = IntervalList::new(vec![
        Interval::interval_lower(a[2] + -l[2] * 1 + -s[1] * 1),
        Interval::interval_upper(s[3] + -s[1] * 1),
    ]);
    ret = ret.intersection(&tmp);
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![Interval::interval_upper(
    ...
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![Interval::interval_lower(
            RealNumRep::new(5, 1) + -a[2] * 1 + l[2] + s[3],
        )]);
        ret = ret.intersection(&tmp);
    }
    if !(l[1] == l[0]) {
    ...
    if !(a[2] + -l[2] * 1 + -s[3] * 1 <= RealNumRep::new(0, 1)) {
        let tmp = IntervalList::new(vec![Interval::interval_upper(a[2] + -l[2] * 1 + -s[1] * 1)]);
        ret = ret.intersection(&tmp);
    }
    let tmp = IntervalList::new(vec![Interval::interval_lower(
        s[4] * 1 / 4 + -a[0] * 1 / 4 + l[0] * 1 / 4,
    ...
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_upper(RealNumRep::new(-5, 1) + a[2] + -l[2] * 1 + -a[1] * 1 + l[1]),
    ...
    ret = ret.intersection(&tmp);
    assert!(l[0] >= RealNumRep::new(0, 1));
    assert!(!(l[2] + s[4] + -a[3] * 1 >= RealNumRep::new(0, 1)));
    assert!(-a[0] * 1 + s[0] + l[0] <= RealNumRep::new(0, 1));
    let tmp = IntervalList::new(vec![Interval::interval_lower(s[4] * 1 / 2 + -s[3] * 1 / 2)]);
    ret = ret.intersection(&tmp);
...
pub fn compute_b_t_5_l_3(
    ...
    assert!(s[1] >= s[0]);
    assert!((l[1] == l[0]) || (!(RealNumRep::new(0, 1) <= -l[1] * 1 + l[0])));
    let tmp = IntervalList::new(vec![Interval::interval_lower(a[2] + -l[2] * 1 + -s[3] * 1)]);
    ret = ret.intersection(&tmp);
    assert!((l[2] == l[1]) || (-a[2] * 1 + l[2] + a[1] + -l[1] * 1 <= RealNumRep::new(-5, 1)));
    let tmp = IntervalList::new(vec![Interval::interval_lower(a[1] + -s[2] * 1 + -l[1] * 1)]);
    ret = ret.intersection(&tmp);
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![Interval::interval_upper(
            a[2] * 2 + -l[2] * 2 + -a[1] * 1 + -s[3] * 1 + l[1],
        )]);
        ret = ret.intersection(&tmp);
    }
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![Interval::interval_lower(
            -a[2] * 2 + l[2] * 2 + a[1] * 3 + -s[0] * 1 + -l[1] * 3,
        )]);
        ret = ret.intersection(&tmp);
    }
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![Interval::interval_upper(
            a[2] * 3 + -l[2] * 3 + -s[4] * 1 + -a[1] * 2 + l[1] * 2,
        )]);
        ret = ret.intersection(&tmp);
    }
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![Interval::interval_upper(a[2] + -l[2] * 1 + -s[2] * 1)]);
        ret = ret.intersection(&tmp);
    }
    if !(l[1] == l[0]) {
    ...
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![Interval::interval_lower(
            -a[2] * 1 + l[2] + a[1] * 2 + -a[0] * 1 + -l[1] * 2 + l[0],
        )]);
        ret = ret.intersection(&tmp);
    }
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![Interval::interval_lower(
            a[2] * 2 + -l[2] * 2 + -s[4] * 1 + -a[1] * 1 + l[1],
        )]);
        ret = ret.intersection(&tmp);
    }
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![Interval::interval_lower(
            -a[2] * 1 + l[2] + a[1] * 2 + -s[1] * 1 + -l[1] * 2,
        )]);
        ret = ret.intersection(&tmp);
    }
    assert!(
        (l[2] == l[1])
            || (!(RealNumRep::new(0, 1) <= -a[2] * 2 + l[2] * 2 + s[4] + a[1] + -l[1] * 1))
    );
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![Interval::interval_upper(
            -a[2] * 1 + l[2] + a[1] * 2 + -s[0] * 1 + -l[1] * 2,
        )]);
        ret = ret.intersection(&tmp);
    }
    if !(l[1] == l[0]) {
    ...
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_upper(a[2] + -l[2] * 1 + -a[1] * 2 + s[0] + l[1] * 2),
            Interval::interval_upper(RealNumRep::new(-10, 1) + a[2] + -l[2] * 1 + -s[0] * 1),
        ]);
        ret = ret.intersection(&tmp);
    }
    let tmp = IntervalList::new(vec![Interval::interval_lower(
    ...
    let tmp = IntervalList::new(vec![
        ...
        Interval::interval_lower(
            a[2] + -l[2] * 1 + -s[4] * 1 + a[1] + -a[0] * 1 + -l[1] * 1 + l[0],
        ),
    ]);
    ret = ret.intersection(&tmp);
    if !(RealNumRep::new(0, 1) <= -a[2] * 1 + l[2] + s[3]) {
        let tmp = IntervalList::new(vec![Interval::interval_lower(
    ...
    if !((l[2] == l[1])
        || (RealNumRep::new(0, 1) <= s[4] * 1 / 4 + -a[1] * 1 + s[0] * 3 / 4 + l[1]))
    {
        let tmp = IntervalList::new(vec![Interval::interval_upper(
            a[2] + -l[2] * 1 + -s[4] * 1 / 2 + -s[0] * 1 / 2,
        )]);
        ret = ret.intersection(&tmp);
    }
    if !((l[2] == l[1])
    ...
    assert!(
        (RealNumRep::new(0, 1) <= -a[2] * 1 + l[2] + s[3])
            || (-s[3] * 1 + s[1] <= RealNumRep::new(-5, 1))
    );
    let tmp = IntervalList::new(vec![Interval::interval_lower(
        a[2] + -l[2] * 1 + -s[4] * 1 / 2 + -s[2] * 1 / 2,
    )]);
    ret = ret.intersection(&tmp);
    if !(RealNumRep::new(0, 1) <= -a[2] * 1 + l[2] + s[3]) {
        let tmp = IntervalList::new(vec![Interval::interval_lower(
    ...
    if !((l[2] == l[1]) || (!(RealNumRep::new(-5, 1) <= -a[1] * 1 + s[0] + l[1]))) {
        let tmp = IntervalList::new(vec![Interval::interval_upper(
            RealNumRep::new(-5, 1) + a[2] + -l[2] * 1 + l[1] + -a[1] * 1,
        )]);
        ret = ret.intersection(&tmp);
    }
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![Interval::interval_upper(
            a[2] + -l[2] * 1 + -s[3] * 1 / 2 + -s[1] * 1 / 2,
        )]);
        ret = ret.intersection(&tmp);
    }
    assert!(
    ...
    assert!(-s[4] * 1 / 2 + -a[1] * 1 / 2 + l[1] * 1 / 2 + s[2] <= RealNumRep::new(0, 1));
    assert!(
        (-s[4] * 1 / 2 + -a[0] * 1 + s[1] * 3 / 2 + l[0] <= RealNumRep::new(0, 1))
            || (a[2] + -l[2] * 1 + -s[4] * 1 + -a[0] * 1 + s[1] + l[0] <= RealNumRep::new(0, 1))
    );
    if !(RealNumRep::new(0, 1) <= -a[2] * 1 + l[2] + s[3]) {
    ...
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![Interval::interval_upper(
            a[2] + -l[2] * 1 + -s[4] * 1 / 3 + -s[1] * 2 / 3,
        )]);
        ret = ret.intersection(&tmp);
    }
    let tmp = IntervalList::new(vec![Interval::interval_lower(
        a[2] + -l[2] * 1 + -s[4] * 2 / 3 + -a[0] * 1 / 3 + l[0] * 1 / 3,
    )]);
    ret = ret.intersection(&tmp);
    let tmp = IntervalList::new(vec![Interval::interval_lower(
        a[2] + -l[2] * 1 + -s[4] * 2 / 3 + -s[1] * 1 / 3,
    )]);
    ret = ret.intersection(&tmp);
    let tmp = IntervalList::new(vec![Interval::interval_lower(
        a[2] + -l[2] * 1 + -s[4] * 1 / 2 + l[1] * 1 / 2 + -a[1] * 1 / 2,
    )]);
    ret = ret.intersection(&tmp);
    assert!(
        (RealNumRep::new(0, 1) <= -a[2] * 1 + l[2] + s[3])
    ...
    if !(RealNumRep::new(0, 1) <= -l[2] * 1 + l[1]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_upper(
                a[2] + -l[2] * 1 + -s[4] * 1 / 3 + l[1] * 2 / 3 + -a[1] * 2 / 3,
            ),
            Interval::interval_lower(a[2] + -l[2] * 1 + -a[1] * 2 + s[0] + l[1] * 2),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![Interval::interval_upper(
            a[2] + -l[2] * 1 + a[0] + -s[1] * 2 + -l[0] * 1,
        )]);
        ret = ret.intersection(&tmp);
    }
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_upper(a[2] + -l[2] * 1 + -s[3] * 2 / 3 + -s[0] * 1 / 3),
            Interval::interval_upper(
                a[2] + -l[2] * 1 + l[1] * 1 / 2 + -a[1] * 1 / 2 + -s[3] * 1 / 2,
            ),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![Interval::interval_upper(
            a[2] + -l[2] * 1 + -s[1] * 3 / 2 + s[0] * 1 / 2,
        )]);
        ret = ret.intersection(&tmp);
    }
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_upper(a[2] * 2 + -l[2] * 2 + -s[4] * 1 + -a[1] * 1 + l[0]),
            Interval::interval_upper(a[2] * 3 + -l[2] * 3 + -s[4] * 2 + -s[0] * 1),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !(RealNumRep::new(0, 1) <= -l[2] * 1 + l[1]) {
    ...
    assert!(
        (RealNumRep::new(0, 1) <= -a[2] * 1 + l[2] + s[3])
            || (s[4] * 1 / 2 + -s[3] * 1 + s[0] * 1 / 2 <= RealNumRep::new(0, 1))
            || (s[4] + a[1] * 2 + -l[1] * 2 + -s[3] * 3 <= RealNumRep::new(0, 1))
    );
    if !(RealNumRep::new(0, 1) <= -a[2] * 1 + l[2] + s[3]) {
        let tmp = IntervalList::new(vec![
    ...
    assert!(
        (-s[4] * 1 + s[1] * 2 + -s[0] * 1 <= RealNumRep::new(0, 1))
            || (a[2] * 2 + -l[2] * 2 + -s[4] * 2 + s[1] + -s[0] * 1 <= RealNumRep::new(0, 1))
    );
    let tmp = IntervalList::new(vec![Interval::interval_lower(RealNumRep::new(5, 1))]);
    ret = ret.intersection(&tmp);
    assert!(l[0] >= RealNumRep::new(0, 1));
...
pub fn compute_q_4_t_5_l_3(
    ...
    assert!(
        (l[2] == l[1])
            || (-a[2] * 2 + l[2] * 2 + a[1] + s[3] + -l[1] * 1 <= RealNumRep::new(-5, 1))
    );
    assert!(
        (l[2] == l[1])
            || (-a[2] * 2 + l[2] * 2 + a[1] * 2 + s[3] + -s[2] * 1 + -l[1] * 2
                <= RealNumRep::new(0, 1))
    );
    assert!(
        (l[2] == l[1])
            || (-a[2] * 3 + l[2] * 3 + a[1] * 3 + s[3] + -s[1] * 1 + -l[1] * 3
                <= RealNumRep::new(0, 1))
    );
    let tmp = IntervalList::new(vec![
        Interval::interval_point(RealNumRep::new(0, 1)),
    ...
    assert!(
        (l[1] == l[0])
            || (a[2] * 2 + -l[2] * 2 + -a[1] * 2 + -s[3] * 1 + s[0] + l[1] * 2
                <= RealNumRep::new(0, 1))
    );
    assert!(-a[1] * 1 + l[1] + s[1] <= RealNumRep::new(0, 1));
    ...
    assert!(
        (l[2] == l[1])
            || (-a[2] * 4 + l[2] * 4 + a[1] * 4 + s[3] + -s[0] * 1 + -l[1] * 4
                <= RealNumRep::new(0, 1))
    );
    assert!(
        (-s[4] * 1 / 2 + s[1] * 1 / 2 <= RealNumRep::new(-5, 1))
    ...
    assert!(
        (l[1] == l[0])
            || (a[2] + -l[2] * 1 + -a[1] * 2 + s[0] + l[1] * 2 <= RealNumRep::new(-5, 1))
    );
    if !(!(RealNumRep::new(0, 1) <= -l[2] * 1 + l[1])) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(RealNumRep::new(5, 1)),
            Interval::interval_lower(a[2] + -s[4] * 1 + a[4] + -a[3] * 1 + -l[1] * 1),
    ...
    if !(!(RealNumRep::new(0, 1) <= -l[2] * 1 + l[1])) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(a[2] + -s[4] * 1 + a[4] + -a[3] * 1 + -l[1] * 1),
            Interval::interval_lower(a[2] + -l[2] * 1 + -s[4] * 1 / 2 + -s[2] * 1 / 2),
    ...
    if !(!(RealNumRep::new(0, 1) <= -l[2] * 1 + l[1])) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(a[2] + -s[4] * 1 + a[4] + -a[3] * 1 + -l[1] * 1),
            Interval::interval_lower(a[2] + -l[2] * 1 + -s[3] * 1),
            Interval::interval_lower(-l[2] * 1 + -s[4] * 2 + a[4] + s[2]),
        ]);
        ret = ret.intersection(&tmp);
    }
    ...
    assert!(
        (l[2] == l[1])
            || (-a[2] * 1 + l[2] + s[3] * 1 / 2 + s[1] * 1 / 2 <= RealNumRep::new(-5, 1))
    );
    let tmp = IntervalList::new(vec![
        Interval::interval_point(RealNumRep::new(0, 1)),
    ...
    assert!(
        (l[2] == l[1])
            || (-a[2] * 3 + l[2] * 3 + a[1] * 3 + -a[0] * 1 + s[3] + -l[1] * 3 + l[0]
                <= RealNumRep::new(0, 1))
    );
    assert!(
        (l[2] == l[1])
    ...
    assert!(
        (l[2] == l[1])
            || (-a[2] * 1 + l[2] + -a[0] * 1 + s[1] * 2 + l[0] <= RealNumRep::new(-5, 1))
    );
    assert!(
        (-a[2] * 2 + l[2] * 2 + a[1] * 2 + s[2] + -s[1] * 1 + -l[1] * 2 <= RealNumRep::new(0, 1))
            || (RealNumRep::new(0, 1) <= -l[2] * 1 + l[1])
    );
    assert!(
        (l[1] == l[0])
            || (a[2] * 3 + -l[2] * 3 + -s[4] * 1 + -a[1] * 3 + s[0] + l[1] * 3
                <= RealNumRep::new(0, 1))
    );
    let tmp = IntervalList::new(vec![
        Interval::interval_point(RealNumRep::new(0, 1)),
    ...
    let tmp = IntervalList::new(vec![
        ...
        Interval::interval_upper(RealNumRep::new(-10, 1) + -a[2] * 1 + a[4]),
    ]);
    ret = ret.intersection(&tmp);
    if !(!(RealNumRep::new(0, 1) <= -l[2] * 1 + l[1])) {
        let tmp = IntervalList::new(vec![
    ...
    let tmp = IntervalList::new(vec![
        ...
        Interval::interval_lower(
            RealNumRep::new(5, 1) + a[2] + -l[2] * 1 + -s[4] * 1 + a[4] + -a[3] * 1,
        ),
    ]);
    ret = ret.intersection(&tmp);
    let tmp = IntervalList::new(vec![
    ...
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(RealNumRep::new(0, 1)),
            Interval::interval_lower(a[4] + -a[3] * 1 + a[1] + -s[3] * 1 + -l[1] * 1),
            Interval::interval_lower(-a[2] * 2 + l[2] + a[4] + a[1] * 2 + -s[3] * 1 + -l[1] * 2),
        ]);
        ret = ret.intersection(&tmp);
    }
    assert!(
        (a[2] + -l[2] * 1 + -s[3] * 1 <= RealNumRep::new(0, 1))
            || (l[0] + -a[0] * 1 + -s[3] * 1 + s[1] * 2 <= RealNumRep::new(0, 1))
    );
    assert!(
        (a[1] + -l[1] * 1 + -s[2] * 1 <= RealNumRep::new(0, 1))
            || (-a[2] * 1 + l[2] + s[4] + -s[2] * 2 + s[0] * 2 <= RealNumRep::new(0, 1))
    ...
    let tmp = IntervalList::new(vec![
        ...
        Interval::interval_lower(a[2] + -l[2] * 2 + -s[4] * 2 + a[4]),
        Interval::interval_lower(
            RealNumRep::new(5, 1) + a[2] + -l[2] * 1 + -s[4] * 1 + a[4] + -a[3] * 1,
        ),
    ]);
    ...
    let tmp = IntervalList::new(vec![
        Interval::interval_point(RealNumRep::new(0, 1)),
        Interval::interval_upper(a[2] + -l[2] * 2 + a[4] + -s[3] * 2),
    ]);
    ret = ret.intersection(&tmp);
    if !(a[2] + -l[2] * 1 + -s[3] * 1 <= RealNumRep::new(0, 1)) {
        let tmp = IntervalList::new(vec![
    ...
    if !((-a[2] * 2 + l[2] + a[3] + a[1] + -l[1] * 1 <= RealNumRep::new(0, 1))
        || (RealNumRep::new(0, 1) <= -l[2] * 1 + l[1]))
    {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(a[4] + -a[3] * 1 + a[1] + -s[3] * 1 + -l[1] * 1),
    ...
    assert!(
        (l[1] == l[0])
            || (a[2] + -l[2] * 1 + -a[1] * 1 + -s[3] * 1 + s[1] + l[1] <= RealNumRep::new(0, 1))
    );
    assert!(
        (a[2] + -l[2] * 1 + -s[3] * 1 <= RealNumRep::new(0, 1))
    ...
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_point(RealNumRep::new(0, 1)),
            Interval::interval_upper(a[2] * 1 / 2 + -l[2] * 1 + a[4] * 1 / 2 + -s[3] * 1),
        ]);
        ret = ret.intersection(&tmp);
    }
    assert!(
        (l[1] == l[0])
            || (a[2] * 2 + -l[2] * 2 + -s[4] * 1 + -a[1] * 2 + s[1] + l[1] * 2
                <= RealNumRep::new(0, 1))
    );
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![Interval::interval_upper(a[2] + -l[2] * 1 + -s[2] * 1)]);
    ...
    ret = ret.intersection(&tmp);
    assert!(
        (!(RealNumRep::new(0, 1) <= -a[2] * 1 + l[2] + s[2]))
            || (RealNumRep::new(0, 1)
                <= -a[2] * 1 + l[2] + s[4] * 1 / 2 + a[1] * 1 / 2 + -l[1] * 1 / 2)
    );
    assert!(-s[4] * 1 / 2 + -a[1] * 1 / 2 + l[1] * 1 / 2 + s[2] <= RealNumRep::new(0, 1));
    let tmp = IntervalList::new(vec![
        Interval::interval_point(RealNumRep::new(0, 1)),
    ...
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_point(RealNumRep::new(0, 1)),
            Interval::interval_upper(
                -a[2] * 3 + l[2] * 2 + a[4] + a[1] * 3 + -s[1] * 1 + -l[1] * 3,
            ),
        ]);
        ret = ret.intersection(&tmp);
    }
    ...
    assert!(
        (l[1] == l[0])
            || (a[2] + -l[2] * 1 + -s[4] * 1 + -a[1] * 1 + s[2] + l[1] <= RealNumRep::new(0, 1))
    );
    if !(a[1] + -l[1] * 1 + -s[2] * 1 <= RealNumRep::new(0, 1)) {
        let tmp = IntervalList::new(vec![
    ...
    assert!((l[2] == l[1]) || (-a[2] * 1 + l[2] + s[1] <= RealNumRep::new(-10, 1)));
    if !(!(RealNumRep::new(0, 1) <= -l[2] * 1 + l[1])) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(a[2] + -s[4] * 1 + a[4] + -a[3] * 1 + -l[1] * 1),
            Interval::interval_lower(a[2] + -l[2] * 1 + -s[3] * 1),
    ...
    let tmp = IntervalList::new(vec![
        Interval::interval_lower(a[2] + -l[2] * 1 + -s[3] * 1),
        Interval::interval_lower(-l[2] * 1 + a[4] + -s[3] * 3 + s[1] * 2),
        Interval::interval_lower(a[2] * 2 + -l[2] * 1 + a[4] + -a[3] * 2 + -s[3] * 1),
    ]);
    ret = ret.intersection(&tmp);
    assert!(
        (-a[2] * 1 + l[2] + a[1] + -a[0] * 1 + s[1] + -l[1] * 1 + l[0] <= RealNumRep::new(0, 1))
            || (RealNumRep::new(0, 1) <= -l[2] * 1 + l[1])
    );
    if !(a[2] + -l[2] * 1 + -s[3] * 1 <= RealNumRep::new(0, 1)) {
        let tmp = IntervalList::new(vec![
    ...
    assert!(
        (a[2] + -l[2] * 1 + -s[3] * 1 <= RealNumRep::new(0, 1))
            || (s[4] + -l[1] * 2 + a[1] * 2 + -s[3] * 3 <= RealNumRep::new(0, 1))
            || (s[4] * 1 / 2 + -s[3] * 1 + s[0] * 1 / 2 <= RealNumRep::new(0, 1))
    );
    assert!(
        (l[2] == l[1])
            || (a[1] + -l[1] * 1 + -s[2] * 1 <= RealNumRep::new(0, 1))
            || (!(a[2] + -l[2] * 1 + -s[4] * 1 + s[2] + -s[0] * 1 <= RealNumRep::new(0, 1)))
    );
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_point(RealNumRep::new(0, 1)),
            Interval::interval_upper(a[2] + -l[2] * 1 + a[4] + -a[3] * 1 + -s[3] * 1),
        ]);
        ret = ret.intersection(&tmp);
    }
    assert!(
    ...
    if !(RealNumRep::new(0, 1) <= -l[2] * 1 + l[1]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(RealNumRep::new(0, 1)),
            Interval::interval_lower(-a[2] * 1 + -s[4] * 1 + a[4] + a[1] + -l[1] * 1),
            Interval::interval_lower(a[2] + -l[2] * 1 + -s[4] * 1 + a[4] + -a[3] * 1),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_point(RealNumRep::new(0, 1)),
            Interval::interval_upper(-a[2] * 1 + a[4] + a[1] + -s[3] * 1 + -l[1] * 1),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !(l[1] == l[0]) {
    ...
    if !(a[1] + -l[1] * 1 + -s[2] * 1 <= RealNumRep::new(0, 1)) {
        let tmp = IntervalList::new(vec![
            ...
            Interval::interval_lower(a[2] + -l[2] * 1 + -s[2] * 2 + s[0]),
            Interval::interval_lower(a[2] + -l[2] * 1 + a[4] + -a[3] * 1 + -s[2] * 3 + s[0] * 2),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !((a[1] + -l[1] * 1 + -s[2] * 1 <= RealNumRep::new(0, 1))
    ...
    if !((l[1] == l[0]) || (!(RealNumRep::new(0, 1) <= -l[2] * 1 + l[1]))) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(a[2] + -s[4] * 1 + a[4] + -a[3] * 1 + -l[1] * 1),
            Interval::interval_lower(a[2] * 2 + -l[2] * 2 + -s[4] * 1 + -a[1] * 1 + l[1]),
            Interval::interval_lower(-l[2] * 1 + -s[4] * 3 / 2 + a[4] + s[1] * 1 / 2),
        ]);
        ret = ret.intersection(&tmp);
    }
    ...
    let tmp = IntervalList::new(vec![
        Interval::interval_lower(RealNumRep::new(5, 1)),
        Interval::interval_lower(-l[2] * 1 + -s[4] * 4 / 3 + a[4] + s[0] * 1 / 3),
        Interval::interval_lower(-l[2] * 1 + -s[4] * 3 / 2 + -l[1] * 1 / 2 + a[1] * 1 / 2 + a[4]),
        Interval::interval_lower(a[2] + -l[2] * 1 + -s[4] * 1 + a[4] + -a[3] * 1),
    ]);
    ret = ret.intersection(&tmp);
    let tmp = IntervalList::new(vec![
        Interval::interval_lower(a[2] + -l[2] * 1 + -s[4] * 3 / 4 + -s[0] * 1 / 4),
        Interval::interval_lower(-l[2] * 1 + -s[4] * 4 / 3 + a[4] + s[0] * 1 / 3),
        Interval::interval_lower(-l[2] * 1 + -s[4] * 3 / 2 + -l[1] * 1 / 2 + a[1] * 1 / 2 + a[4]),
        Interval::interval_lower(a[2] + -l[2] * 1 + -s[4] * 1 + a[4] + -a[3] * 1),
    ]);
    ...
    assert!(
        (l[2] == l[1])
            || (-a[2] * 2 + l[2] * 2 + a[1] * 2 + -a[0] * 1 + s[2] + -l[1] * 2 + l[0]
                <= RealNumRep::new(0, 1))
    );
    let tmp = IntervalList::new(vec![
        Interval::interval_lower(a[2] + -l[2] * 1 + -s[4] * 3 / 4 + -s[0] * 1 / 4),
        ...
        || (RealNumRep::new(0, 1) <= -l[2] * 1 + l[1]))
    {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(RealNumRep::new(0, 1)),
            Interval::interval_lower(
                -a[2] * 3 + l[2] * 2 + a[4] + a[1] * 3 + -s[2] * 1 + -l[1] * 3,
            ),
        ]);
        ret = ret.intersection(&tmp);
    }
    ...
    if !((!(-a[2] * 2 + l[2] + a[3] + a[1] + -l[1] * 1 <= RealNumRep::new(0, 1)))
        || (-a[2] * 3 + l[2] * 2 + a[4] + a[1] * 2 + -l[1] * 2 <= RealNumRep::new(0, 1))
        || (RealNumRep::new(0, 1) <= -l[2] * 1 + l[1]))
    {
        let tmp = IntervalList::new(vec![Interval::interval_lower(
            -a[2] * 1 + l[2] + a[1] * 2 + -a[0] * 1 + -l[1] * 2 + l[0],
    ...
    assert!(
        (-s[4] * 1 / 2 + -a[0] * 1 + s[1] * 3 / 2 + l[0] <= RealNumRep::new(0, 1))
            || (a[2] + -l[2] * 1 + -s[4] * 1 + l[0] + -a[0] * 1 + s[1] <= RealNumRep::new(0, 1))
    );
    ...
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_point(RealNumRep::new(0, 1)),
            Interval::interval_upper(-a[2] * 2 + l[2] + a[4] + a[1] * 2 + -s[2] * 1 + -l[1] * 2),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !(RealNumRep::new(0, 1) <= -l[2] * 1 + l[1]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(RealNumRep::new(5, 1)),
            Interval::interval_lower(
                RealNumRep::new(5, 1) + -a[2] * 3 + l[2] * 2 + a[4] + a[1] * 2 + -l[1] * 2,
            ),
            Interval::interval_lower(
                RealNumRep::new(5, 1) + -a[2] * 1 + l[2] + a[4] + -a[3] * 1 + a[1] + -l[1] * 1,
            ),
        ]);
        ret = ret.intersection(&tmp);
    }
    let tmp = IntervalList::new(vec![
        Interval::interval_point(RealNumRep::new(0, 1)),
        Interval::interval_upper(-a[2] * 3 + l[2] * 2 + a[4] + s[1] * 2),
        Interval::interval_upper(-l[2] * 1 + a[4] + -s[1] * 5 / 2 + s[0] * 3 / 2),
    ]);
    ret = ret.intersection(&tmp);
    if !(!(RealNumRep::new(0, 1) <= -a[2] * 1 + l[2] + s[1] * 3 / 2 + -s[0] * 1 / 2)) {
        let tmp = IntervalList::new(vec![
            Interval::interval_point(RealNumRep::new(0, 1)),
            Interval::interval_upper(-a[2] * 1 + a[4] + -s[1] * 1 + s[0]),
        ]);
        ret = ret.intersection(&tmp);
    }
    assert!(
        (l[2] == l[1])
            || (-a[2] * 1 + l[2] + s[1] * 3 / 2 + -s[0] * 1 / 2 <= RealNumRep::new(-5, 1))
    );
    assert!((l[2] == l[1]) || (!(RealNumRep::new(-5, 1) <= -a[2] * 2 + l[2] * 2 + s[4] + s[1])));
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_point(RealNumRep::new(0, 1)),
            Interval::interval_upper(
    ...
    if !(a[2] + -l[2] * 1 + -s[3] * 1 <= RealNumRep::new(0, 1)) {
        let tmp = IntervalList::new(vec![
            Interval::interval_upper(-a[4] * 1 + a[3] + a[1] + -s[0] * 1 + -l[1] * 1),
            Interval::interval_lower(
                -l[2] * 1 / 2 + a[3] * 1 / 2 + a[1] * 1 / 2 + -s[3] * 1 + -l[1] * 1 / 2,
            ),
    ...
    if !((a[2] + -l[2] * 1 + -s[3] * 1 <= RealNumRep::new(0, 1))
        || (!(-l[2] * 1 + a[3] + -a[1] * 1 + l[1] <= RealNumRep::new(10, 1))))
    {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(-l[2] * 1 + a[4] + -s[3] * 2 + s[0]),
            Interval::interval_lower(RealNumRep::new(5, 1) + a[1] + -s[3] * 1 + -l[1] * 1),
    ...
    if !(a[2] + -l[2] * 1 + -s[3] * 1 <= RealNumRep::new(0, 1)) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(-s[4] * 1 + a[4] * 2 + -a[3] * 2 + a[1] + -l[1] * 1),
            Interval::interval_lower(s[4] * 1 / 2 + a[1] + -s[3] * 3 / 2 + -l[1] * 1),
            Interval::interval_lower(-l[2] * 1 + a[4] + -s[3] * 2 + s[0]),
        ]);
        ret = ret.intersection(&tmp);
    ...
    assert!(
        (l[1] == l[0])
            || (a[2] + -l[2] * 1 + -a[1] * 1 + -s[2] * 1 + s[0] + l[1] <= RealNumRep::new(0, 1))
    );
    assert!(
        (l[1] == l[0])
            || (!(RealNumRep::new(0, 1)
    ...
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_point(RealNumRep::new(0, 1)),
            Interval::interval_upper(
                -a[2] * 4 + l[2] * 3 + a[4] + a[1] * 4 + -s[0] * 1 + -l[1] * 4,
            ),
        ]);
        ret = ret.intersection(&tmp);
    }
    ...
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_point(RealNumRep::new(0, 1)),
            Interval::interval_upper(RealNumRep::new(-5, 1) + a[2] + -l[2] * 2 + a[4] + -s[3] * 2),
        ]);
        ret = ret.intersection(&tmp);
    }
    let tmp = IntervalList::new(vec![
    ...
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(RealNumRep::new(5, 1)),
            Interval::interval_lower(
                RealNumRep::new(10, 1) + -a[2] * 1 + l[2] + a[4] + -a[3] * 1 + s[1],
            ),
            Interval::interval_lower(
                RealNumRep::new(15, 1) + -a[2] * 3 + l[2] * 2 + a[4] + s[1] * 2,
            ),
        ]);
        ret = ret.intersection(&tmp);
    }
    ...
    let tmp = IntervalList::new(vec![
        Interval::interval_lower(a[2] + -l[2] * 1 + -s[3] * 1),
        Interval::interval_lower(-l[2] * 1 + a[4] + -s[3] * 3 + s[1] * 2),
        Interval::interval_lower(a[2] + -l[2] * 1 + a[4] + -a[3] * 1 + -s[3] * 2 + s[1]),
    ]);
    ret = ret.intersection(&tmp);
    let tmp = IntervalList::new(vec![
        Interval::interval_point(RealNumRep::new(0, 1)),
        Interval::interval_upper(-l[2] * 1 + a[4] + a[0] * 3 + -s[1] * 4 + -l[0] * 3),
        Interval::interval_upper(-a[2] * 1 + a[4] + a[0] * 2 + -s[1] * 2 + -l[0] * 2),
    ]);
    ret = ret.intersection(&tmp);
    if !(a[1] + -l[1] * 1 + -s[2] * 1 <= RealNumRep::new(0, 1)) {
        let tmp = IntervalList::new(vec![
    ...
    if !((RealNumRep::new(0, 1) <= -l[1] * 1 + l[0])
        || (!(-a[2] * 2 + l[2] + a[3] + a[1] + -l[1] * 1 <= RealNumRep::new(0, 1)))
        || (RealNumRep::new(0, 1) <= -l[2] * 1 + l[1]))
    {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(a[2] * 2 + -l[2] * 2 + -s[4] * 1 + -a[1] * 1 + l[1]),
    ...
    assert!(
        (l[2] == l[1])
            || (-a[2] * 3 + l[2] * 3 + a[1] * 3 + s[2] + -s[0] * 1 + -l[1] * 3
                <= RealNumRep::new(0, 1))
    );
    if !((l[2] == l[1]) || (!(l[1] == l[0]))) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(-a[2] * 1 + l[2] + a[1] * 2 + -a[0] * 1 + -l[1] * 2 + l[0]),
            Interval::interval_lower(
                -a[2] * 4 + l[2] * 3 + a[4] + a[1] * 4 + -a[0] * 1 + -l[1] * 4 + l[0],
            ),
            Interval::interval_lower(
                -a[2] * 2 + l[2] * 2 + a[4] + -a[3] * 1 + a[1] * 3 + -a[0] * 1 + -l[0] * 2,
            ),
        ]);
        ret = ret.intersection(&tmp);
    }
    ...
    if !(!(RealNumRep::new(0, 1) <= -l[2] * 1 + l[1])) {
        let tmp = IntervalList::new(vec![
            ...
            Interval::interval_lower(-l[2] * 1 + -s[4] * 3 / 2 + a[4] + s[1] * 1 / 2),
            Interval::interval_lower(
                a[2] + -l[2] * 1 + -s[4] * 1 / 2 + -a[1] * 1 / 2 + l[1] * 1 / 2,
            ),
        ]);
        ret = ret.intersection(&tmp);
    }
    let tmp = IntervalList::new(vec![
        Interval::interval_lower(-l[2] * 1 + -s[4] * 3 / 2 + a[4] + s[1] * 1 / 2),
        Interval::interval_lower(a[2] + -l[2] * 1 + -s[4] * 1 / 2 + -a[1] * 1 / 2 + l[1] * 1 / 2),
        Interval::interval_lower(a[2] + -l[2] * 1 + -s[4] * 1 + a[4] + -a[3] * 1),
    ]);
    ret = ret.intersection(&tmp);
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![Interval::interval_upper(
            RealNumRep::new(-5, 1) + a[2] + -l[2] * 1 + a[4] + -a[3] * 1 + -s[2] * 1,
        )]);
        ret = ret.intersection(&tmp);
    }
    assert!(
        (l[2] == l[1])
            || (!(RealNumRep::new(-5, 1) <= -a[2] * 2 + l[2] * 2 + s[4] + -l[1] * 1 + a[1]))
            || (!(RealNumRep::new(-5, 1) <= -a[2] * 3 + l[2] * 3 + s[4] * 2 + s[0]))
    );
    assert!(
        (l[2] == l[1])
            || (-a[2] * 2 + l[2] * 2 + a[1] + s[3] + -l[1] * 1 <= RealNumRep::new(-10, 1))
            || (-a[2] * 1 + l[2] + s[3] * 2 / 3 + s[0] * 1 / 3 <= RealNumRep::new(-5, 1))
    );
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_point(RealNumRep::new(0, 1)),
            Interval::interval_upper(
                a[2] + -l[2] * 1 + -s[4] * 2 / 3 + a[4] + -a[3] * 1 + -s[1] * 1 / 3,
            ),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !(a[2] * 2 + -l[2] * 2 + -s[4] * 1 + -s[2] * 1 <= RealNumRep::new(0, 1)) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(
    ...
    if !((l[2] == l[1]) || (-a[2] * 2 + l[2] + a[3] + a[1] + -l[1] * 1 <= RealNumRep::new(0, 1))) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(RealNumRep::new(5, 1)),
            Interval::interval_lower(
                -a[2] * 1 + l[2] + a[4] + -a[3] * 1 + a[1] * 2 + -s[2] * 1 + -l[1] * 2,
            ),
        ]);
        ret = ret.intersection(&tmp);
    }
    assert!(
        (-a[2] * 2 + l[2] * 2 + a[1] * 2 + s[1] + -s[0] * 1 + -l[1] * 2 <= RealNumRep::new(0, 1))
            || (RealNumRep::new(0, 1) <= -l[2] * 1 + l[1])
    );
    if !((RealNumRep::new(0, 1) <= -l[1] * 1 + l[0])
        || (-a[2] * 2 + l[2] + a[3] + a[1] + -l[1] * 1 <= RealNumRep::new(0, 1))
        ...
        || (RealNumRep::new(0, 1) <= -l[2] * 1 + l[1]))
    {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(RealNumRep::new(0, 1)),
            Interval::interval_lower(
                -a[2] * 5 + l[2] * 4 + a[4] + a[1] * 5 + -s[0] * 1 + -l[1] * 5,
            ),
        ]);
        ret = ret.intersection(&tmp);
    }
        ...
        || (RealNumRep::new(0, 1) <= -l[2] * 1 + l[1]))
    {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(RealNumRep::new(5, 1)),
            Interval::interval_lower(
                -a[2] * 3 + l[2] * 3 + a[4] + -a[3] * 1 + a[1] * 4 + -s[0] * 1 + -l[1] * 4,
            ),
        ]);
        ret = ret.intersection(&tmp);
    }
    ...
    let tmp = IntervalList::new(vec![
        Interval::interval_upper(-a[2] * 1 + l[2] + a[4] + -a[3] * 1 + a[1] + -l[1] * 1),
        Interval::interval_lower(
    ...
    if !(a[1] + -l[1] * 1 + -s[2] * 1 <= RealNumRep::new(0, 1)) {
        let tmp = IntervalList::new(vec![
            ...
            Interval::interval_lower(
                -a[2] * 1 + l[2] + s[4] + a[4] + -a[3] * 1 + -s[2] * 2 + s[0] * 2,
            ),
        ]);
        ret = ret.intersection(&tmp);
    }
    ...
    let tmp = IntervalList::new(vec![
        Interval::interval_lower(a[2] + -l[2] * 1 + -s[4] * 2 / 3 + -a[0] * 1 / 3 + l[0] * 1 / 3),
        Interval::interval_lower(-l[2] * 1 + -s[4] * 2 + a[4] + s[2]),
        Interval::interval_lower(a[2] + -l[2] * 1 + -s[4] * 1 + a[4] + -a[3] * 1),
    ]);
    ret = ret.intersection(&tmp);
    ...
    ret = ret.intersection(&tmp);
    let tmp = IntervalList::new(vec![
        Interval::interval_lower(a[2] + -l[2] * 1 + -s[4] * 2 / 3 + -s[1] * 1 / 3),
        Interval::interval_lower(-l[2] * 1 + -s[4] * 2 + a[4] + s[2]),
        Interval::interval_lower(a[2] + -l[2] * 1 + -s[4] * 1 + a[4] + -a[3] * 1),
    ]);
    ret = ret.intersection(&tmp);
    ...
    if !(a[2] + -l[2] * 1 + -s[3] * 1 <= RealNumRep::new(0, 1)) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(RealNumRep::new(5, 1)),
            Interval::interval_lower(-l[2] * 1 + a[4] + -s[3] * 2 + s[0]),
            Interval::interval_lower(-l[2] * 1 + -l[1] * 2 + a[1] * 2 + a[4] + -s[3] * 3),
            Interval::interval_lower(
    ...
    if !(!(l[1] == l[0])) {
        let tmp = IntervalList::new(vec![
            ...
            Interval::interval_lower(-l[2] * 1 + -s[4] * 2 + a[4] + s[2]),
            Interval::interval_lower(
                a[2] * 2 + -l[2] * 2 + -s[4] * 2 + a[4] + -a[3] * 1 + a[1] + -s[1] * 1 + -l[0] * 1,
            ),
            Interval::interval_lower(-s[4] * 1 / 3 + a[1] + -s[1] * 2 / 3 + -l[1] * 1),
        ]);
        ret = ret.intersection(&tmp);
    ...
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_point(RealNumRep::new(0, 1)),
            Interval::interval_upper(
                a[2] * 3 + -l[2] * 3 + -s[4] * 2 + a[4] + -a[3] * 1 + -s[1] * 1,
            ),
        ]);
        ret = ret.intersection(&tmp);
    }
    ...
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![
            ...
            Interval::interval_lower(
                RealNumRep::new(10, 1) + -a[2] * 1 + a[4] + -a[1] * 2 + s[0] * 2 + l[1] * 2,
            ),
        ]);
        ret = ret.intersection(&tmp);
    }
    ...
    if !(!(RealNumRep::new(0, 1) <= -l[2] * 1 + l[1])) {
        let tmp = IntervalList::new(vec![
            ...
            Interval::interval_lower(-l[2] * 1 + -s[4] * 4 / 3 + a[4] + s[0] * 1 / 3),
            Interval::interval_lower(
                -l[2] * 1 + -s[4] * 3 / 2 + -l[1] * 1 / 2 + a[1] * 1 / 2 + a[4],
            ),
        ]);
        ret = ret.intersection(&tmp);
    }
    ...
    {
        let tmp = IntervalList::new(vec![Interval::interval_lower(
            -a[2] * 4 + l[2] * 3 + a[4] + a[1] * 4 + -s[1] * 1 + -l[1] * 4,
        )]);
        ret = ret.intersection(&tmp);
    }
    if !(!(RealNumRep::new(0, 1) <= -l[2] * 1 + l[1])) {
    ...
    assert!(
        (l[2] == l[1]) || (!(RealNumRep::new(0, 1) <= -a[2] * 1 + l[2] + s[4] + -s[3] * 1 + s[1]))
    );
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![Interval::interval_upper(
            a[2] * 3 + -l[2] * 3 + -s[4] * 1 + -a[1] * 2 + l[1] * 2,
    ...
    let tmp = IntervalList::new(vec![
        ...
        Interval::interval_lower(
            RealNumRep::new(5, 1) + -s[4] * 1 / 2 + -l[1] * 1 / 2 + a[1] * 1 / 2 + a[4] + -a[3] * 1,
        ),
        Interval::interval_lower(
            RealNumRep::new(5, 1) + -s[4] * 1 / 3 + a[4] + -a[3] * 1 + s[0] * 1 / 3,
        ),
        ...
        || (RealNumRep::new(0, 1) <= -l[2] * 1 + l[1]))
    {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(RealNumRep::new(5, 1)),
            Interval::interval_lower(
                -a[2] * 2 + l[2] * 2 + a[4] + -a[3] * 1 + a[1] * 3 + -a[0] * 1 + -l[1] * 3 + l[0],
            ),
        ]);
        ret = ret.intersection(&tmp);
    }
    ...
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_point(RealNumRep::new(0, 1)),
            Interval::interval_upper(
                a[2] + -l[2] * 1 + -s[4] * 1 + a[4] + -a[3] * 1 + a[1] * 2 + -s[1] * 2 + -l[1] * 2,
            ),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_upper(a[2] + -l[2] * 1 + -s[3] * 2 / 3 + -s[0] * 1 / 3),
            Interval::interval_upper(
                a[2] + -l[2] * 1 + -a[1] * 1 / 2 + l[1] * 1 / 2 + -s[3] * 1 / 2,
            ),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_upper(a[2] + -l[2] * 1 + -s[4] * 1 / 2 + -s[0] * 1 / 2),
            Interval::interval_upper(
                a[2] + -l[2] * 1 + -s[4] * 1 / 3 + -a[1] * 2 / 3 + l[1] * 2 / 3,
            ),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !((-a[2] * 2 + l[2] + a[3] + a[1] + -l[1] * 1 <= RealNumRep::new(0, 1))
        || (!(RealNumRep::new(0, 1) <= a[2] + -l[2] * 1 + -a[4] * 1 + a[3] + -a[1] * 1 + l[1]))
        || (RealNumRep::new(0, 1) <= -l[2] * 1 + l[1]))
    {
        let tmp = IntervalList::new(vec![Interval::interval_lower(
            -a[2] * 3 + l[2] * 3 + a[4] + -a[3] * 1 + a[1] * 4 + -s[0] * 1 + -l[1] * 4,
    ...
    ret = ret.intersection(&tmp);
    if !(a[2] * 4 + -l[2] * 4 + -s[4] * 3 + -s[0] * 1 <= RealNumRep::new(0, 1)) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(
    ...
    let tmp = IntervalList::new(vec![
        Interval::interval_lower(-a[2] * 1 + l[2] + a[4] + -a[3] * 1 + a[1] + -l[1] * 1),
        Interval::interval_lower(a[2] + -l[2] * 1 + -s[4] * 1 + a[1] + -s[1] * 1 + -l[1] * 1),
        Interval::interval_lower(-l[2] * 1 + -s[4] * 4 / 3 + a[4] + s[0] * 1 / 3),
        Interval::interval_lower(-s[4] * 1 / 3 + a[1] + -s[1] * 2 / 3 + -l[1] * 1),
        Interval::interval_lower(
            a[2] * 2 + -l[2] * 2 + -s[4] * 2 + a[4] + -a[3] * 1 + a[1] + -s[1] * 1 + -l[1] * 1,
        ),
        Interval::interval_lower(a[2] + -l[2] * 2 + -s[4] * 2 + a[4]),
    ]);
    ret = ret.intersection(&tmp);
    ...
    let tmp = IntervalList::new(vec![
        ...
        Interval::interval_lower(-l[2] * 1 + -s[4] * 4 / 3 + a[4] + s[0] * 1 / 3),
        Interval::interval_lower(
            a[2] + -l[2] * 1 + -s[4] * 1 + a[4] + -a[3] * 1 + a[1] + -s[2] * 1 + -l[1] * 1,
        ),
        Interval::interval_lower(a[2] + -l[2] * 2 + -s[4] * 2 + a[4]),
    ]);
    ret = ret.intersection(&tmp);
    assert!(
        (l[2] == l[1])
            || (-a[2] * 1 + l[2] + a[1] + -l[1] * 1 <= RealNumRep::new(-10, 1))
            || (-a[2] * 1 + l[2] + s[0] <= RealNumRep::new(-15, 1))
    );
    if !(a[2] + -l[2] * 1 + -s[3] * 1 <= RealNumRep::new(0, 1)) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(a[4] + -a[3] * 1 + a[1] + -s[3] * 1 + -l[1] * 1),
    ...
    if !(a[2] + -l[2] * 1 + -s[3] * 1 <= RealNumRep::new(0, 1)) {
        let tmp = IntervalList::new(vec![
            ...
            Interval::interval_lower(s[4] + -l[1] * 2 + a[1] * 2 + a[4] + -a[3] * 1 + -s[3] * 3),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !(a[2] + -l[2] * 1 + -s[3] * 1 <= RealNumRep::new(0, 1)) {
        let tmp = IntervalList::new(vec![
            ...
            Interval::interval_lower(-l[2] * 1 + -l[1] * 2 + a[1] * 2 + a[4] + -s[3] * 3),
            Interval::interval_lower(
                a[2] + -l[2] * 1 + a[4] + -a[3] * 1 + -s[3] * 3 / 2 + s[0] * 1 / 2,
            ),
            Interval::interval_lower(
                a[2] + -l[2] * 1 + -l[1] * 1 + a[1] + a[4] + -a[3] * 1 + -s[3] * 2,
            ),
        ]);
        ret = ret.intersection(&tmp);
    }
    ...
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_point(RealNumRep::new(0, 1)),
            Interval::interval_upper(
                a[2] + -l[2] * 1 + -s[4] * 1 / 2 + a[4] + -a[3] * 1 + -s[2] * 1 / 2,
            ),
        ]);
        ret = ret.intersection(&tmp);
    }
        ...
        || (RealNumRep::new(0, 1) <= -l[2] * 1 + l[1]))
    {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(RealNumRep::new(5, 1)),
            Interval::interval_lower(
                -a[2] * 2 + l[2] * 2 + a[4] + -a[3] * 1 + a[1] * 3 + -s[1] * 1 + -l[1] * 3,
            ),
        ]);
        ret = ret.intersection(&tmp);
    }
    let tmp = IntervalList::new(vec![
        ...
        Interval::interval_lower(-l[2] * 1 + -s[4] * 3 / 2 + a[4] + s[1] * 1 / 2),
        Interval::interval_lower(
            a[2] * 3 + -l[2] * 3 + -s[4] * 3 + a[4] + -a[3] * 1 + a[1] + -s[0] * 1 + -l[1] * 1,
        ),
        Interval::interval_lower(a[2] + -l[2] * 2 + -s[4] * 2 + a[4]),
    ]);
    ret = ret.intersection(&tmp);
    ...
    assert!(
        (l[2] == l[1])
            || (!(RealNumRep::new(0, 1) <= -a[2] * 2 + l[2] * 2 + s[4] * 2 + -s[3] * 1 + s[0]))
            || (!(RealNumRep::new(0, 1) <= -a[2] * 1 + l[2] + s[4] + -l[1] * 1 + a[1] + -s[3] * 1))
    );
    let tmp = IntervalList::new(vec![
        Interval::interval_lower(RealNumRep::new(0, 1)),
        Interval::interval_lower(
    ...
    ret = ret.intersection(&tmp);
    if !(!(RealNumRep::new(0, 1) <= -a[2] * 1 + l[2] + s[4] + -a[4] * 1 + a[3])) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(-a[2] * 1 + l[2] + a[4] + -a[3] * 1 + a[1] + -l[1] * 1),
            Interval::interval_lower(-l[2] * 1 + -s[4] * 2 + a[4] + s[2]),
            Interval::interval_lower(
    ...
    if !(RealNumRep::new(0, 1) <= -l[1] * 1 + l[0]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_point(RealNumRep::new(0, 1)),
            Interval::interval_upper(
                -a[2] * 1 + l[2] + a[4] + -a[3] * 1 + a[1] * 2 + -s[1] * 1 + -l[1] * 2,
            ),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_point(RealNumRep::new(0, 1)),
            Interval::interval_upper(
                a[2] + -l[2] * 1 + a[4] + -a[3] * 1 + a[0] * 1 / 2 + -s[2] * 3 / 2 + -l[0] * 1 / 2,
            ),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_point(RealNumRep::new(0, 1)),
            Interval::interval_upper(
                a[2] + -l[2] * 1 + a[4] + -a[3] * 1 + -s[2] * 3 / 2 + s[1] * 1 / 2,
            ),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !(RealNumRep::new(0, 1) <= a[2] + -l[2] * 1 + -s[4] * 1 + a[4] + -a[3] * 1) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(-a[2] * 1 + l[2] + a[4] + -a[3] * 1 + a[1] + -l[1] * 1),
            Interval::interval_lower(-l[2] * 1 + -s[4] * 3 / 2 + a[4] + s[1] * 1 / 2),
            Interval::interval_lower(
    ...
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_point(RealNumRep::new(0, 1)),
            Interval::interval_upper(
                a[2] * 4 + -l[2] * 4 + -s[4] * 3 + a[4] + -a[3] * 1 + -s[0] * 1,
            ),
            Interval::interval_upper(
                a[2] * 3 + -l[2] * 3 + -s[4] * 2 + l[1] + -a[1] * 1 + a[4] + -a[3] * 1,
            ),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !((a[2] + -l[2] * 1 + -s[3] * 1 <= RealNumRep::new(0, 1))
        || (RealNumRep::new(0, 1) <= -a[2] * 1 + l[2] + s[4] + -a[4] * 1 + a[3]))
    {
        let tmp = IntervalList::new(vec![
            Interval::interval_upper(a[2] + -s[3] * 1 + -l[1] * 1),
            Interval::interval_lower(-l[2] * 1 + -s[4] * 3 / 2 + a[4] + s[1] * 1 / 2),
            Interval::interval_lower(s[4] * 1 / 2 + a[1] * 1 / 2 + -s[3] * 1 + -l[1] * 1 / 2),
        ]);
        ret = ret.intersection(&tmp);
    ...
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_point(RealNumRep::new(0, 1)),
            Interval::interval_upper(
                -a[2] * 2 + l[2] * 2 + a[4] + -a[3] * 1 + a[1] * 3 + -s[0] * 1 + -l[1] * 3,
            ),
        ]);
        ret = ret.intersection(&tmp);
    }
    ...
    if !(RealNumRep::new(0, 1) <= -l[2] * 1 + l[1]) {
        let tmp = IntervalList::new(vec![Interval::interval_upper(
            a[2] * 2 + -l[2] * 2 + -s[4] * 1 + a[4] + -a[3] * 1 + -a[1] * 1 + l[1],
        )]);
        ret = ret.intersection(&tmp);
    }
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_upper(a[2] * 2 + -l[2] * 2 + -s[4] * 1 + l[0] + -a[1] * 1),
            Interval::interval_upper(a[2] * 3 + -l[2] * 3 + -s[4] * 2 + -s[0] * 1),
        ]);
        ret = ret.intersection(&tmp);
    }
    assert!(
        (RealNumRep::new(0, 1) <= -l[1] * 1 + l[0])
            || (!(RealNumRep::new(0, 1) <= s[4] + -a[1] * 1 + -s[3] * 1 + s[0] + l[1]))
    );
    if !(RealNumRep::new(0, 1) <= a[2] + -l[2] * 1 + -s[4] * 1 + a[4] + -a[3] * 1) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(-a[2] * 1 + l[2] + a[4] + -a[3] * 1 + a[1] + -l[1] * 1),
    ...
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![
            ...
            Interval::interval_upper(
                -l[2] * 1 / 2 + a[3] * 1 / 2 + a[1] * 1 / 2 + -s[2] * 1 + -l[1] * 1 / 2,
            ),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![Interval::interval_upper(
            RealNumRep::new(-10, 1) + a[2] + -l[2] * 1 + a[4] + -a[3] * 1 + -s[1] * 1,
        )]);
        ret = ret.intersection(&tmp);
    }
    let tmp = IntervalList::new(vec![
    ...
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_point(RealNumRep::new(0, 1)),
            Interval::interval_upper(a[2] + -l[2] * 1 + a[4] + -a[3] * 1 + -s[1] * 2 + s[0]),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_point(RealNumRep::new(0, 1)),
            Interval::interval_upper(
                a[2] + -l[2] * 1 + a[4] + -a[3] * 1 + -s[2] * 4 / 3 + s[0] * 1 / 3,
            ),
        ]);
        ret = ret.intersection(&tmp);
    }
    ...
    if !(RealNumRep::new(0, 1) <= -a[2] * 1 + l[2] + s[4] + -a[4] * 1 + a[3]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(
                a[2] * 2 + -l[2] * 2 + -s[4] * 2 + a[1] + -s[0] * 1 + -l[1] * 1,
            ),
            Interval::interval_lower(-s[4] * 1 + a[4] * 2 + -a[3] * 2 + a[1] + -l[1] * 1),
            Interval::interval_lower(-l[2] * 1 + -s[4] * 2 + a[4] + s[2]),
            Interval::interval_lower(-s[4] * 1 / 2 + a[1] + -s[0] * 1 / 2 + -l[1] * 1),
    ...
    let tmp = IntervalList::new(vec![
        Interval::interval_upper(-a[2] * 2 + l[2] * 2 + s[4] + a[1] + -l[1] * 1),
        Interval::interval_lower(
            -s[4] * 2 / 3 + a[4] + -a[3] * 1 + a[1] + -s[1] * 1 / 3 + -l[1] * 1,
        ),
        Interval::interval_lower(-l[2] * 1 + -s[4] * 4 / 3 + a[4] + s[0] * 1 / 3),
    ...
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![
            ...
            Interval::interval_lower(RealNumRep::new(10, 1) + -a[2] * 2 + l[2] + a[4] + s[0]),
            Interval::interval_lower(
                RealNumRep::new(15, 1) + -a[2] * 3 + l[2] * 2 + -l[1] * 2 + a[4] + a[1] * 2,
            ),
            Interval::interval_lower(
                RealNumRep::new(10, 1) + -a[2] * 1 + l[2] + -l[1] * 1 + a[1] + a[4] + -a[3] * 1,
            ),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !(a[2] + -l[2] * 1 + -s[4] * 1 <= RealNumRep::new(-5, 1)) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(-l[2] * 1 + -s[4] * 4 / 3 + a[4] + s[0] * 1 / 3),
            Interval::interval_lower(
                RealNumRep::new(5, 1) + -s[4] * 1 + a[4] + -a[3] * 1 + a[1] + -l[1] * 1,
    ...
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_point(RealNumRep::new(0, 1)),
            Interval::interval_upper(
                a[2] + -l[2] * 1 + -l[1] * 1 + a[1] + a[4] + -a[3] * 1 + -s[2] * 2,
            ),
        ]);
        ret = ret.intersection(&tmp);
    }
    ...
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_point(RealNumRep::new(0, 1)),
            Interval::interval_upper(
                a[2] + -l[2] * 1 + a[4] + -a[3] * 1 + a[0] * 2 + -s[1] * 3 + -l[0] * 2,
            ),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_point(RealNumRep::new(0, 1)),
            Interval::interval_upper(
                a[2] * 2 + -l[2] * 2 + -s[4] * 1 + a[4] + -a[3] * 1 + -s[2] * 1,
            ),
        ]);
        ret = ret.intersection(&tmp);
    }
    ...
    if !((l[2] == l[1]) || (!(RealNumRep::new(-5, 1) <= -a[1] * 1 + s[0] + l[1]))) {
        let tmp = IntervalList::new(vec![Interval::interval_upper(
            RealNumRep::new(-10, 1) + a[2] + -l[2] * 1 + l[1] + -a[1] * 1 + a[4] + -a[3] * 1,
        )]);
        ret = ret.intersection(&tmp);
    }
    if !(l[1] == l[0]) {
    ...
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_point(RealNumRep::new(0, 1)),
            Interval::interval_upper(
                a[2] + -l[2] * 1 + -s[4] * 3 / 4 + a[4] + -a[3] * 1 + -s[0] * 1 / 4,
            ),
            Interval::interval_upper(
                a[2] + -l[2] * 1 + -s[4] * 2 / 3 + l[1] * 1 / 3 + -a[1] * 1 / 3 + a[4] + -a[3] * 1,
            ),
        ]);
        ret = ret.intersection(&tmp);
    }
    ...
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_point(RealNumRep::new(0, 1)),
            Interval::interval_upper(
                RealNumRep::new(-15, 1) + a[2] + -l[2] * 1 + a[4] + -a[3] * 1 + -s[0] * 1,
            ),
            Interval::interval_upper(RealNumRep::new(-15, 1) + -l[2] * 1 + l[1] + a[4] + -a[1] * 1),
        ]);
        ret = ret.intersection(&tmp);
...
pub fn compute_s_4_t_5_l_3(
    ...
    assert!(
        (l[2] == l[1])
            || (-a[2] * 2 + l[2] * 2 + a[1] * 2 + s[1] + -s[0] * 1 + -l[1] * 2
                <= RealNumRep::new(0, 1))
    );
    assert!(
        (l[2] == l[1])
            || (-a[2] * 1 + l[2] + a[1] + -a[0] * 1 + s[1] + -l[1] * 1 + l[0]
                <= RealNumRep::new(0, 1))
    );
    assert!(
        (l[2] == l[1])
    ...
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(-l[2] * 1 + a[3]),
            Interval::interval_lower(a[2] * 3 + -l[2] * 3 + -a[1] * 3 + s[0] + l[1] * 3),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![Interval::interval_upper(
            RealNumRep::new(-5, 1) + a[2] * 3 + -l[2] * 3 + -a[1] * 2 + l[1] * 2,
        )]);
        ret = ret.intersection(&tmp);
    }
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![Interval::interval_upper(
            a[2] * 4 + -l[2] * 4 + -a[1] * 4 + a[0] + l[1] * 4 + -l[0] * 1,
        )]);
        ret = ret.intersection(&tmp);
    }
    assert!(
        (l[2] == l[1])
            || (-a[2] * 2 + l[2] * 2 + s[3] + a[1] + -l[1] * 1 <= RealNumRep::new(-5, 1))
    );
    assert!(
        (l[2] == l[1])
            || (-a[2] * 3 + l[2] * 3 + s[3] + a[1] * 3 + -a[0] * 1 + -l[1] * 3 + l[0]
                <= RealNumRep::new(0, 1))
    );
    assert!(
        (l[2] == l[1])
            || (-a[2] * 4 + l[2] * 4 + s[3] + a[1] * 4 + -s[0] * 1 + -l[1] * 4
                <= RealNumRep::new(0, 1))
    );
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![Interval::interval_upper(
            a[2] * 5 + -l[2] * 5 + -a[1] * 5 + s[0] + l[1] * 5,
        )]);
        ret = ret.intersection(&tmp);
    }
    if !(l[1] == l[0]) {
    ...
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(-l[2] * 1 + a[3]),
            Interval::interval_lower(a[2] + -l[2] * 1 + -a[1] * 1 + s[2] + l[1]),
        ]);
        ret = ret.intersection(&tmp);
    }
    assert!(
        (l[2] == l[1])
            || (-a[2] * 3 + l[2] * 3 + s[3] + a[1] * 3 + -s[1] * 1 + -l[1] * 3
                <= RealNumRep::new(0, 1))
    );
    ...
    assert!(
        (l[2] == l[1])
            || (-a[2] * 1 + l[2] + s[3] * 2 / 3 + s[0] * 1 / 3 <= RealNumRep::new(-5, 1))
            || (-a[2] * 2 + l[2] * 2 + s[3] + -l[1] * 1 + a[1] <= RealNumRep::new(-10, 1))
    );
    let tmp = IntervalList::new(vec![
        Interval::interval_lower(-l[2] * 1 + a[3]),
        Interval::interval_lower(s[2] * 4 / 3 + -s[0] * 1 / 3),
    ...
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(-l[2] * 1 + a[3]),
            Interval::interval_lower(a[2] * 2 + -l[2] * 2 + -a[1] * 2 + s[1] + l[1] * 2),
        ]);
        ret = ret.intersection(&tmp);
    }
    assert!(
    ...
    assert!(
        (l[2] == l[1])
            || (-a[2] * 2 + l[2] * 2 + s[3] + a[1] * 2 + -s[2] * 1 + -l[1] * 2
                <= RealNumRep::new(0, 1))
    );
    assert!(
        (l[2] == l[1])
            || (-a[2] * 2 + l[2] * 2 + a[1] * 2 + s[2] + -s[1] * 1 + -l[1] * 2
                <= RealNumRep::new(0, 1))
    );
    assert!(
    ...
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![Interval::interval_upper(
            a[2] * 2 + -l[2] * 2 + a[4] + -a[3] * 1 + -a[1] * 1 + l[1],
        )]);
        ret = ret.intersection(&tmp);
    }
    assert!((l[1] == l[0]) || (-a[1] * 1 + s[0] + l[1] <= RealNumRep::new(-10, 1)));
    ...
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_upper(
                RealNumRep::new(-5, 1) + a[2] * 2 + -l[2] * 2 + l[1] + -a[1] * 1 + a[4] + -a[3] * 1,
            ),
            Interval::interval_upper(
                RealNumRep::new(-5, 2)
                    + a[2] * 3 / 2
    ...
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![Interval::interval_upper(
            RealNumRep::new(-15, 1) + a[2] * 3 + -l[2] * 3 + -s[1] * 2,
        )]);
        ret = ret.intersection(&tmp);
    }
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_upper(
                RealNumRep::new(-15, 1) + a[2] * 3 + -l[2] * 3 + l[1] * 2 + -a[1] * 2,
            ),
            Interval::interval_upper(RealNumRep::new(-10, 1) + a[2] * 2 + -l[2] * 2 + -s[0] * 1),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !((l[2] == l[1]) || (a[1] + -s[2] * 1 + -l[1] * 1 <= RealNumRep::new(0, 1))) {
        let tmp = IntervalList::new(vec![Interval::interval_upper(
            a[2] + -l[2] * 1 + a[4] + -a[3] * 1 + s[2] + -s[0] * 1,
        )]);
        ret = ret.intersection(&tmp);
    }
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_upper(
                RealNumRep::new(-5, 1) + a[2] + -l[2] * 2 + a[3] + -a[1] * 1 + l[1],
            ),
            Interval::interval_upper(
                RealNumRep::new(-5, 2) + a[2] * 1 / 2 + -l[2] * 3 / 2 + a[3] + -s[0] * 1 / 2,
            ),
        ]);
        ret = ret.intersection(&tmp);
    }
    ...
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![Interval::interval_upper(
            RealNumRep::new(-5, 1) + a[2] + -l[2] * 2 + a[3] + -s[1] * 1,
        )]);
        ret = ret.intersection(&tmp);
    }
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![Interval::interval_upper(
            RealNumRep::new(-5, 1) + a[2] * 2 + -l[2] * 2 + a[4] + -a[3] * 1 + -s[1] * 1,
        )]);
        ret = ret.intersection(&tmp);
    }
    assert!(l[0] >= RealNumRep::new(0, 1));
...
pub fn compute_sim_s_4_t_5_l_3(
    ...
    assert!(
        (l[1] == l[0]) || (a[2] + -l[2] * 1 + -a[1] * 1 + -C * 1 + l[1] <= RealNumRep::new(0, 1))
    );
    assert!(
        (l[2] == l[1])
            || (-a[2] * 1 + l[2] + a[1] + C + -l[1] * 1 == RealNumRep::new(0, 1))
            || (!(a[2] + -l[2] * 1 + -a[1] * 1 + -C * 1 + l[1] <= RealNumRep::new(0, 1)))
    );
    if !(RealNumRep::new(0, 1) <= -a[2] * 1 + l[2] + a[1] + C + -l[1] * 1 + -B * 1) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(-l[2] * 1 + a[3]),
    ...
    assert!((l[1] == l[0]) || (s[3] + B + -C * 2 + -a[1] * 1 + l[1] <= RealNumRep::new(0, 1)));
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![Interval::interval_upper(
            -B * 1 + C * 3 + a[1] + -l[1] * 1,
        )]);
    ...
    assert!((l[2] == l[1]) || (-a[2] * 1 + l[2] + B + C + s[1] <= RealNumRep::new(0, 1)));
    assert!(
        (l[2] == l[1])
            || (RealNumRep::new(0, 1) <= a[2] + -l[2] * 1 + -B * 1 + -C * 1 + -a[1] * 1 + l[1])
            || (-a[2] * 1 + l[2] + B + C * 2 + s[0] <= RealNumRep::new(0, 1))
    );
    assert!((l[2] == l[1]) || (!(RealNumRep::new(0, 1) <= -l[2] * 1 + l[1])));
    assert!((l[2] == l[1]) || (-a[2] * 1 + l[2] + B + s[2] <= RealNumRep::new(0, 1)));
    assert!(a[2] + -l[2] * 1 + -B * 1 + -C * 2 + -a[0] * 1 + l[0] <= RealNumRep::new(0, 1));
    assert!(
        (-a[2] * 1 + l[2] + -l[1] * 1 + a[1] + B + C == RealNumRep::new(0, 1))
            || (!(RealNumRep::new(0, 1) <= a[2] + -l[2] * 1 + -B * 1 + -C * 1 + -a[1] * 1 + l[1]))
    );
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![Interval::interval_upper(
    ...
    assert!((l[2] == l[1]) || (-a[2] * 1 + l[2] + s[3] + B + -C * 1 <= RealNumRep::new(0, 1)));
    assert!(-C * 1 + -a[0] * 1 + s[1] + l[0] <= RealNumRep::new(0, 1));
    let tmp = IntervalList::new(vec![
        Interval::interval_lower(-l[2] * 1 + a[3]),
        Interval::interval_lower(a[2] + -l[2] * 1 + -B * 1 + C),
    ]);
    ret = ret.intersection(&tmp);
    assert!(a[2] + -l[2] * 1 + -B * 1 + -C * 2 + -s[1] * 1 <= RealNumRep::new(0, 1));
    assert!(a[2] + -l[2] * 1 + -B * 1 + -C * 1 + -s[2] * 1 <= RealNumRep::new(0, 1));
    assert!(a[2] + -l[2] * 1 + -B * 1 + -C * 3 + -s[0] * 1 <= RealNumRep::new(0, 1));
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![Interval::interval_upper(
            a[2] + -l[2] * 1 + C + a[4] + -a[3] * 1,
        )]);
        ret = ret.intersection(&tmp);
    }
    let tmp = IntervalList::new(vec![
    ...
    assert!(s[3] + l[1] + -a[1] * 1 + -C * 2 <= RealNumRep::new(0, 1));
    assert!(l[1] + -a[1] * 1 + -C * 1 + s[2] <= RealNumRep::new(0, 1));
    let tmp = IntervalList::new(vec![Interval::interval_upper(C * 4 + a[0] + -l[0] * 1)]);
    ret = ret.intersection(&tmp);
    let tmp = IntervalList::new(vec![Interval::interval_upper(C * 3 + s[2])]);
    ...
    ret = ret.intersection(&tmp);
    assert!(s[3] + -C * 2 + -s[2] * 1 <= RealNumRep::new(0, 1));
    assert!(-a[2] * 1 + l[2] + s[3] + -C * 1 <= RealNumRep::new(0, 1));
    ret
}
...
pub fn compute_c_t_5_l_4(
    ...
    if !((l[3] == l[2]) || (RealNumRep::new(0, 1) <= l[1] + -l[2] * 1)) {
        let tmp = IntervalList::new(vec![Interval::interval_point(
            -l[3] * 1 + a[3] + -a[2] * 1 + l[2],
        )]);
        ret = ret.intersection(&tmp);
    ...
    if !(l[3] == l[2]) {
        let tmp = IntervalList::new(vec![
            ...
            Interval::interval_upper(RealNumRep::new(-5, 1) + -l[3] * 1 + a[3] + -a[2] * 1 + l[2]),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !(l[2] == l[1]) {
    ...
    let tmp = IntervalList::new(vec![
        ...
        Interval::interval_upper(s[3] * 1 / 2 + -s[0] * 1 / 2),
        Interval::interval_lower(a[2] * 1 / 2 + -s[0] * 1 / 2 + -l[2] * 1 / 2),
    ]);
    ret = ret.intersection(&tmp);
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![Interval::interval_lower(
    ...
    if !((l[3] == l[2])
        || (l[3] + -a[3] * 1 + a[2] + -l[2] * 1 + a[1] + -a[0] * 1 + -l[1] * 1 + l[0]
            <= RealNumRep::new(0, 1)))
    {
        let tmp = IntervalList::new(vec![Interval::interval_upper(
            -l[3] * 1 / 2 + a[3] * 1 / 2 + -a[1] * 1 / 2 + l[1] * 1 / 2,
    ...
    if !(l[3] == l[2]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(
                l[3] + -a[3] * 1 + a[2] + -l[2] * 1 + a[1] + -s[0] * 1 + -l[1] * 1,
            ),
            Interval::interval_upper(-l[3] * 1 / 2 + a[3] * 1 / 2 + -a[1] * 1 / 2 + l[1] * 1 / 2),
        ]);
        ret = ret.intersection(&tmp);
    ...
    assert!(-a[2] * 1 + l[2] + s[2] <= RealNumRep::new(0, 1));
    if !((l[3] == l[2])
        || (l[3] + -a[3] * 1 + a[2] + -l[2] * 1 + a[1] + -s[1] * 1 + -l[1] * 1
            <= RealNumRep::new(0, 1)))
    {
        let tmp = IntervalList::new(vec![Interval::interval_upper(
            -l[3] * 1 / 2 + a[3] * 1 / 2 + -a[1] * 1 / 2 + l[1] * 1 / 2,
    ...
    if !(l[3] == l[2]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_upper(-l[3] * 1 + a[3] + -a[2] * 1 + l[2] + -a[1] * 1 + s[2] + l[1]),
            Interval::interval_upper(-l[3] * 1 / 2 + a[3] * 1 / 2 + -a[1] * 1 / 2 + l[1] * 1 / 2),
        ]);
        ret = ret.intersection(&tmp);
    }
    ...
    assert!(
        (l[1] == l[0])
            || (-l[3] * 1 + a[3] + -a[2] * 1 + l[2] + -a[1] * 1 + s[0] + l[1]
                <= RealNumRep::new(0, 1))
    );
    let tmp = IntervalList::new(vec![Interval::interval_lower(s[2] * 1 / 3 + -s[0] * 1 / 3)]);
    ret = ret.intersection(&tmp);
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![Interval::interval_lower(
            -l[3] * 1 + a[3] + -a[2] * 1 + l[2] + -a[1] * 1 + s[1] + l[1],
        )]);
        ret = ret.intersection(&tmp);
    }
    let tmp = IntervalList::new(vec![Interval::interval_lower(s[3] * 1 / 3 + -s[1] * 1 / 3)]);
    ...
    if !(a[2] + -l[2] * 1 + -s[3] * 1 <= RealNumRep::new(0, 1)) {
        let tmp = IntervalList::new(vec![
            Interval::interval_upper(-a[1] * 1 + s[3] + l[1]),
            Interval::interval_upper(a[2] * 1 / 2 + -s[0] * 1 / 2 + -l[2] * 1 / 2),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !(l[3] == l[2]) {
    ...
    if !(l[3] == l[2]) {
        let tmp = IntervalList::new(vec![Interval::interval_upper(
            RealNumRep::new(-5, 1) + -l[3] * 1 + a[3] + -s[2] * 1,
        )]);
        ret = ret.intersection(&tmp);
    }
    if !(l[3] == l[2]) {
        let tmp = IntervalList::new(vec![Interval::interval_lower(
            RealNumRep::new(5, 1) + l[3] + -a[3] * 1 + s[4],
        )]);
        ret = ret.intersection(&tmp);
    }
    let tmp = IntervalList::new(vec![Interval::interval_lower(
        s[4] * 1 / 3 + l[1] * 1 / 3 + -a[1] * 1 / 3,
    )]);
    ret = ret.intersection(&tmp);
    let tmp = IntervalList::new(vec![Interval::interval_lower(RealNumRep::new(5, 1))]);
    ret = ret.intersection(&tmp);
    assert!(l[0] >= RealNumRep::new(0, 1));
    assert!(!(l[3] + s[4] + -a[4] * 1 >= RealNumRep::new(0, 1)));
    assert!(-a[0] * 1 + s[0] + l[0] <= RealNumRep::new(0, 1));
    assert!(-a[1] * 1 + l[1] + s[1] <= RealNumRep::new(0, 1));
...
pub fn compute_b_t_5_l_4(
    ...
    if !(l[3] == l[2]) {
        let tmp = IntervalList::new(vec![Interval::interval_upper(-l[3] * 1 + a[3] + -s[3] * 1)]);
        ret = ret.intersection(&tmp);
    }
    assert!(
        (l[1] == l[0])
    ...
    assert!(
        (a[2] + -s[3] * 1 + -l[2] * 1 <= RealNumRep::new(0, 1))
            || (l[3] + -a[3] * 1 + s[4] + -s[3] * 1 + s[1] <= RealNumRep::new(0, 1))
    );
    assert!(
        (a[2] + -s[3] * 1 + -l[2] * 1 <= RealNumRep::new(0, 1))
            || (-a[0] * 1 + -s[3] * 1 + s[1] * 2 + l[0] <= RealNumRep::new(0, 1))
    ...
    assert!(
        (l[1] == l[0])
            || (l[3] == l[2])
            || (l[3] + -a[3] * 1 + a[2] * 2 + -a[1] * 1 + -l[1] * 1 <= RealNumRep::new(0, 1))
            || (!(l[2] == l[1]))
    );
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![Interval::interval_upper(
    ...
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![Interval::interval_upper(
            l[3] * 1 / 2 + -a[3] * 1 / 2 + a[1] * 3 / 2 + -s[0] * 1 + -l[1] * 3 / 2,
        )]);
        ret = ret.intersection(&tmp);
    }
    if !(l[1] == l[0]) {
    ...
    if !(l[3] == l[2]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(l[3] + -a[3] * 1 + a[1] * 2 + -s[0] * 1 + -l[1] * 2),
            Interval::interval_upper(
    ...
    if !(a[2] + -s[3] * 1 + -l[2] * 1 <= RealNumRep::new(0, 1)) {
        let tmp = IntervalList::new(vec![Interval::interval_lower(
            -l[3] * 1 / 2 + a[3] * 1 / 2 + a[1] * 1 / 2 + -s[3] * 1 + -l[1] * 1 / 2,
        )]);
        ret = ret.intersection(&tmp);
    }
    let tmp = IntervalList::new(vec![Interval::interval_lower(
    ...
    if !(a[2] + -s[3] * 1 + -l[2] * 1 <= RealNumRep::new(0, 1)) {
        let tmp = IntervalList::new(vec![Interval::interval_lower(
            l[3] + -a[3] * 1 + s[4] + a[1] + -s[3] * 1 + -l[1] * 1,
        )]);
        ret = ret.intersection(&tmp);
    }
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![Interval::interval_upper(
            -l[3] * 1 + a[3] + -s[4] * 1 + a[1] + -s[0] * 1 + -l[1] * 1,
        )]);
        ret = ret.intersection(&tmp);
    }
    if !((l[3] == l[2])
    ...
    {
        let tmp = IntervalList::new(vec![Interval::interval_lower(
            l[3] * 1 / 2 + -a[3] * 1 / 2 + a[1] * 3 / 2 + -a[0] * 1 + -l[1] * 3 / 2 + l[0],
        )]);
        ret = ret.intersection(&tmp);
    }
    assert!(
        (-l[1] * 1 + a[1] + -s[2] * 1 <= RealNumRep::new(0, 1))
            || (l[3] + -a[3] * 1 + s[4] + -s[2] * 1 + s[0] <= RealNumRep::new(0, 1))
    );
    if !(l[3] == l[2]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_upper(
                -l[3] * 3 / 2 + a[3] * 3 / 2 + -s[4] * 1 + -a[1] * 1 / 2 + l[1] * 1 / 2,
            ),
            Interval::interval_upper(
                -l[3] * 1 + a[3] + -s[4] * 1 / 2 + -a[2] * 1 / 2 + l[2] * 1 / 2,
            ),
        ]);
        ret = ret.intersection(&tmp);
    }
    ...
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![Interval::interval_upper(
            -s[4] * 1 / 2 + a[2] * 1 / 2 + a[1] + -l[2] * 1 / 2 + -s[0] * 1 + -l[1] * 1,
        )]);
        ret = ret.intersection(&tmp);
    }
    if !((l[1] == l[0]) || (l[3] == l[2])) {
        let tmp = IntervalList::new(vec![Interval::interval_upper(
            -l[3] * 1 / 2 + a[3] * 1 / 2 + a[1] * 1 / 2 + -s[2] * 1 + -l[1] * 1 / 2,
        )]);
        ret = ret.intersection(&tmp);
    }
    if !(l[3] == l[2]) {
        let tmp = IntervalList::new(vec![Interval::interval_upper(
            -l[3] * 1 + a[3] + a[0] * 1 / 2 + -s[2] * 3 / 2 + -l[0] * 1 / 2,
        )]);
        ret = ret.intersection(&tmp);
    }
    assert!(
        (RealNumRep::new(0, 1) <= l[1] + -l[2] * 1)
            || (l[3] + -a[3] * 1 + s[4] + -a[2] * 1 + a[1] + -l[1] * 1 + l[2]
                <= RealNumRep::new(0, 1))
    );
    assert!(
        (a[2] + -s[3] * 1 + -l[2] * 1 <= RealNumRep::new(0, 1))
    ...
    {
        let tmp = IntervalList::new(vec![Interval::interval_lower(
            l[3] * 1 / 2 + -a[3] * 1 / 2 + a[1] * 3 / 2 + -s[1] * 1 + -l[1] * 3 / 2,
        )]);
        ret = ret.intersection(&tmp);
    }
    if !(RealNumRep::new(0, 1) <= -l[1] * 1 + l[0]) {
    ...
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![Interval::interval_upper(
            -l[3] * 1 + a[3] + -s[4] * 1 + a[2] + -s[1] * 1 + -l[2] * 1,
        )]);
        ret = ret.intersection(&tmp);
    }
    if !(l[2] == l[1]) {
    ...
    if !(RealNumRep::new(0, 1) <= l[1] + -l[2] * 1) {
        let tmp = IntervalList::new(vec![
            Interval::interval_upper(
                -s[4] * 1 / 3 + l[1] * 2 / 3 + -a[1] * 2 / 3 + a[2] + -l[2] * 1,
            ),
    ...
    assert!(
        (a[2] + -s[3] * 1 + -l[2] * 1 <= RealNumRep::new(0, 1))
            || (l[3] + -a[3] * 1 + s[4] + -s[3] * 1 / 2 + s[0] * 1 / 2 <= RealNumRep::new(0, 1))
            || (l[3] + -a[3] * 1 + s[4] + a[1] + -s[3] * 1 + -l[1] * 1 <= RealNumRep::new(0, 1))
    );
    if !(RealNumRep::new(0, 1) <= -l[3] * 1 + l[2]) {
        let tmp = IntervalList::new(vec![Interval::interval_lower(
            l[3] * 2 + -a[3] * 2 + a[2] * 3 + -a[0] * 1 + -l[2] * 3 + l[0],
        )]);
        ret = ret.intersection(&tmp);
    }
    if !(l[3] == l[2]) {
        let tmp = IntervalList::new(vec![
            ...
            Interval::interval_point(l[3] + -a[3] * 1 + l[1] + -a[1] * 1 + a[2] * 2 + -l[2] * 2),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![
            ...
            Interval::interval_upper(l[3] * 2 + -a[3] * 2 + a[2] * 3 + -s[0] * 1 + -l[2] * 3),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![Interval::interval_upper(
            l[3] + -a[3] * 1 + a[2] * 2 + -s[1] * 1 + -l[2] * 2,
        )]);
        ret = ret.intersection(&tmp);
    }
    if !(l[2] == l[1]) {
    ...
    if !((l[2] == l[1])
        || (RealNumRep::new(0, 1) <= l[3] + -a[3] * 1 + s[4] + -a[1] * 1 + s[0] + l[1]))
    {
        let tmp = IntervalList::new(vec![Interval::interval_upper(
            -l[3] * 2 + a[3] * 2 + -s[4] * 2 + a[2] + -s[0] * 1 + -l[2] * 1,
        )]);
        ret = ret.intersection(&tmp);
    }
    if !((l[2] == l[1])
        || (!(RealNumRep::new(0, 1) <= l[3] + -a[3] * 1 + s[4] + -a[1] * 1 + s[0] + l[0])))
    {
        let tmp = IntervalList::new(vec![Interval::interval_upper(
            -l[3] * 1 + a[3] + -s[4] * 1 + a[2] + -a[1] * 1 + l[1] + -l[2] * 1,
        )]);
        ret = ret.intersection(&tmp);
    }
    if !(RealNumRep::new(0, 1) <= -l[3] * 1 + l[2]) {
        let tmp = IntervalList::new(vec![Interval::interval_lower(
            l[3] * 3 + -a[3] * 3 + a[2] * 4 + -s[0] * 1 + -l[2] * 4,
        )]);
        ret = ret.intersection(&tmp);
    }
    assert!(
    ...
    if !(l[3] == l[2]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_upper(
                -l[3] * 1 + a[3] + -a[2] * 1 + l[2] + a[0] + -s[1] * 1 + -l[0] * 1,
            ),
            Interval::interval_upper(-l[3] * 1 + a[3] + a[0] * 2 + -s[1] * 3 + -l[0] * 2),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !(l[3] == l[2]) {
        let tmp = IntervalList::new(vec![Interval::interval_upper(
            -l[3] * 1 + a[3] + -s[2] * 4 / 3 + s[0] * 1 / 3,
        )]);
        ret = ret.intersection(&tmp);
    }
    if !(l[3] == l[2]) {
        let tmp = IntervalList::new(vec![Interval::interval_upper(
            -l[3] * 1 + a[3] + -s[2] * 3 / 2 + s[1] * 1 / 2,
        )]);
        ret = ret.intersection(&tmp);
    }
    assert!(
        (l[2] == l[1])
            || (!(l[1] == l[0]))
            || (-l[3] * 1 + a[3] + -a[2] * 2 + a[1] + l[2] * 2 + -l[0] * 1
                <= RealNumRep::new(0, 1))
    );
    if !(-l[1] * 1 + a[1] + -s[2] * 1 <= RealNumRep::new(0, 1)) {
        let tmp = IntervalList::new(vec![Interval::interval_lower(
            -l[3] * 1 + a[3] + -s[2] * 3 + s[0] * 2,
        )]);
        ret = ret.intersection(&tmp);
    }
    assert!(
    ...
    if !(a[2] + -s[3] * 1 + -l[2] * 1 <= RealNumRep::new(0, 1)) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(-l[3] * 1 + a[3] + a[1] + -s[3] * 2 + -l[0] * 1),
            Interval::interval_lower(-l[3] * 1 + a[3] + -s[3] * 3 / 2 + s[0] * 1 / 2),
        ]);
        ret = ret.intersection(&tmp);
    }
    assert!(
    ...
    if !(l[3] == l[2]) {
        let tmp = IntervalList::new(vec![
            ...
            Interval::interval_upper(-l[3] * 1 + a[3] + -s[4] * 2 / 3 + -s[1] * 1 / 3),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !(l[3] == l[2]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_upper(
                -l[3] * 1 + a[3] + -a[2] * 1 + l[2] + -s[1] * 1 / 2 + s[0] * 1 / 2,
            ),
            Interval::interval_upper(-l[3] * 1 + a[3] + -s[1] * 2 + s[0]),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !(l[3] == l[2]) {
        let tmp = IntervalList::new(vec![
            ...
            Interval::interval_upper(
                -l[3] * 1 + a[3] + -s[4] * 2 / 3 + l[1] * 1 / 3 + -a[1] * 1 / 3,
            ),
            Interval::interval_upper(-l[3] * 1 + a[3] + -s[4] * 3 / 4 + -s[0] * 1 / 4),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !(-l[1] * 1 + a[1] + -s[2] * 1 <= RealNumRep::new(0, 1)) {
...
pub fn compute_q_4_t_5_l_4(
    ...
    assert!(
        (l[3] == l[2])
            || (!(RealNumRep::new(0, 1) <= -l[1] * 1 + l[0]))
            || (l[3] + -a[3] * 1 + a[1] + -a[0] * 1 + s[2] <= RealNumRep::new(0, 1))
    );
    assert!((l[2] == l[1]) || (-a[2] * 1 + a[1] + -l[1] * 1 + l[2] <= RealNumRep::new(-5, 1)));
    assert!(
        (l[2] == l[1]) || (-a[2] * 1 / 2 + l[2] * 1 / 2 + s[1] * 1 / 2 <= RealNumRep::new(-5, 1))
    );
    assert!(
        (l[3] == l[2])
    ...
    if !(a[2] + -s[3] * 1 + -l[2] * 1 <= RealNumRep::new(0, 1)) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(RealNumRep::new(5, 1)),
            Interval::interval_lower(-l[3] * 1 + a[4] + -s[3] * 3 + s[1] * 2),
        ]);
        ret = ret.intersection(&tmp);
    }
    assert!(
    ...
    if !(l[3] == l[2]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(RealNumRep::new(5, 1)),
            Interval::interval_lower(RealNumRep::new(10, 1) + l[3] + -a[3] * 2 + a[4] + s[2]),
        ]);
        ret = ret.intersection(&tmp);
    }
    let tmp = IntervalList::new(vec![
    ...
    let tmp = IntervalList::new(vec![
        Interval::interval_upper(RealNumRep::new(-10, 1) + -l[3] * 1 + a[4] + -s[2] * 1),
        Interval::interval_point(RealNumRep::new(0, 1)),
        Interval::interval_upper(RealNumRep::new(-5, 1) + -a[3] * 1 + a[4]),
    ]);
    ret = ret.intersection(&tmp);
    let tmp = IntervalList::new(vec![
        Interval::interval_lower(a[2] + -s[3] * 1 + -l[2] * 1),
        Interval::interval_lower(-a[3] * 1 + a[4] + -s[3] * 1 + s[1]),
    ]);
    ret = ret.intersection(&tmp);
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![Interval::interval_upper(
    ...
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_upper(-l[2] * 1 + a[2] + -s[3] * 2 / 3 + -s[0] * 1 / 3),
            Interval::interval_upper(-l[2] * 1 + a[2] + -a[1] * 2 + s[0] + l[1] * 2),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![
            ...
            Interval::interval_lower(-l[2] * 1 + a[2] + -a[1] * 2 + s[0] + l[1] * 2),
        ]);
        ret = ret.intersection(&tmp);
    }
    assert!(
    ...
    let tmp = IntervalList::new(vec![
        Interval::interval_point(RealNumRep::new(0, 1)),
        Interval::interval_upper(-l[3] * 1 + a[4] + a[2] + -l[2] * 1 + -s[3] * 2),
    ]);
    ret = ret.intersection(&tmp);
    let tmp = IntervalList::new(vec![
        Interval::interval_point(RealNumRep::new(0, 1)),
        Interval::interval_upper(-l[3] * 1 + a[4] + -l[1] * 1 / 2 + a[1] * 1 / 2 + -s[3] * 3 / 2),
    ]);
    ret = ret.intersection(&tmp);
    let tmp = IntervalList::new(vec![
        Interval::interval_point(RealNumRep::new(0, 1)),
        Interval::interval_upper(-l[3] * 1 + a[4] + a[0] * 1 / 3 + -s[3] * 4 / 3 + -l[0] * 1 / 3),
    ]);
    ret = ret.intersection(&tmp);
    let tmp = IntervalList::new(vec![
        Interval::interval_point(RealNumRep::new(0, 1)),
        Interval::interval_upper(-l[3] * 1 + a[4] + -s[3] * 4 / 3 + s[1] * 1 / 3),
    ]);
    ret = ret.intersection(&tmp);
    let tmp = IntervalList::new(vec![
        Interval::interval_lower(a[1] + -s[2] * 1 + -l[1] * 1),
        Interval::interval_lower(-l[3] * 1 + a[4] + -s[2] * 4 + s[0] * 3),
    ]);
    ret = ret.intersection(&tmp);
    let tmp = IntervalList::new(vec![
        Interval::interval_lower(a[1] + -s[2] * 1 + -l[1] * 1),
        Interval::interval_lower(-a[3] * 1 + a[4] + -s[2] * 1 + s[0]),
    ]);
    ret = ret.intersection(&tmp);
    if !(a[2] + -s[3] * 1 + -l[2] * 1 <= RealNumRep::new(0, 1)) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(RealNumRep::new(5, 1)),
            Interval::interval_lower(-l[3] * 1 + a[4] + -l[1] * 2 + a[1] * 2 + -s[3] * 3),
            Interval::interval_lower(-l[3] * 1 + a[4] + -s[3] * 2 + s[0]),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !(l[2] == l[1]) {
    ...
    if !(l[3] == l[2]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(a[2] + -s[3] * 1 + -l[2] * 1),
            Interval::interval_lower(l[3] + -a[3] * 2 + a[4] + a[2] * 2 + -s[3] * 1 + -l[2] * 2),
        ]);
        ret = ret.intersection(&tmp);
    }
    let tmp = IntervalList::new(vec![
        Interval::interval_point(RealNumRep::new(0, 1)),
        Interval::interval_upper(-l[3] * 1 + a[4] + -s[2] * 5 / 3 + s[0] * 2 / 3),
        Interval::interval_upper(-a[3] * 1 + a[4] + -s[2] * 1 / 3 + s[0] * 1 / 3),
    ]);
    ret = ret.intersection(&tmp);
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![Interval::interval_upper(a[1] + -s[1] * 1 + -l[1] * 1)]);
    ...
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_point(RealNumRep::new(0, 1)),
            Interval::interval_upper(
                -l[3] * 1 + a[4] + -a[2] * 1 + a[1] + -s[3] * 1 + -l[1] * 1 + l[2],
            ),
        ]);
        ret = ret.intersection(&tmp);
    }
    ...
    assert!(
        (l[2] == l[1])
            || (-l[3] * 1 / 2 + a[3] * 1 / 2 + -a[2] * 1 + a[1] * 1 / 2 + -l[1] * 1 / 2 + l[2]
                <= RealNumRep::new(0, 1))
    );
    assert!(
        (l[2] == l[1])
            || (a[1] + -s[2] * 1 + -l[1] * 1 <= RealNumRep::new(0, 1))
            || (-l[3] * 1 + a[3] + -a[2] * 1 + -s[2] * 1 + s[0] + l[2] <= RealNumRep::new(0, 1))
    );
    assert!(
        (l[1] == l[0])
    ...
    if !(l[3] == l[2]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(RealNumRep::new(5, 1)),
            Interval::interval_lower(
                RealNumRep::new(10, 1) + l[3] + -a[3] * 2 + a[4] + a[2] + -l[2] * 1,
            ),
            Interval::interval_lower(
                RealNumRep::new(15, 2) + l[3] * 1 / 2 + -a[3] * 3 / 2 + a[4] + s[1] * 1 / 2,
            ),
        ]);
        ret = ret.intersection(&tmp);
    }
    let tmp = IntervalList::new(vec![
        Interval::interval_point(RealNumRep::new(0, 1)),
        Interval::interval_upper(-l[3] * 1 + a[4] + -s[3] * 3 / 2 + s[2] * 1 / 2),
    ]);
    ret = ret.intersection(&tmp);
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_point(RealNumRep::new(0, 1)),
            Interval::interval_upper(
                -l[3] * 2 / 3 + a[4] * 2 / 3 + a[1] * 1 / 3 + -s[3] * 1 + -l[1] * 1 / 3,
            ),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_point(RealNumRep::new(0, 1)),
            Interval::interval_upper(
                -a[3] * 1 / 2 + a[4] * 1 / 2 + a[1] * 1 / 2 + -s[2] * 1 / 2 + -l[1] * 1 / 2,
            ),
            Interval::interval_upper(
                -l[3] * 1 / 3 + a[4] * 1 / 3 + a[1] * 2 / 3 + -s[2] * 1 + -l[1] * 2 / 3,
            ),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_point(RealNumRep::new(0, 1)),
            Interval::interval_upper(
                RealNumRep::new(-5, 1) + -a[3] * 1 + a[4] + a[1] + -s[2] * 1 + -l[1] * 1,
            ),
            Interval::interval_upper(
                RealNumRep::new(-10, 1) + -l[3] * 1 + a[4] + a[1] * 2 + -s[2] * 3 + -l[1] * 2,
            ),
        ]);
        ret = ret.intersection(&tmp);
    }
    ...
    let tmp = IntervalList::new(vec![
        Interval::interval_point(RealNumRep::new(0, 1)),
        Interval::interval_upper(RealNumRep::new(-5, 1) + -l[3] * 1 + a[4] + -s[3] * 1),
    ]);
    ret = ret.intersection(&tmp);
    assert!(
        (l[3] == l[2])
    ...
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_point(RealNumRep::new(0, 1)),
            Interval::interval_upper(
                l[3] + -a[3] * 2 + a[4] + a[2] + -l[2] * 1 + a[1] * 2 + -s[1] * 2 + -l[1] * 2,
            ),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(RealNumRep::new(5, 1)),
            Interval::interval_lower(
                RealNumRep::new(5, 1) + -a[3] * 1 + a[4] + -a[1] * 1 + s[0] + l[1],
            ),
        ]);
        ret = ret.intersection(&tmp);
    }
    let tmp = IntervalList::new(vec![
        Interval::interval_point(RealNumRep::new(0, 1)),
        Interval::interval_upper(-a[3] * 1 + a[4] + -s[1] * 1 / 2 + s[0] * 1 / 2),
        Interval::interval_upper(-l[3] * 1 + a[4] + -s[1] * 5 / 2 + s[0] * 3 / 2),
        Interval::interval_upper(-l[3] * 1 + a[4] + -a[2] * 1 + l[2] + -s[1] * 1 + s[0]),
    ]);
    ret = ret.intersection(&tmp);
    if !(a[2] + -s[3] * 1 + -l[2] * 1 <= RealNumRep::new(0, 1)) {
        let tmp = IntervalList::new(vec![
    ...
    if !(a[1] + -s[2] * 1 + -l[1] * 1 <= RealNumRep::new(0, 1)) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(RealNumRep::new(5, 1)),
            Interval::interval_lower(-l[3] * 1 + a[4] + -a[2] * 1 + l[2] + -s[2] * 2 + s[0] * 2),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !(a[1] + -s[2] * 1 + -l[1] * 1 <= RealNumRep::new(0, 1)) {
    ...
    let tmp = IntervalList::new(vec![
        Interval::interval_point(RealNumRep::new(0, 1)),
        Interval::interval_upper(-l[3] * 1 + a[4] + a[0] + -s[2] * 2 + -l[0] * 1),
        Interval::interval_upper(-a[3] * 1 + a[4] + a[0] * 1 / 2 + -s[2] * 1 / 2 + -l[0] * 1 / 2),
    ]);
    ret = ret.intersection(&tmp);
    let tmp = IntervalList::new(vec![
        Interval::interval_point(RealNumRep::new(0, 1)),
        Interval::interval_upper(-l[3] * 1 + a[4] + -s[2] * 2 + s[1]),
        Interval::interval_upper(-a[3] * 1 + a[4] + -s[2] * 1 / 2 + s[1] * 1 / 2),
    ]);
    ret = ret.intersection(&tmp);
    if !(a[1] + -s[2] * 1 + -l[1] * 1 <= RealNumRep::new(0, 1)) {
        let tmp = IntervalList::new(vec![
    ...
    let tmp = IntervalList::new(vec![
        Interval::interval_point(RealNumRep::new(0, 1)),
        Interval::interval_upper(-l[3] * 1 + a[4] + -l[1] * 2 + a[1] * 2 + -s[2] * 3),
        Interval::interval_upper(
            l[3] * 1 / 2 + -a[3] * 3 / 2 + a[4] + a[1] * 1 / 2 + -l[0] * 1 / 2,
        ),
    ]);
    ret = ret.intersection(&tmp);
    if !(l[1] == l[0]) {
    ...
    if !((l[1] == l[0]) || (!(RealNumRep::new(0, 1) <= -l[3] * 1 + l[2]))) {
        let tmp = IntervalList::new(vec![
            Interval::interval_point(RealNumRep::new(0, 1)),
            Interval::interval_upper(
                -l[3] * 1 + -a[3] * 1 + a[4] + a[1] + -s[2] * 1 + -l[1] * 1 + l[2],
            ),
        ]);
        ret = ret.intersection(&tmp);
    }
    let tmp = IntervalList::new(vec![
        Interval::interval_point(RealNumRep::new(0, 1)),
        Interval::interval_upper(RealNumRep::new(-5, 1) + -a[3] * 1 + a[4]),
        Interval::interval_upper(RealNumRep::new(-15, 1) + -l[3] * 1 + a[4] + -s[1] * 1),
        Interval::interval_upper(RealNumRep::new(-10, 1) + -l[3] * 1 + a[4] + -a[2] * 1 + l[2]),
    ]);
    ret = ret.intersection(&tmp);
    assert!(
        (l[1] == l[0])
    ...
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(a[2] + -s[3] * 1 + -l[2] * 1),
            Interval::interval_lower(
                -l[3] * 1 + a[4] + -a[2] * 2 + a[1] * 2 + -s[3] * 1 + -l[1] * 2 + l[2] * 2,
            ),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_point(RealNumRep::new(0, 1)),
            Interval::interval_upper(
                -l[3] * 1 / 2 + a[4] * 1 / 2 + a[2] * 1 / 2 + -s[3] * 1 + -l[2] * 1 / 2,
            ),
        ]);
        ret = ret.intersection(&tmp);
    }
        ...
        || (a[2] + -s[3] * 1 + -l[2] * 1 <= RealNumRep::new(0, 1)))
    {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(-l[3] * 1 + a[4] + -s[3] * 2 + s[0]),
            Interval::interval_lower(RealNumRep::new(5, 1) + a[1] + -s[3] * 1 + -l[0] * 1),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(-a[3] * 1 + a[4] + -a[2] * 1 + a[1] + -l[1] * 1 + l[2]),
            Interval::interval_lower(l[0] + -a[2] * 1 + a[1] * 2 + -a[0] * 1 + -l[1] * 2 + l[2]),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !(l[1] == l[0]) {
    ...
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![Interval::interval_upper(
            -l[3] * 1 + a[3] + -s[4] * 1 + -l[2] * 1 + a[2] + -s[1] * 1,
        )]);
        ret = ret.intersection(&tmp);
    }
    if !(l[2] == l[1]) {
    ...
    if !(l[3] == l[2]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(RealNumRep::new(5, 1)),
            Interval::interval_lower(
                RealNumRep::new(5, 1) + l[3] + -a[3] * 2 + a[4] + a[2] + -l[2] * 1,
            ),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(RealNumRep::new(5, 1)),
            Interval::interval_lower(
                -l[3] * 1 + a[4] + -a[2] * 4 + a[1] * 4 + -s[1] * 1 + -l[1] * 4 + l[2] * 4,
            ),
        ]);
        ret = ret.intersection(&tmp);
    }
    ...
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(a[1] + -s[2] * 1 + -l[1] * 1),
            Interval::interval_lower(
                -l[3] * 1 + a[4] + -a[2] * 3 + a[1] * 3 + -s[2] * 1 + -l[1] * 3 + l[2] * 3,
            ),
        ]);
        ret = ret.intersection(&tmp);
    }
    ...
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_point(RealNumRep::new(0, 1)),
            Interval::interval_upper(l[3] + -a[3] * 2 + a[4] + a[2] * 2 + -s[2] * 1 + -l[2] * 2),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !(l[3] == l[2]) {
    ...
    let tmp = IntervalList::new(vec![
        Interval::interval_lower(a[2] + -s[3] * 1 + -l[2] * 1),
        Interval::interval_lower(-a[3] * 1 + a[4] + a[1] + -s[3] * 1 + -l[1] * 1),
        Interval::interval_lower(-a[3] * 1 + a[4] + -s[3] * 1 / 2 + s[0] * 1 / 2),
    ]);
    ret = ret.intersection(&tmp);
    if !((!(RealNumRep::new(0, 1) <= -l[1] * 1 + l[0]))
        || (a[2] + -s[3] * 1 + -l[2] * 1 <= RealNumRep::new(0, 1)))
    {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(-a[3] * 1 + a[4] + -s[3] * 1 / 2 + s[0] * 1 / 2),
            Interval::interval_lower(a[1] + -s[3] * 2 / 3 + -s[0] * 1 / 3 + -l[0] * 1),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !(a[2] + -s[3] * 1 + -l[2] * 1 <= RealNumRep::new(0, 1)) {
    ...
    if !((l[1] == l[0]) || (a[2] + -s[3] * 1 + -l[2] * 1 <= RealNumRep::new(0, 1))) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(
                -l[3] * 1 / 2 + a[3] * 1 / 2 + a[1] * 1 / 2 + -s[3] * 1 + -l[1] * 1 / 2,
            ),
    ...
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_point(RealNumRep::new(0, 1)),
            Interval::interval_upper(-a[3] * 1 + a[4] + a[2] + -s[3] * 1 + -l[2] * 1),
        ]);
        ret = ret.intersection(&tmp);
    }
    assert!(
        ...
        || (a[2] + -s[3] * 1 + -l[2] * 1 <= RealNumRep::new(0, 1)))
    {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(-l[3] * 1 + a[4] + -s[3] * 3 + s[1] * 2),
            Interval::interval_lower(s[4] * 1 / 2 + a[1] + -s[3] * 3 / 2 + -l[0] * 1),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !((!(RealNumRep::new(0, 1) <= -l[1] * 1 + l[0]))
    ...
    let tmp = IntervalList::new(vec![
        Interval::interval_point(RealNumRep::new(0, 1)),
        Interval::interval_upper(-a[3] * 1 + a[4] + a[1] + -s[2] * 1 + -l[0] * 1),
        Interval::interval_lower(
            l[3] * 1 / 2 + -a[3] * 3 / 2 + a[4] + a[1] * 1 / 2 + -l[0] * 1 / 2,
        ),
    ]);
    ...
    if !(a[2] + -s[3] * 1 + -l[2] * 1 <= RealNumRep::new(0, 1)) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(-l[3] * 1 + a[4] + -s[3] * 3 + s[1] * 2),
            Interval::interval_lower(-l[3] * 1 + a[3] + -s[3] * 2 + s[1]),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !(l[3] == l[2]) {
        let tmp = IntervalList::new(vec![
            ...
            Interval::interval_lower(
                RealNumRep::new(20, 3) + l[3] * 1 / 3 + -a[3] * 4 / 3 + a[4] + s[0] * 1 / 3,
            ),
            Interval::interval_lower(
                RealNumRep::new(15, 2)
                    + l[3] * 1 / 2
    ...
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(RealNumRep::new(5, 1)),
            Interval::interval_lower(
                RealNumRep::new(5, 1) + -a[3] * 1 + a[4] + -a[2] * 1 + s[1] + l[2],
            ),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(RealNumRep::new(5, 1)),
            Interval::interval_lower(
                -l[3] * 1 + a[4] + -a[2] * 4 + a[1] * 4 + -a[0] * 1 + -l[1] * 4 + l[2] * 4 + l[0],
            ),
        ]);
        ret = ret.intersection(&tmp);
    }
    ...
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(RealNumRep::new(5, 1)),
            Interval::interval_lower(
                RealNumRep::new(20, 1) + -l[3] * 1 + a[4] + -a[1] * 4 + s[0] * 3 + l[1] * 4,
            ),
        ]);
        ret = ret.intersection(&tmp);
    }
    ...
    if !(a[1] + -s[2] * 1 + -l[1] * 1 <= RealNumRep::new(0, 1)) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(-l[3] * 1 + a[4] + -s[2] * 4 + s[0] * 3),
            Interval::interval_lower(-l[3] * 1 + a[3] + -s[2] * 3 + s[0] * 2),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !(a[1] + -s[2] * 1 + -l[1] * 1 <= RealNumRep::new(0, 1)) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(-l[3] * 1 + a[4] + -a[2] * 1 + l[2] + -s[2] * 2 + s[0] * 2),
            Interval::interval_lower(-l[3] * 1 + a[3] * 2 + -a[4] * 1 + -a[2] * 1 + l[2]),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !(l[3] == l[2]) {
    ...
    let tmp = IntervalList::new(vec![
        Interval::interval_point(RealNumRep::new(0, 1)),
        Interval::interval_upper(-l[3] * 1 + a[4] + -s[3] * 5 / 4 + s[0] * 1 / 4),
    ]);
    ret = ret.intersection(&tmp);
    let tmp = IntervalList::new(vec![
        Interval::interval_point(RealNumRep::new(0, 1)),
        Interval::interval_upper(RealNumRep::new(-5, 1) + -a[3] * 1 + a[4]),
        Interval::interval_upper(RealNumRep::new(-10, 1) + -l[3] * 1 + a[4] + -a[2] * 1 + l[2]),
        Interval::interval_upper(RealNumRep::new(-20, 1) + -l[3] * 1 + a[4] + -s[0] * 1),
        Interval::interval_upper(RealNumRep::new(-15, 1) + -l[3] * 1 + a[4] + l[1] + -a[1] * 1),
    ]);
    ret = ret.intersection(&tmp);
    assert!(
        (a[2] + -s[3] * 1 + -l[2] * 1 <= RealNumRep::new(0, 1))
    ...
    if !(l[3] == l[2]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(
                l[3] * 2 + -a[3] * 3 + a[4] + a[2] * 3 + -s[2] * 1 + -l[2] * 3,
            ),
            Interval::interval_lower(l[3] + -a[3] * 1 + a[2] * 2 + -s[2] * 1 + -l[2] * 2),
        ]);
        ret = ret.intersection(&tmp);
    }
    assert!(
    ...
    if !(a[2] + -s[3] * 1 + -l[2] * 1 <= RealNumRep::new(0, 1)) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(-a[3] * 1 + a[4] + -s[3] * 1 + s[1]),
            Interval::interval_lower(l[3] + -a[3] * 1 + s[4] + a[1] + -s[3] * 1 + -l[1] * 1),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![
            ...
            Interval::interval_lower(
                -l[3] * 1 + a[4] + -a[2] * 5 + a[1] * 5 + -s[0] * 1 + -l[1] * 5 + l[2] * 5,
            ),
        ]);
        ret = ret.intersection(&tmp);
    }
    ...
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_point(RealNumRep::new(0, 1)),
            Interval::interval_upper(-a[3] * 1 + a[4] + a[1] + -s[2] * 1 + -l[1] * 1),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !(l[3] == l[2]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(a[1] + -s[2] * 1 + -l[1] * 1),
            Interval::interval_lower(
                l[3] * 1 / 2 + -a[3] * 3 / 2 + a[4] + a[1] * 3 / 2 + -s[2] * 1 + -l[1] * 3 / 2,
            ),
            Interval::interval_lower(
                l[3] + -a[3] * 2 + a[4] + a[2] + -l[2] * 1 + a[1] * 2 + -s[2] * 2 + -l[1] * 2,
            ),
        ]);
        ret = ret.intersection(&tmp);
    }
    ...
    if !((l[3] == l[2])
        || (RealNumRep::new(0, 1) <= -a[3] * 1 + a[4] + -a[2] * 1 + a[1] + -l[1] * 1 + l[2]))
    {
        let tmp = IntervalList::new(vec![Interval::interval_lower(
            l[3] + -a[3] * 2 + a[4] + a[1] * 2 + -s[1] * 1 + -l[1] * 2,
        )]);
        ret = ret.intersection(&tmp);
    }
    assert!(
    ...
    if !(a[1] + -s[2] * 1 + -l[1] * 1 <= RealNumRep::new(0, 1)) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(-l[3] * 1 + a[4] + -a[2] * 1 + l[2] + -s[2] * 2 + s[0] * 2),
            Interval::interval_lower(-l[3] * 1 + a[3] + -a[2] * 1 + l[2] + -s[2] * 1 + s[0]),
        ]);
        ret = ret.intersection(&tmp);
    }
    let tmp = IntervalList::new(vec![
        Interval::interval_point(RealNumRep::new(0, 1)),
        Interval::interval_upper(-a[3] * 1 + a[4] + a[0] + -s[1] * 1 + -l[0] * 1),
        Interval::interval_upper(-l[3] * 1 + a[4] + a[0] * 3 + -s[1] * 4 + -l[0] * 3),
        Interval::interval_upper(
            -l[3] * 1 + a[4] + -a[2] * 1 + l[2] + a[0] * 2 + -s[1] * 2 + -l[0] * 2,
        ),
    ]);
    ret = ret.intersection(&tmp);
    if !(a[2] + -s[3] * 1 + -l[2] * 1 <= RealNumRep::new(0, 1)) {
    ...
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_point(RealNumRep::new(0, 1)),
            Interval::interval_upper(l[3] + -a[3] * 2 + a[4] + a[1] * 2 + -s[0] * 1 + -l[1] * 2),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !(l[1] == l[0]) {
    ...
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_point(RealNumRep::new(0, 1)),
            Interval::interval_upper(
                l[3] * 1 / 2 + -a[3] * 3 / 2 + a[4] + a[1] * 3 / 2 + -s[1] * 1 + -l[1] * 3 / 2,
            ),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_point(RealNumRep::new(0, 1)),
            Interval::interval_upper(
                RealNumRep::new(-5, 1) + -l[3] * 1 + a[4] + a[2] + -s[3] * 2 + -l[2] * 1,
            ),
        ]);
        ret = ret.intersection(&tmp);
    }
    ...
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_upper(
                -l[3] * 1 + a[3] + -s[4] * 1 + -l[2] * 1 + a[2] + -a[1] * 1 + l[1],
            ),
            Interval::interval_upper(
                -l[3] * 2 + a[3] * 2 + -s[4] * 2 + -l[2] * 1 + a[2] + -s[0] * 1,
            ),
        ]);
        ret = ret.intersection(&tmp);
    }
    ...
    assert!(
        (l[1] == l[0])
            || (a[2] + -s[3] * 1 + -l[2] * 1 <= RealNumRep::new(0, 1))
            || (a[3] + -a[1] * 1 + -s[3] * 2 + s[1] * 2 + l[1] + -l[2] * 1
                <= RealNumRep::new(0, 1))
            || (!(RealNumRep::new(0, 1) <= -l[3] * 1 + l[2]))
    );
    assert!(
    ...
    if !(l[3] == l[2]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_upper(-l[3] * 1 + a[3] + -a[2] * 2 + s[1] + l[2] * 2),
            Interval::interval_upper(-l[3] * 1 + a[3] + a[0] * 2 + -s[1] * 3 + -l[0] * 2),
        ]);
        ret = ret.intersection(&tmp);
    }
    ...
    if !(l[3] == l[2]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(RealNumRep::new(5, 1)),
            Interval::interval_lower(
                l[3] * 4 + -a[3] * 5 + a[4] + a[2] * 5 + -s[0] * 1 + -l[2] * 5,
            ),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !((l[3] == l[2])
        || (l[3] * 2 + -a[3] * 3 + a[4] + a[2] * 3 + -a[1] * 1 + l[1] + -l[2] * 3
            <= RealNumRep::new(0, 1)))
    {
        let tmp = IntervalList::new(vec![Interval::interval_lower(RealNumRep::new(0, 1))]);
        ret = ret.intersection(&tmp);
    ...
    if !((l[3] == l[2]) || (a[2] + -s[3] * 1 + -l[2] * 1 <= RealNumRep::new(0, 1))) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(RealNumRep::new(5, 1)),
            Interval::interval_lower(
                l[3] * 3 / 2 + -a[3] * 5 / 2 + a[4] + a[1] * 5 / 2 + -s[0] * 1 + -l[1] * 5 / 2,
            ),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !((l[1] == l[0]) || (!(l[2] == l[1]))) {
        let tmp = IntervalList::new(vec![
            Interval::interval_point(RealNumRep::new(0, 1)),
            Interval::interval_upper(-l[3] * 1 + a[4] + -a[2] * 3 + a[1] * 3 + -s[1] * 1),
            Interval::interval_upper(-a[3] * 1 + a[4] + -a[2] * 1 + a[1] + -l[1] * 1 + l[2]),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(RealNumRep::new(5, 1)),
            Interval::interval_lower(
                RealNumRep::new(15, 1) + -l[3] * 1 + a[4] + -a[2] * 3 + s[1] * 2 + l[2] * 3,
            ),
        ]);
        ret = ret.intersection(&tmp);
    }
    ...
    if !((l[2] == l[1]) || (!(RealNumRep::new(0, 1) <= -l[3] * 1 + l[2]))) {
        let tmp = IntervalList::new(vec![
            Interval::interval_point(RealNumRep::new(0, 1)),
            Interval::interval_upper(-l[3] * 1 + -a[3] * 3 + a[4] + a[2] * 3 + -s[1] * 1),
        ]);
        ret = ret.intersection(&tmp);
    }
    assert!(
    ...
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_point(RealNumRep::new(0, 1)),
            Interval::interval_upper(
                -l[3] * 1 + a[4] + -a[2] * 4 + a[1] * 4 + -s[0] * 1 + -l[1] * 4 + l[2] * 4,
            ),
            Interval::interval_upper(-a[3] * 1 + a[4] + -a[2] * 1 + a[1] + -l[1] * 1 + l[2]),
        ]);
        ret = ret.intersection(&tmp);
    ...
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_point(RealNumRep::new(0, 1)),
            Interval::interval_upper(
                -l[3] * 1 / 2 + -a[3] * 1 / 2 + a[4] + a[1] * 1 / 2 + -s[3] * 1 + -l[1] * 1 / 2,
            ),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_point(RealNumRep::new(0, 1)),
            Interval::interval_upper(
                -l[3] * 1 + a[4] + -a[2] * 2 + a[1] * 2 + -s[2] * 1 + -l[1] * 2 + l[2] * 2,
            ),
            Interval::interval_upper(-a[3] * 1 + a[4] + -a[2] * 1 + a[1] + -l[1] * 1 + l[2]),
        ]);
        ret = ret.intersection(&tmp);
    ...
    if !((l[3] == l[2])
        || (l[3] + -a[3] * 1 + a[2] + a[1] + -l[2] * 1 + -s[1] * 1 + -l[1] * 1
            <= RealNumRep::new(0, 1))
        || (l[3] * 1 / 2 + -a[3] * 3 / 2 + a[4] + a[1] * 1 / 2 + -l[1] * 1 / 2
            <= RealNumRep::new(0, 1)))
    {
        let tmp = IntervalList::new(vec![Interval::interval_lower(
            l[3] * 1 / 2 + -a[3] * 1 / 2 + a[1] * 3 / 2 + -s[1] * 1 + -l[1] * 3 / 2,
    ...
    if !(l[3] == l[2]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_upper(
                -l[3] * 2 + a[3] * 2 + -a[2] * 2 + l[2] * 2 + -a[1] * 1 + s[0] + l[1],
            ),
            Interval::interval_lower(l[3] + -a[3] * 1 + a[1] * 2 + -s[0] * 1 + -l[1] * 2),
            Interval::interval_lower(-a[3] * 1 + a[4] + -a[2] * 1 + a[1] + -l[1] * 1 + l[2]),
        ]);
    ...
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![
            ...
            Interval::interval_lower(
                RealNumRep::new(10, 1) + -l[3] * 1 + a[4] + -a[2] * 2 + s[0] + l[2] * 2,
            ),
        ]);
        ret = ret.intersection(&tmp);
    }
    ...
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_point(RealNumRep::new(0, 1)),
            Interval::interval_upper(
                -l[3] * 1 + a[4] + -a[2] * 3 + a[1] * 3 + -s[1] * 1 + -l[1] * 3 + l[2] * 3,
            ),
            Interval::interval_upper(-a[3] * 1 + a[4] + -a[2] * 1 + a[1] + -l[1] * 1 + l[2]),
        ]);
        ret = ret.intersection(&tmp);
            ...
            <= RealNumRep::new(0, 1)))
    {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(RealNumRep::new(5, 1)),
            Interval::interval_lower(
                l[3] + -a[3] * 2 + a[4] + a[1] * 2 + -a[0] * 1 + -l[1] * 2 + l[0],
            ),
        ]);
        ret = ret.intersection(&tmp);
    }
    ...
    {
        let tmp = IntervalList::new(vec![Interval::interval_lower(
            l[3] * 1 / 2 + -a[3] * 1 / 2 + l[0] + a[1] * 3 / 2 + -a[0] * 1 + -l[1] * 3 / 2,
        )]);
        ret = ret.intersection(&tmp);
    }
    if !((l[3] == l[2])
    ...
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(RealNumRep::new(5, 1)),
            Interval::interval_lower(
                RealNumRep::new(5, 1) + -a[3] * 1 + a[4] + -a[2] * 1 + a[1] + -l[1] * 1 + l[2],
            ),
            Interval::interval_lower(
                RealNumRep::new(5, 2)
                    + -a[3] * 1
    ...
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_point(RealNumRep::new(0, 1)),
            Interval::interval_upper(
                l[3] * 2 + -a[3] * 3 + a[4] + a[2] * 3 + -s[1] * 1 + -l[2] * 3,
            ),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_upper(RealNumRep::new(-10, 1) + -l[2] * 1 + a[2] + -s[0] * 1),
    ...
    if !((l[3] == l[2]) || (!(l[2] == l[1]))) {
        let tmp = IntervalList::new(vec![
            ...
            Interval::interval_lower(l[3] * 3 + -a[3] * 3 + -l[1] * 4 + a[2] * 4 + -s[0] * 1),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !(l[3] == l[2]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(
                l[3] * 3 + -a[3] * 4 + a[4] + a[2] * 4 + -a[0] * 1 + -l[2] * 4 + l[0],
            ),
            Interval::interval_lower(
                l[3] * 2 + -a[3] * 2 + l[0] + a[2] * 3 + -a[0] * 1 + -l[2] * 3,
            ),
        ]);
        ret = ret.intersection(&tmp);
    }
    ...
    if !((l[3] == l[2])
        || (!(l[3] * 1 / 2 + -a[3] * 1 + a[4] * 1 / 2 + a[2] * 1 / 2 + -l[2] * 1 / 2
            <= RealNumRep::new(0, 1))))
    {
        let tmp = IntervalList::new(vec![Interval::interval_lower(
            l[3] * 4 + -a[3] * 5 + a[4] + a[2] * 5 + -s[0] * 1 + -l[2] * 5,
    ...
    {
        let tmp = IntervalList::new(vec![Interval::interval_lower(
            l[3] * 3 + -a[3] * 4 + a[4] + a[2] * 4 + -s[1] * 1 + -l[2] * 4,
        )]);
        ret = ret.intersection(&tmp);
    }
    if !(l[3] == l[2]) {
        let tmp = IntervalList::new(vec![
            ...
            Interval::interval_lower(l[3] * 2 + -a[3] * 2 + a[2] * 3 + -s[1] * 1 + -l[2] * 3),
        ]);
        ret = ret.intersection(&tmp);
    }
    assert!(
    ...
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_point(RealNumRep::new(0, 1)),
            Interval::interval_upper(
                l[3] * 3 + -a[3] * 4 + a[4] + a[2] * 4 + -s[0] * 1 + -l[2] * 4,
            ),
            Interval::interval_upper(
                l[3] * 2 + -a[3] * 3 + a[4] + a[2] * 3 + -a[1] * 1 + l[1] + -l[2] * 3,
            ),
            ...
            <= RealNumRep::new(0, 1))))
    {
        let tmp = IntervalList::new(vec![
            Interval::interval_point(
                l[3] * 2 + -a[3] * 3 + a[4] + l[1] + -a[1] * 1 + a[2] * 3 + -l[2] * 3,
            ),
            Interval::interval_lower(
                l[3] * 2 + -a[3] * 3 + a[4] + a[2] * 3 + -a[1] * 1 + l[1] + -l[2] * 3,
            ),
    ...
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![
            ...
            Interval::interval_upper(
                -s[4] * 1 / 3 + l[1] * 2 / 3 + -a[1] * 2 / 3 + -l[2] * 1 + a[2],
            ),
        ]);
        ret = ret.intersection(&tmp);
    }
    ...
    assert!(l[3] + -a[3] * 1 + s[3] <= RealNumRep::new(0, 1));
    assert!(-a[0] * 1 + s[0] + l[0] <= RealNumRep::new(0, 1));
    let tmp = IntervalList::new(vec![Interval::interval_upper(-l[3] * 1 + -s[4] * 1 + a[4])]);
    ret = ret.intersection(&tmp);
    assert!(-a[1] * 1 + s[1] + l[1] <= RealNumRep::new(0, 1));
    ret
}
...
pub fn compute_s_4_t_5_l_4(
    ...
    assert!(
        (l[2] == l[1])
            || (l[2] * 1 / 2 + a[3] * 1 / 2 + -a[2] * 1 + s[1] * 1 / 2 <= RealNumRep::new(-5, 1))
    );
    assert!(
        (l[1] == l[0])
            || (a[2] + -a[1] * 2 + s[0] + l[1] * 2 + -l[2] * 1 <= RealNumRep::new(-5, 1))
    ...
    assert!(
        (l[2] == l[1]) || (l[2] + a[3] + -a[2] * 2 + a[1] + -l[1] * 1 <= RealNumRep::new(-5, 1))
    );
    assert!(
        (l[2] == l[1])
            || (l[2] * 2 + a[3] + -a[2] * 3 + a[1] * 3 + -s[1] * 1 + -l[1] * 3
                <= RealNumRep::new(0, 1))
    );
    assert!(
        (l[2] == l[1])
            || (l[2] * 2 + a[3] + -a[2] * 3 + a[1] * 3 + -a[0] * 1 + -l[1] * 3 + l[0]
                <= RealNumRep::new(0, 1))
    );
    assert!(
        (l[2] == l[1])
            || (l[2] + a[3] + -a[2] * 2 + a[1] * 2 + -s[2] * 1 + -l[1] * 2
                <= RealNumRep::new(0, 1))
    );
    if !(RealNumRep::new(0, 1) <= -a[1] * 1 + s[2] + l[1]) {
        let tmp = IntervalList::new(vec![Interval::interval_upper(
    ...
    assert!((l[1] == l[0]) || (-a[1] * 1 + s[0] + l[1] <= RealNumRep::new(-10, 1)));
    assert!(
        (l[1] == l[0]) || (a[3] + -a[2] * 1 + -a[1] * 1 + s[0] + l[1] <= RealNumRep::new(-5, 1))
    );
    assert!(
        (l[1] == l[0])
            || (-l[2] * 1 / 3 + a[3] * 1 / 3 + -a[1] * 1 + s[0] * 2 / 3 + l[1]
                <= RealNumRep::new(-5, 1))
    );
    assert!(
        (RealNumRep::new(0, 1) <= -a[1] * 1 + s[2] + l[1])
            || (-l[2] * 1 + a[3] + -s[2] * 3 + s[0] * 2 <= RealNumRep::new(0, 1))
    );
    assert!(
        (RealNumRep::new(0, 1) <= -a[1] * 1 + s[2] + l[1])
            || (a[3] + -a[2] * 1 + -s[2] * 1 + s[0] <= RealNumRep::new(0, 1))
    ...
    assert!(
        (l[2] == l[1])
            || (l[2] * 3 + a[3] + -a[2] * 4 + a[1] * 4 + -s[0] * 1 + -l[1] * 4
                <= RealNumRep::new(0, 1))
    );
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![Interval::interval_upper(
    ...
    assert!(
        (l[2] == l[1])
            || (l[2] * 1 / 3 + a[3] * 2 / 3 + -a[2] * 1 + s[0] * 1 / 3 <= RealNumRep::new(-5, 1))
            || (l[2] + a[3] + -a[2] * 2 + a[1] + -l[1] * 1 <= RealNumRep::new(-10, 1))
    );
    assert!(l[0] >= RealNumRep::new(0, 1));
    assert!(l[2] + s[3] + -a[3] * 1 <= RealNumRep::new(0, 1));
    assert!(-a[0] * 1 + s[0] + l[0] <= RealNumRep::new(0, 1));
...
pub fn compute_sim_s_4_t_5_l_4(
    ...
    assert!(
        (l[1] == l[0]) || (a[2] + -a[1] * 1 + -C * 1 + -l[2] * 1 + l[1] <= RealNumRep::new(0, 1))
    );
    assert!(
        (l[2] == l[1])
            || (-a[2] * 1 + a[1] + C + -l[1] * 1 + l[2] == RealNumRep::new(0, 1))
            || (!(a[2] + -a[1] * 1 + -C * 1 + -l[2] * 1 + l[1] <= RealNumRep::new(0, 1)))
    );
    let tmp = IntervalList::new(vec![Interval::interval_upper(-l[2] * 1 + a[3] + C)]);
    ret = ret.intersection(&tmp);
    assert!((l[2] == l[1]) || (a[3] + -a[2] * 1 + -C * 1 + B <= RealNumRep::new(0, 1)));
    ...
    assert!(
        (-a[2] * 1 + a[1] + C + -l[1] * 1 + l[2] + B == RealNumRep::new(0, 1))
            || (!(RealNumRep::new(0, 1) <= a[2] + -a[1] * 1 + -C * 1 + l[1] + -l[2] * 1 + -B * 1))
    );
    ...
    assert!(-l[2] * 1 + a[3] + -C * 3 + -s[1] * 1 <= RealNumRep::new(0, 1));
    assert!(-l[2] * 1 + a[3] + -a[0] * 1 + -C * 3 + l[0] <= RealNumRep::new(0, 1));
    assert!(-C * 2 + s[2] + -s[1] * 1 <= RealNumRep::new(0, 1));
    assert!(-l[2] * 1 + a[3] + -C * 4 + -s[0] * 1 <= RealNumRep::new(0, 1));
    assert!(
        (l[1] == l[0])
            || (-l[2] * 1 + a[3] + -a[1] * 1 + -C * 2 + l[1] + B <= RealNumRep::new(0, 1))
    );
    assert!(B >= RealNumRep::new(5, 1));
    assert!(C >= RealNumRep::new(5, 1));
    assert!(l[0] >= RealNumRep::new(0, 1));
    ...
    assert!(-a[2] * 1 + s[2] + l[2] <= RealNumRep::new(0, 1));
    assert!(-a[1] * 1 + s[1] + l[1] <= RealNumRep::new(0, 1));
    assert!(-l[2] * 1 + a[3] + -C * 2 + -s[2] * 1 <= RealNumRep::new(0, 1));
    assert!(a[3] + -a[2] * 1 + -C * 1 <= RealNumRep::new(0, 1));
    assert!(-a[1] * 1 + -C * 1 + s[2] + l[1] <= RealNumRep::new(0, 1));
    assert!(-l[2] * 1 + a[3] + -a[1] * 1 + -C * 2 + l[1] <= RealNumRep::new(0, 1));
    ret
}
...
pub fn compute_c_t_5_l_5(
    ...
    if !(a[2] + -s[3] * 1 + -l[2] * 1 <= RealNumRep::new(0, 1)) {
        let tmp = IntervalList::new(vec![Interval::interval_upper(a[2] + -s[1] * 1 + -l[2] * 1)]);
        ret = ret.intersection(&tmp);
    }
    if !(l[3] == l[2]) {
        let tmp = IntervalList::new(vec![Interval::interval_upper(
    ...
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_point(a[2] + -a[1] * 1 + l[1] + -l[2] * 1),
    ...
    let tmp = IntervalList::new(vec![Interval::interval_lower(
        a[4] * 1 / 3 + -l[3] * 1 / 3 + -s[2] * 1 / 3,
    )]);
    ret = ret.intersection(&tmp);
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![Interval::interval_lower(
            RealNumRep::new(5, 2) + a[4] * 1 / 2 + -l[3] * 1 / 2 + -a[2] * 1 / 2 + l[2] * 1 / 2,
        )]);
        ret = ret.intersection(&tmp);
    }
    if !(l[1] == l[0]) {
    ...
    if !(l[3] == l[2]) {
        let tmp = IntervalList::new(vec![
            ...
            Interval::interval_upper(a[3] * 1 / 2 + -a[1] * 1 / 2 + -l[3] * 1 / 2 + l[1] * 1 / 2),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !((l[3] == l[2])
    ...
    let tmp = IntervalList::new(vec![Interval::interval_lower(-a[2] * 1 + s[3] + l[2])]);
    ret = ret.intersection(&tmp);
    let tmp = IntervalList::new(vec![Interval::interval_lower(
        a[4] * 1 / 2 + -l[3] * 1 / 2 + -s[3] * 1 / 2,
    )]);
    ret = ret.intersection(&tmp);
    assert!(-a[2] * 1 + l[2] + s[2] <= RealNumRep::new(0, 1));
    let tmp = IntervalList::new(vec![Interval::interval_lower(
    ...
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![Interval::interval_lower(
            RealNumRep::new(5, 3) + a[4] * 1 / 3 + -l[3] * 1 / 3 + -a[1] * 1 / 3 + l[1] * 1 / 3,
        )]);
        ret = ret.intersection(&tmp);
    }
    let tmp = IntervalList::new(vec![Interval::interval_lower(
        a[4] * 1 / 2 + -l[3] * 1 / 2 + -a[2] * 1 / 2 + l[2] * 1 / 2,
    )]);
    ret = ret.intersection(&tmp);
    let tmp = IntervalList::new(vec![Interval::interval_lower(
        a[4] * 1 / 4 + -l[3] * 1 / 4 + -s[1] * 1 / 4,
    )]);
    ret = ret.intersection(&tmp);
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![Interval::interval_upper(
    ...
    let tmp = IntervalList::new(vec![Interval::interval_lower(
        a[4] * 1 / 3 + -l[3] * 1 / 3 + -a[1] * 1 / 3 + l[1] * 1 / 3,
    )]);
    ret = ret.intersection(&tmp);
    if !(l[3] == l[2]) {
        let tmp = IntervalList::new(vec![Interval::interval_upper(
    ...
    let tmp = IntervalList::new(vec![Interval::interval_lower(
        a[4] * 1 / 4 + -l[3] * 1 / 4 + -a[0] * 1 / 4 + l[0] * 1 / 4,
    )]);
    ret = ret.intersection(&tmp);
    let tmp = IntervalList::new(vec![Interval::interval_lower(
        a[4] * 1 / 5 + -l[3] * 1 / 5 + -s[0] * 1 / 5,
    )]);
    ret = ret.intersection(&tmp);
    let tmp = IntervalList::new(vec![Interval::interval_lower(RealNumRep::new(5, 1))]);
    ret = ret.intersection(&tmp);
    ...
    let tmp = IntervalList::new(vec![Interval::interval_lower(s[1] * 1 / 2 + -s[0] * 1 / 2)]);
    ret = ret.intersection(&tmp);
    let tmp = IntervalList::new(vec![Interval::interval_lower(a[4] + -a[3] * 1)]);
    ret = ret.intersection(&tmp);
    assert!(-a[1] * 1 + s[1] + l[1] <= RealNumRep::new(0, 1));
    let tmp = IntervalList::new(vec![Interval::interval_lower(-a[0] * 1 + s[1] + l[0])]);
    ret = ret.intersection(&tmp);
...
pub fn compute_b_t_5_l_5(
    ...
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![Interval::interval_upper(
            -a[4] * 1 / 3 + l[3] * 1 / 3 + a[2] + -s[1] * 2 / 3 + -l[2] * 1,
        )]);
        ret = ret.intersection(&tmp);
    }
    if !(l[2] == l[1]) {
    ...
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_upper(a[2] + -s[3] * 2 / 3 + -s[0] * 1 / 3 + -l[2] * 1),
            Interval::interval_upper(
                a[2] + -a[1] * 1 / 2 + -s[3] * 1 / 2 + l[1] * 1 / 2 + -l[2] * 1,
            ),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_upper(
                -a[4] * 1 / 2 + l[3] * 1 / 2 + a[2] + -s[0] * 1 / 2 + -l[2] * 1,
            ),
            Interval::interval_upper(
                -a[4] * 1 / 3 + l[3] * 1 / 3 + a[2] + -a[1] * 2 / 3 + l[1] * 2 / 3 + -l[2] * 1,
            ),
        ]);
        ret = ret.intersection(&tmp);
    }
    ...
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![Interval::interval_upper(
            -a[4] * 1 + l[3] + a[2] * 3 + -a[1] * 2 + l[1] * 2 + -l[2] * 3,
        )]);
        ret = ret.intersection(&tmp);
    }
    assert!(
    ...
    if !(l[3] == l[2]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_upper(
                a[3] * 1 / 2 + -a[2] * 1 + a[1] * 1 / 2 + l[2] + -l[1] * 1 / 2 + -l[3] * 1 / 2,
            ),
    ...
    if !(l[3] == l[2]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_upper(
                -a[4] * 1 / 2 + -l[3] * 1 / 2 + a[3] + -a[2] * 1 / 2 + l[2] * 1 / 2,
            ),
            Interval::interval_upper(
                -a[4] * 1 + -l[3] * 1 / 2 + a[3] * 3 / 2 + -a[1] * 1 / 2 + l[1] * 1 / 2,
            ),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_upper(-a[4] * 2 + a[3] * 2 + a[2] + -s[0] * 1 + -l[2] * 1),
            Interval::interval_upper(-a[4] * 1 + a[3] + a[2] + -a[1] * 1 + l[1] + -l[2] * 1),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !(l[3] == l[2]) {
    ...
    if !(l[3] == l[2]) {
        let tmp = IntervalList::new(vec![Interval::interval_upper(
            -a[4] * 1 / 2 + -l[3] * 1 / 2 + a[3] + -s[2] * 1 / 2,
        )]);
        ret = ret.intersection(&tmp);
    }
    if !(a[2] + -s[3] * 1 + -l[2] * 1 <= RealNumRep::new(0, 1)) {
        let tmp = IntervalList::new(vec![Interval::interval_lower(
            a[4] + -a[3] * 1 + a[1] + -s[3] * 1 + -l[1] * 1,
        )]);
        ret = ret.intersection(&tmp);
    }
    if !(a[2] + -s[3] * 1 + -l[2] * 1 <= RealNumRep::new(0, 1)) {
    ...
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![Interval::interval_upper(
            -a[4] * 1 / 4 + l[3] * 1 / 4 + a[1] + -s[0] * 3 / 4 + -l[1] * 1,
        )]);
        ret = ret.intersection(&tmp);
    }
    if !(a[2] + -s[3] * 1 + -l[2] * 1 <= RealNumRep::new(0, 1)) {
    ...
    if !(a[2] + -s[3] * 1 + -l[2] * 1 <= RealNumRep::new(0, 1)) {
        let tmp = IntervalList::new(vec![Interval::interval_lower(
            a[4] * 1 / 2 + -l[3] * 1 / 2 + a[1] + -s[3] * 3 / 2 + -l[1] * 1,
        )]);
        ret = ret.intersection(&tmp);
    }
    if !(l[1] == l[0]) {
    ...
    if !(l[3] == l[2]) {
        let tmp = IntervalList::new(vec![
            ...
            Interval::interval_upper(-a[4] * 2 / 3 + -l[3] * 1 / 3 + a[3] + -s[1] * 1 / 3),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !(l[3] == l[2]) {
        let tmp = IntervalList::new(vec![
            ...
            Interval::interval_upper(-a[4] * 3 / 4 + -l[3] * 1 / 4 + a[3] + -s[0] * 1 / 4),
            Interval::interval_lower(-a[4] * 1 + a[3] + a[1] + -s[0] * 1 + -l[1] * 1),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !(l[1] == l[0]) {
    ...
    if !(l[3] == l[2]) {
        let tmp = IntervalList::new(vec![
            ...
            Interval::interval_upper(
                -a[4] * 2 / 3 + -l[3] * 1 / 3 + a[3] + -a[1] * 1 / 3 + l[1] * 1 / 3,
            ),
        ]);
        ret = ret.intersection(&tmp);
    }
    ...
    assert!(
        (a[2] + -s[3] * 1 + -l[2] * 1 <= RealNumRep::new(0, 1))
            || (a[4] + -l[3] * 1 + -s[3] * 3 + s[1] * 2 <= RealNumRep::new(0, 1))
    );
    assert!(
        (a[1] + -l[1] * 1 + -s[2] * 1 <= RealNumRep::new(0, 1))
            || (s[3] + -s[2] * 3 + s[0] * 2 <= RealNumRep::new(0, 1))
    ...
    assert!(
        (a[1] + -l[1] * 1 + -s[2] * 1 <= RealNumRep::new(0, 1))
            || (a[4] + -l[3] * 1 + -s[2] * 4 + s[0] * 3 <= RealNumRep::new(0, 1))
    );
    assert!(
        (a[2] + -s[3] * 1 + -l[2] * 1 <= RealNumRep::new(0, 1))
            || (a[4] + -a[3] * 1 + -s[3] * 1 + s[1] <= RealNumRep::new(0, 1))
    );
    assert!(
        (a[2] + -s[3] * 1 + -l[2] * 1 <= RealNumRep::new(0, 1))
            || (a[4] + -a[3] * 1 + -s[3] * 1 / 2 + s[0] * 1 / 2 <= RealNumRep::new(0, 1))
            || (a[4] + -a[3] * 1 + a[1] + -s[3] * 1 + -l[1] * 1 <= RealNumRep::new(0, 1))
    );
    assert!(
        (a[2] + -s[3] * 1 + -l[2] * 1 <= RealNumRep::new(0, 1))
            || (a[4] + -l[3] * 1 + -s[3] * 2 + s[0] <= RealNumRep::new(0, 1))
            || (a[4] + -l[3] * 1 + a[1] * 2 + -s[3] * 3 + -l[1] * 2 <= RealNumRep::new(0, 1))
    );
    assert!(
        (a[1] + -l[1] * 1 + -s[2] * 1 <= RealNumRep::new(0, 1))
            || (a[4] + -l[3] * 1 + -a[2] * 1 + l[2] + -s[2] * 2 + s[0] * 2
                <= RealNumRep::new(0, 1))
    );
    assert!(
        (a[1] + -l[1] * 1 + -s[2] * 1 <= RealNumRep::new(0, 1))
    ...
    ret = ret.intersection(&tmp);
    assert!(l[0] >= RealNumRep::new(0, 1));
    assert!(-a[3] * 1 + s[3] + l[3] <= RealNumRep::new(0, 1));
    assert!(-a[4] * 1 + l[3] + s[4] <= RealNumRep::new(0, 1));
    assert!(-a[0] * 1 + s[0] + l[0] <= RealNumRep::new(0, 1));
    assert!(-a[2] * 1 + s[2] + l[2] <= RealNumRep::new(0, 1));
    ret
...
pub fn compute_q_4_t_5_l_5(
    ...
    assert!(
        (l[3] == l[2])
            || (a[2] + -s[3] * 1 + -l[2] * 1 <= RealNumRep::new(0, 1))
            || (a[4] * 2 + -a[3] * 2 + a[1] * 2 + -s[3] * 2 + -l[1] * 2 <= RealNumRep::new(0, 1))
    );
    assert!(
        (a[2] + -s[3] * 1 + -l[2] * 1 <= RealNumRep::new(0, 1))
            || (-s[3] * 1 + s[1] <= RealNumRep::new(-5, 1))
    ...
    assert!(
        (a[2] + -s[3] * 1 + -l[2] * 1 <= RealNumRep::new(0, 1))
            || (a[4] * 1 / 3 + -l[3] * 1 / 3 + -s[3] * 1 + s[1] * 2 / 3 <= RealNumRep::new(0, 1))
    );
    assert!(
        (a[2] + -s[3] * 1 + -l[2] * 1 <= RealNumRep::new(0, 1))
            || (a[4] + -a[3] * 1 + -s[3] * 1 + s[1] <= RealNumRep::new(0, 1))
    ...
    assert!(-a[3] * 1 + s[3] + l[3] <= RealNumRep::new(0, 1));
    assert!(
        (l[1] == l[0]) || (a[4] + -a[3] * 1 + -a[1] * 1 + s[0] + l[1] <= RealNumRep::new(-5, 1))
    );
    assert!(
        (a[2] + -s[3] * 1 + -l[2] * 1 <= RealNumRep::new(0, 1))
            || (-a[0] * 1 + -s[3] * 1 + s[1] * 2 + l[0] <= RealNumRep::new(0, 1))
    ...
    assert!(
        (a[1] + -s[2] * 1 + -l[1] * 1 <= RealNumRep::new(0, 1))
            || (a[4] * 1 / 4 + -l[3] * 1 / 4 + -s[2] * 1 + s[0] * 3 / 4 <= RealNumRep::new(0, 1))
    );
    assert!(
        (l[1] == l[0])
            || (a[2] + -s[3] * 1 + -l[2] * 1 <= RealNumRep::new(0, 1))
    ...
    assert!(
        (l[3] == l[2])
            || (a[4] * 1 / 2 + l[3] * 1 / 2 + -a[3] * 1 + s[2] * 1 / 2 <= RealNumRep::new(-5, 1))
    );
    assert!(
        (l[3] == l[2])
            || (a[4] + l[3] * 1 / 2 + -a[3] * 3 / 2 + a[1] * 1 / 2 + -l[1] * 1 / 2
                <= RealNumRep::new(-5, 1))
            || (a[4] + l[3] + -a[3] * 2 + a[2] + -l[2] * 1 <= RealNumRep::new(-10, 1))
    );
    assert!(
        (l[1] == l[0])
            || (a[4] * 1 / 2
    ...
    assert!(
        (l[3] == l[2])
            || (-a[3] * 1 + a[2] + s[1] * 1 / 2 + -s[0] * 1 / 2 + -l[1] * 1 + l[3]
                <= RealNumRep::new(0, 1))
            || (!(RealNumRep::new(0, 1) <= l[1] + -l[2] * 1))
    );
    assert!(
    ...
    assert!(
        (l[3] == l[2])
            || (-a[3] * 1 + a[2] + a[1] + -a[0] * 1 + -l[2] * 1 + -l[1] * 1 + l[3] + l[0]
                <= RealNumRep::new(0, 1))
            || (a[4] * 2 + l[3] * 2 + -a[3] * 4 + a[1] * 4 + -a[0] * 2 + -l[1] * 4 + l[0] * 2
                <= RealNumRep::new(0, 1))
    );
    assert!(
        (l[3] == l[2])
    ...
    assert!(
        (l[3] == l[2])
            || (-a[3] * 1 + a[2] + a[1] + -l[2] * 1 + -s[1] * 1 + -l[1] * 1 + l[3]
                <= RealNumRep::new(0, 1))
            || (a[4] * 2 + l[3] * 2 + -a[3] * 4 + a[1] * 4 + -s[1] * 2 + -l[1] * 4
                <= RealNumRep::new(0, 1))
    );
    assert!(
        (l[3] == l[2])
    ...
    assert!(
        (l[1] == l[0])
            || (a[4] * 1 / 4 + -l[3] * 1 / 4 + -a[1] * 1 + s[0] * 3 / 4 + l[1]
                <= RealNumRep::new(-5, 1))
    );
    assert!(
        (l[1] == l[0])
    ...
    assert!(
        (a[1] + -s[2] * 1 + -l[1] * 1 <= RealNumRep::new(0, 1))
            || (a[4] * 1 / 2 + -l[3] * 1 / 2 + -a[2] * 1 / 2 + l[2] * 1 / 2 + -s[2] * 1 + s[0]
                <= RealNumRep::new(0, 1))
    );
    assert!(
        (l[2] == l[1])
    ...
    assert!(
        (a[2] + -s[3] * 1 + -l[2] * 1 <= RealNumRep::new(0, 1))
            || (a[4] + -l[3] * 1 + -s[3] * 2 + s[0] <= RealNumRep::new(0, 1))
            || (a[4] * 2 / 3 + -l[3] * 2 / 3 + a[1] * 4 / 3 + -s[3] * 2 + -l[1] * 4 / 3
                <= RealNumRep::new(0, 1))
    );
    assert!(
        (l[3] == l[2]) || (a[4] + l[3] + -a[3] * 2 + a[2] + -l[2] * 1 <= RealNumRep::new(-5, 1))
    );
    assert!(
        (l[2] == l[1])
    ...
    assert!(
        (l[3] == l[2])
            || (a[4] + l[3] + -a[3] * 2 + a[2] * 2 + -s[3] * 1 + -l[2] * 2
                <= RealNumRep::new(0, 1))
    );
    assert!(
        (a[2] + -s[3] * 1 + -l[2] * 1 <= RealNumRep::new(0, 1))
            || (a[4] + -a[3] * 1 + -s[3] * 1 / 2 + s[0] * 1 / 2 <= RealNumRep::new(0, 1))
            || (a[4] + -a[3] * 1 + a[1] + -s[3] * 1 + -l[0] * 1 <= RealNumRep::new(0, 1))
    );
    assert!(
        (l[2] == l[1])
            || (a[3] * 2 + -a[2] * 2 + -s[3] * 1 + s[0] + l[2] * 2 + -l[3] * 2
                <= RealNumRep::new(0, 1))
            || (a[3] + -a[2] * 1 + a[1] + -s[3] * 1 + -l[3] * 1 + -l[1] * 1 + l[2]
                <= RealNumRep::new(0, 1))
    );
    assert!(
        (l[3] == l[2])
    ...
    assert!(
        (l[3] == l[2])
            || (-a[3] * 1 + a[2] + s[2] * 1 / 2 + -s[1] * 1 / 2 + -l[1] * 1 + l[3]
                <= RealNumRep::new(0, 1))
            || (!(RealNumRep::new(0, 1) <= l[1] + -l[2] * 1))
    );
    assert!(
    ...
    assert!(
        (l[2] == l[1])
            || (a[4] + -a[3] * 1 + -a[2] * 1 + a[1] + -l[1] * 1 + l[2] <= RealNumRep::new(-5, 1))
            || (a[4] * 2 + -a[3] * 2 + -a[2] * 1 + s[0] + l[2] <= RealNumRep::new(-5, 1))
    );
    assert!(
        (l[2] == l[1]) || (a[4] + -a[3] * 1 + -a[2] * 1 + s[1] + l[2] <= RealNumRep::new(-5, 1))
    );
    assert!(
        (l[3] == l[2])
    ...
    assert!(
        (l[3] == l[2])
            || (a[4] * 2 / 3 + l[3] * 1 / 3 + -a[3] * 1 + s[1] * 1 / 3 <= RealNumRep::new(-5, 1))
            || (a[4] + l[3] + -a[3] * 2 + a[2] + -l[2] * 1 <= RealNumRep::new(-10, 1))
    );
    assert!(
        (l[3] == l[2])
    ...
    assert!(
        (l[3] == l[2])
            || (!(RealNumRep::new(0, 1) <= l[1] + -l[2] * 1))
            || (a[4] + l[3] * 2 + -a[3] * 3 + a[2] * 3 + -s[2] * 1 + -l[1] * 3
                <= RealNumRep::new(0, 1))
    );
    assert!(
        (l[3] == l[2])
            || (a[4] + l[3] + -a[3] * 2 + a[2] + -l[2] * 1 <= RealNumRep::new(-10, 1))
            || (a[4] * 3 / 4 + l[3] * 1 / 4 + -a[3] * 1 + s[0] * 1 / 4 <= RealNumRep::new(-5, 1))
            || (a[4] * 2 / 3 + l[3] * 1 / 3 + -a[3] * 1 + a[1] * 1 / 3 + -l[1] * 1 / 3
                <= RealNumRep::new(-5, 1))
    );
    assert!(
        (l[3] == l[2])
            || (!(RealNumRep::new(0, 1) <= l[1] + -l[2] * 1))
            || (a[4] + l[3] * 4 + -a[3] * 5 + a[2] * 5 + -s[0] * 1 + -l[1] * 5
                <= RealNumRep::new(0, 1))
    );
    assert!(
        (l[3] == l[2])
    ...
    assert!(
        (l[2] == l[1])
            || (a[4] * 1 / 2 + -l[3] * 1 / 2 + -a[2] * 1 + s[0] * 1 / 2 + l[2]
                <= RealNumRep::new(-5, 1))
            || (a[4] + -l[3] * 1 + -a[2] * 3 + a[1] * 2 + -l[1] * 2 + l[2] * 3
                <= RealNumRep::new(-15, 1))
    );
    assert!(
        (l[2] == l[1])
            || (a[4] * 1 / 3 + -l[3] * 1 / 3 + -a[2] * 1 + s[1] * 2 / 3 + l[2]
                <= RealNumRep::new(-5, 1))
    );
    assert!(
        (l[2] == l[1])
...
pub fn compute_l_1_t_5_l_1(
    ...
    let tmp = IntervalList::new(vec![Interval::interval_upper(a[1] + -s[3] * 1)]);
    ret = ret.intersection(&tmp);
    assert!(
        (-a[0] * 1 + l[0] + -s[4] * 1 / 2 + s[1] * 3 / 2 <= RealNumRep::new(0, 1))
            || (RealNumRep::new(0, 1) <= a[1] + -a[2] * 1 + s[4] * 1 / 2 + -s[1] * 1 / 2)
    );
    ...
    let tmp = IntervalList::new(vec![
        Interval::interval_point(l[0]),
        Interval::interval_upper(a[1] + a[4] + -a[2] * 1 + -s[4] * 1 + s[2] + -s[0] * 1),
    ]);
    ret = ret.intersection(&tmp);
    if !(-s[4] * 1 / 3 + s[0] * 1 / 3 <= RealNumRep::new(-5, 1)) {
        let tmp = IntervalList::new(vec![Interval::interval_lower(
            RealNumRep::new(-5, 1) + a[1] + a[3] * 2 + -a[2] * 2 + -s[4] * 1,
        )]);
        ret = ret.intersection(&tmp);
    }
    if !(-a[0] * 1 + l[0] + -s[4] * 2 + s[2] * 3 <= RealNumRep::new(0, 1)) {
        let tmp = IntervalList::new(vec![Interval::interval_lower(a[3] + -s[4] * 1)]);
        ret = ret.intersection(&tmp);
    }
    ...
    if !(-a[0] * 1 + l[0] + -s[4] * 1 / 2 + s[1] * 3 / 2 <= RealNumRep::new(0, 1)) {
        let tmp = IntervalList::new(vec![Interval::interval_lower(a[3] + -s[4] * 1)]);
        ret = ret.intersection(&tmp);
    }
    ...
    let tmp = IntervalList::new(vec![
        Interval::interval_point(l[0]),
        Interval::interval_upper(s[3] + a[1] + a[4] + -a[2] * 1 + -s[4] * 1 + -s[1] * 1),
    ]);
    ret = ret.intersection(&tmp);
    if !(-s[4] * 1 / 3 + s[0] * 1 / 3 <= RealNumRep::new(-5, 1)) {
        let tmp = IntervalList::new(vec![Interval::interval_lower(a[3] + -s[4] * 1)]);
    ...
    let tmp = IntervalList::new(vec![
        Interval::interval_point(l[0]),
        Interval::interval_upper(
            s[3] * 1 / 2 + a[1] + a[4] + -a[2] * 1 + -s[4] * 1 + -s[0] * 1 / 2,
        ),
    ]);
    ret = ret.intersection(&tmp);
    assert!(l[0] >= RealNumRep::new(0, 1));
    ...
    assert!(-s[3] * 2 + s[1] * 3 + -s[0] * 1 <= RealNumRep::new(0, 1));
    assert!(-a[0] * 1 + -s[3] * 1 + l[0] + s[1] * 2 <= RealNumRep::new(0, 1));
    assert!(-s[3] * 1 + s[4] * 1 / 2 + s[0] * 1 / 2 <= RealNumRep::new(0, 1));
    assert!(-s[3] * 1 + s[4] * 1 / 3 + s[1] * 2 / 3 <= RealNumRep::new(0, 1));
    let tmp = IntervalList::new(vec![Interval::interval_upper(
        s[3] + a[3] + -s[4] * 1 + -s[1] * 1,
    )]);
    ret = ret.intersection(&tmp);
...
pub fn compute_sim_l_1_t_5_l_1(
    ...
    let tmp = IntervalList::new(vec![
        Interval::interval_point(l[0]),
        Interval::interval_upper(a[1] + C * 3 + -s[4] * 1 + -B * 1),
    ]);
    ret = ret.intersection(&tmp);
    ...
    let tmp = IntervalList::new(vec![
        Interval::interval_point(l[0]),
        Interval::interval_upper(a[1] + a[4] + -a[2] * 1 + C + -s[4] * 1),
    ]);
    ret = ret.intersection(&tmp);
    let tmp = IntervalList::new(vec![
        Interval::interval_point(l[0]),
        Interval::interval_upper(-s[3] * 1 + a[1] + C * 2 + -B * 1),
    ]);
    ret = ret.intersection(&tmp);
    let tmp = IntervalList::new(vec![
        Interval::interval_point(l[0]),
    ...
    let tmp = IntervalList::new(vec![
        Interval::interval_lower(a[1] + C * 2 + -s[4] * 1 + -B * 1),
        Interval::interval_lower(a[3] + -s[4] * 1),
    ]);
    ret = ret.intersection(&tmp);
    assert!(-a[4] * 1 + a[2] + -B * 1 + -C * 1 + s[4] + -s[2] * 1 <= RealNumRep::new(0, 1));
    let tmp = IntervalList::new(vec![Interval::interval_upper(a[4] + -s[4] * 1)]);
    ret = ret.intersection(&tmp);
    assert!(s[3] + -C * 4 + -s[0] * 1 <= RealNumRep::new(0, 1));
    ...
    assert!(-a[0] * 1 + l[0] + -a[4] * 1 + a[2] + -B * 1 + -C * 2 + s[4] <= RealNumRep::new(0, 1));
    assert!(-a[4] * 1 + a[2] + -B * 1 + -C * 3 + s[4] + -s[0] * 1 <= RealNumRep::new(0, 1));
    assert!(-s[3] * 1 + -a[4] * 1 + a[2] + -B * 1 + s[4] <= RealNumRep::new(0, 1));
    assert!(-a[4] * 1 + a[2] + -B * 1 + -C * 2 + s[4] + -s[1] * 1 <= RealNumRep::new(0, 1));
    assert!(C >= RealNumRep::new(5, 1));
    assert!(l[0] >= RealNumRep::new(0, 1));
    ...
    assert!(C + -s[2] * 1 + s[0] <= RealNumRep::new(0, 1));
    assert!(s[3] + -C * 2 + -s[2] * 1 <= RealNumRep::new(0, 1));
    assert!(-a[0] * 1 + l[0] + -C * 4 + s[4] <= RealNumRep::new(0, 1));
    assert!(-a[0] * 1 + s[3] + l[0] + -C * 3 <= RealNumRep::new(0, 1));
...
pub fn compute_l_2_t_5_l_2(
    ...
    let tmp = IntervalList::new(vec![
        Interval::interval_point(l[1]),
        Interval::interval_upper(RealNumRep::new(-5, 1) + l[1] + -a[1] * 1 + a[2]),
    ]);
    ret = ret.intersection(&tmp);
    assert!(
        (-s[3] * 1 / 2 + s[0] * 1 / 2 <= RealNumRep::new(-5, 1))
    ...
    assert!(
        (RealNumRep::new(0, 1) <= l[1] + -a[1] * 1 + s[2])
            || (!(RealNumRep::new(-5, 1) <= l[1] + -a[1] * 1 + s[0]))
    );
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![Interval::interval_lower(
            l[1] + -a[1] * 1 + a[2] + -s[2] * 1 + s[0],
        )]);
        ret = ret.intersection(&tmp);
    }
    let tmp = IntervalList::new(vec![
        Interval::interval_point(l[1]),
        Interval::interval_upper(
            l[1] * 1 / 2 + -a[1] * 1 / 2 + a[2] + a[4] * 1 / 2 + -a[3] * 1 / 2 + -s[4] * 1 / 2,
        ),
    ]);
    ret = ret.intersection(&tmp);
    let tmp = IntervalList::new(vec![
        Interval::interval_point(l[1]),
        Interval::interval_upper(
            l[1] * 1 / 2 + -a[1] * 1 / 2 + a[2] * 1 / 2 + a[3] * 1 / 2 + -s[4] * 1 / 2,
        ),
    ]);
    ret = ret.intersection(&tmp);
    if !(-s[4] * 1 / 2 + s[1] * 1 / 2 <= RealNumRep::new(-5, 1)) {
    ...
    let tmp = IntervalList::new(vec![
        Interval::interval_point(l[1]),
        Interval::interval_upper(
            RealNumRep::new(-5, 3) + l[1] * 2 / 3 + -a[1] * 2 / 3 + a[2] + -s[4] * 1 / 3,
        ),
    ]);
    ret = ret.intersection(&tmp);
    let tmp = IntervalList::new(vec![
        Interval::interval_point(l[1]),
        Interval::interval_upper(l[1] + -a[1] * 1 + a[2] + -s[4] * 1 / 4 + s[1] * 1 / 4),
    ]);
    ret = ret.intersection(&tmp);
    let tmp = IntervalList::new(vec![
        Interval::interval_point(l[1]),
        Interval::interval_upper(
            l[1] + -a[1] * 1 + a[2] + a[0] * 1 / 4 + -s[4] * 1 / 4 + -l[0] * 1 / 4,
        ),
    ]);
    ret = ret.intersection(&tmp);
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![Interval::interval_lower(
            RealNumRep::new(5, 1) + l[1] * 2 + -a[1] * 2 + a[2] + s[0],
        )]);
        ret = ret.intersection(&tmp);
    }
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![Interval::interval_lower(
            l[1] + -a[1] * 1 + -s[3] * 1 / 2 + a[2] + s[0] * 1 / 2,
        )]);
        ret = ret.intersection(&tmp);
    }
    let tmp = IntervalList::new(vec![
        Interval::interval_point(l[1]),
        Interval::interval_upper(l[1] + -a[1] * 1 + s[3] * 1 / 2 + a[2] + -s[4] * 1 / 2),
    ]);
    ret = ret.intersection(&tmp);
    let tmp = IntervalList::new(vec![
        Interval::interval_point(l[1]),
        Interval::interval_upper(l[1] + -a[1] * 1 + a[2] + -s[4] * 1 / 3 + s[2] * 1 / 3),
    ]);
    ret = ret.intersection(&tmp);
    assert!(
        (l[1] == l[0])
            || (l[1] + -a[1] * 1 + -s[3] * 1 + -a[4] * 1 + a[3] + s[4] + s[0]
                <= RealNumRep::new(0, 1))
    );
    let tmp = IntervalList::new(vec![
        Interval::interval_point(l[1]),
        Interval::interval_upper(
            l[1] + -a[1] * 1 + a[2] + a[0] * 1 / 2 + -s[2] * 1 / 2 + -l[0] * 1 / 2,
        ),
    ]);
    ret = ret.intersection(&tmp);
    let tmp = IntervalList::new(vec![
        Interval::interval_point(l[1]),
        Interval::interval_upper(l[1] + -a[1] * 1 + -s[3] * 1 / 4 + a[2] + s[0] * 1 / 4),
    ]);
    ret = ret.intersection(&tmp);
    let tmp = IntervalList::new(vec![
        Interval::interval_point(l[1]),
        Interval::interval_upper(l[1] + -a[1] * 1 + a[2] + -s[2] * 1 / 3 + s[0] * 1 / 3),
    ]);
    ret = ret.intersection(&tmp);
    let tmp = IntervalList::new(vec![
        Interval::interval_point(l[1]),
        Interval::interval_upper(l[1] + -a[1] * 1 + -s[3] * 1 / 2 + a[2] + s[2] * 1 / 2),
    ]);
    ret = ret.intersection(&tmp);
    let tmp = IntervalList::new(vec![
        Interval::interval_point(l[1]),
        Interval::interval_upper(
            l[1] + -a[1] * 1 + -s[3] * 1 / 3 + a[2] + a[0] * 1 / 3 + -l[0] * 1 / 3,
        ),
    ]);
    ret = ret.intersection(&tmp);
    assert!((l[1] == l[0]) || (l[1] + -a[1] * 1 + s[1] <= RealNumRep::new(-5, 1)));
    ...
    assert!(
        (l[1] == l[0])
            || (l[1] * 3 / 2 + -a[1] * 3 / 2 + -a[4] * 1 / 2 + a[3] * 1 / 2 + s[4] * 1 / 2 + s[0]
                <= RealNumRep::new(-5, 1))
    );
    let tmp = IntervalList::new(vec![
        Interval::interval_point(l[1]),
    ...
    let tmp = IntervalList::new(vec![
        Interval::interval_point(l[1]),
        Interval::interval_upper(l[1] + -a[1] * 1 + a[2] + a[0] + -s[1] * 1 + -l[0] * 1),
    ]);
    ret = ret.intersection(&tmp);
    if !((l[1] == l[0]) || (l[1] + -a[1] * 1 + -s[4] * 1 + s[2] * 2 <= RealNumRep::new(-5, 1))) {
        let tmp = IntervalList::new(vec![Interval::interval_lower(a[3] + -s[4] * 1)]);
        ret = ret.intersection(&tmp);
    }
    if !(-s[4] * 2 + s[2] * 3 + -s[1] * 1 <= RealNumRep::new(0, 1)) {
    ...
    let tmp = IntervalList::new(vec![
        Interval::interval_point(l[1]),
        Interval::interval_upper(l[1] + -a[1] * 1 + a[2] + -s[4] * 1 / 5 + s[0] * 1 / 5),
    ]);
    ret = ret.intersection(&tmp);
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(a[3] + -s[4] * 1),
            Interval::interval_lower(l[1] + -a[1] * 1 + a[2] + -s[4] * 1 + s[2]),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(a[3] + -s[4] * 1),
            Interval::interval_lower(l[1] + -a[1] * 1 + a[2] + -s[4] * 1 / 2 + s[1] * 1 / 2),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(a[3] + -s[4] * 1),
            Interval::interval_lower(l[1] + -a[1] * 1 + a[2] + -s[4] * 1 / 3 + s[0] * 1 / 3),
        ]);
        ret = ret.intersection(&tmp);
    }
    let tmp = IntervalList::new(vec![
        Interval::interval_point(l[1]),
        Interval::interval_upper(l[1] + -a[1] * 1 + -s[3] * 1 / 3 + a[2] + s[1] * 1 / 3),
    ]);
    ret = ret.intersection(&tmp);
    let tmp = IntervalList::new(vec![
        Interval::interval_point(l[1]),
        Interval::interval_upper(l[1] + -a[1] * 1 + a[2] + -s[2] * 1 / 2 + s[1] * 1 / 2),
    ]);
    ret = ret.intersection(&tmp);
    let tmp = IntervalList::new(vec![
        Interval::interval_point(l[1]),
        Interval::interval_upper(l[1] + -a[1] * 1 + a[2] + -s[1] * 1 / 2 + s[0] * 1 / 2),
    ]);
    ret = ret.intersection(&tmp);
    assert!(
        (!(RealNumRep::new(-5, 1) <= l[1] + -a[1] * 1 + s[0]))
    ...
    if !((!(RealNumRep::new(-5, 1) <= l[1] + -a[1] * 1 + s[0]))
        || (-l[1] * 1 / 2 + a[1] * 1 / 2 + -s[4] * 1 / 2 <= RealNumRep::new(-5, 1)))
    {
        let tmp = IntervalList::new(vec![Interval::interval_lower(a[3] + -s[4] * 1)]);
        ret = ret.intersection(&tmp);
    ...
    let tmp = IntervalList::new(vec![
        ...
        Interval::interval_upper(l[1] + -a[1] * 1 + s[3] + a[3] + -s[4] * 1),
    ]);
    ret = ret.intersection(&tmp);
    assert!(
        (l[1] == l[0])
            || (l[1] + -a[1] * 1 + s[4] * 1 / 4 + s[0] * 3 / 4 <= RealNumRep::new(-5, 1))
    );
    assert!(
        (l[1] == l[0])
            || (l[1] + -a[1] * 1 + -s[3] * 2 + -a[4] * 1 + a[3] + s[4] + s[1] * 2
                <= RealNumRep::new(0, 1))
    );
    let tmp = IntervalList::new(vec![
        Interval::interval_point(l[1]),
        Interval::interval_upper(
            RealNumRep::new(-5, 3) + a[2] * 1 / 3 + a[3] * 2 / 3 + -s[4] * 2 / 3 + -s[0] * 1 / 3,
        ),
        Interval::interval_upper(
            RealNumRep::new(-5, 2)
                + l[1] * 1 / 2
    ...
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![Interval::interval_upper(
            RealNumRep::new(-5, 1) + -l[1] * 1 + a[1] + a[3] + -s[4] * 1 + -s[0] * 1,
        )]);
        ret = ret.intersection(&tmp);
    }
    let tmp = IntervalList::new(vec![
        Interval::interval_point(l[1]),
        Interval::interval_upper(s[3] + a[2] + a[4] + -a[3] * 1 + -s[4] * 1 + -s[1] * 1),
    ]);
    ret = ret.intersection(&tmp);
    let tmp = IntervalList::new(vec![
        Interval::interval_point(l[1]),
        Interval::interval_upper(l[1] + -a[1] * 1 + s[3] + a[2] + a[4] + -a[3] * 1 + -s[4] * 1),
        Interval::interval_upper(
            s[3] * 1 / 2 + a[2] + a[4] + -a[3] * 1 + -s[4] * 1 + -s[0] * 1 / 2,
        ),
    ]);
    ret = ret.intersection(&tmp);
    assert!(
        (-s[3] * 1 + s[4] * 1 / 2 + s[0] * 1 / 2 <= RealNumRep::new(0, 1))
            || (-l[1] * 2 + a[1] * 2 + -s[3] * 3 + s[4] <= RealNumRep::new(0, 1))
    );
    assert!(
        (RealNumRep::new(0, 1) <= l[1] + -a[1] * 1 + s[2])
            || (s[4] * 1 / 4 + -s[2] * 1 + s[0] * 3 / 4 <= RealNumRep::new(0, 1))
    );
    if !(RealNumRep::new(0, 1) <= l[1] + -a[1] * 1 + s[2]) {
        let tmp = IntervalList::new(vec![Interval::interval_upper(
            a[3] + -s[4] * 1 + s[2] + -s[0] * 1,
        )]);
        ret = ret.intersection(&tmp);
    ...
    if !(RealNumRep::new(0, 1) <= l[1] + -a[1] * 1 + s[2]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_point(l[1]),
            Interval::interval_upper(a[2] + a[4] + -a[3] * 1 + -s[4] * 1 + s[2] + -s[0] * 1),
        ]);
        ret = ret.intersection(&tmp);
    }
    let tmp = IntervalList::new(vec![
    ...
    let tmp = IntervalList::new(vec![
        Interval::interval_point(l[1]),
        Interval::interval_upper(
            RealNumRep::new(-5, 2) + a[2] * 1 / 2 + a[3] * 1 / 2 + -s[4] * 1 / 2 + -s[1] * 1 / 2,
        ),
    ]);
    ret = ret.intersection(&tmp);
    let tmp = IntervalList::new(vec![
...
pub fn compute_sim_l_2_t_5_l_2(
    ...
    assert!((l[1] == l[0]) || (l[1] + -a[1] * 1 + C + s[0] + B <= RealNumRep::new(0, 1)));
    assert!(-l[1] * 1 + a[1] + -s[3] * 1 + C + -B * 1 <= RealNumRep::new(0, 1));
    if !((l[1] == l[0]) || (RealNumRep::new(0, 1) <= a[1] + -a[2] * 1 + C)) {
    ...
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_point(l[1]),
            Interval::interval_point(l[1] + -a[1] * 1 + a[2] + -C * 1),
        ]);
        ret = ret.intersection(&tmp);
    }
    assert!((l[1] == l[0]) || (l[1] + -a[1] * 1 + -C * 1 + s[2] + B <= RealNumRep::new(0, 1)));
    assert!((l[1] == l[0]) || (l[1] + -a[1] * 1 + s[1] + B <= RealNumRep::new(0, 1)));
    if !(-l[1] * 1 + a[1] + C * 2 + -s[4] * 1 + -B * 1 <= RealNumRep::new(0, 1)) {
        let tmp = IntervalList::new(vec![Interval::interval_lower(a[3] + -s[4] * 1)]);
        ret = ret.intersection(&tmp);
    }
    assert!((l[1] == l[0]) || (l[1] + -a[1] * 1 + s[3] + -C * 2 + B <= RealNumRep::new(0, 1)));
    assert!((l[1] == l[0]) || (l[1] + -a[1] * 1 + -C * 3 + s[4] + B <= RealNumRep::new(0, 1)));
    let tmp = IntervalList::new(vec![Interval::interval_upper(a[4] + -s[4] * 1)]);
    ret = ret.intersection(&tmp);
    assert!(
        (l[1] == l[0])
            || (l[1] + -a[1] * 1 + -a[4] * 1 + a[3] + -C * 2 + s[4] <= RealNumRep::new(0, 1))
    );
    let tmp = IntervalList::new(vec![
        Interval::interval_point(l[1]),
        Interval::interval_upper(a[2] + -C * 1 + -s[1] * 1 + -B * 1),
    ]);
    ret = ret.intersection(&tmp);
    let tmp = IntervalList::new(vec![Interval::interval_lower(-s[3] * 1 + a[2] + -B * 1)]);
    ret = ret.intersection(&tmp);
    let tmp = IntervalList::new(vec![Interval::interval_lower(
        a[2] + -a[0] * 1 + -C * 2 + -B * 1 + l[0],
    )]);
    ret = ret.intersection(&tmp);
    let tmp = IntervalList::new(vec![
        Interval::interval_point(l[1]),
    ...
    let tmp = IntervalList::new(vec![
        Interval::interval_point(l[1]),
        Interval::interval_upper(a[2] + -s[2] * 1 + -B * 1),
    ]);
    ret = ret.intersection(&tmp);
    let tmp = IntervalList::new(vec![
        Interval::interval_point(l[1] + -a[1] * 1 + a[2] + -C * 1 + -B * 1),
        Interval::interval_lower(l[1] + -a[1] * 1 + a[2] + -C * 1 + -B * 1),
    ]);
    ret = ret.intersection(&tmp);
    let tmp = IntervalList::new(vec![
        Interval::interval_point(l[1]),
        Interval::interval_upper(a[2] + -C * 2 + -s[0] * 1 + -B * 1),
        Interval::interval_upper(l[1] + -a[1] * 1 + a[2] + -C * 1 + -B * 1),
    ]);
    ret = ret.intersection(&tmp);
    if !(!(l[1] == l[0])) {
        let tmp = IntervalList::new(vec![
            Interval::interval_point(l[1]),
            Interval::interval_upper(-a[1] * 1 + a[2] + -C * 1 + l[0]),
        ]);
        ret = ret.intersection(&tmp);
    }
    let tmp = IntervalList::new(vec![Interval::interval_lower(
    ...
    assert!(
        (-s[3] * 1 + C * 2 + s[0] <= RealNumRep::new(0, 1))
            || (-l[1] * 1 + a[1] + -s[3] * 1 + C <= RealNumRep::new(0, 1))
    );
    assert!(-a[0] * 1 + -C * 2 + s[2] + l[0] <= RealNumRep::new(0, 1));
    assert!(-C * 2 + s[2] + -s[1] * 1 <= RealNumRep::new(0, 1));
    assert!(-C * 2 + s[1] + -s[0] * 1 <= RealNumRep::new(0, 1));
    ...
    let tmp = IntervalList::new(vec![
        Interval::interval_lower(a[3] + -s[4] * 1),
        Interval::interval_lower(a[2] + C + -s[4] * 1 + -B * 1),
    ]);
    ret = ret.intersection(&tmp);
    let tmp = IntervalList::new(vec![
        Interval::interval_point(l[1]),
        Interval::interval_upper(-s[3] * 1 + a[2] + C + -B * 1),
    ]);
    ret = ret.intersection(&tmp);
    let tmp = IntervalList::new(vec![
        Interval::interval_point(l[1]),
        Interval::interval_upper(a[2] + C * 2 + -s[4] * 1 + -B * 1),
    ]);
    ret = ret.intersection(&tmp);
    let tmp = IntervalList::new(vec![
        Interval::interval_point(l[1]),
        Interval::interval_upper(a[2] + a[4] + -a[3] * 1 + C + -s[4] * 1),
    ]);
    ret = ret.intersection(&tmp);
    assert!(s[3] + -C * 2 + -s[2] * 1 <= RealNumRep::new(0, 1));
    if !(C * 2 + -s[4] * 1 + s[1] <= RealNumRep::new(0, 1)) {
    ...
    if !((-l[1] * 1 + a[1] + C * 2 + -s[4] * 1 <= RealNumRep::new(0, 1))
    ...
    assert!(s[3] + -C * 4 + -s[0] * 1 <= RealNumRep::new(0, 1));
    assert!(-C * 5 + s[4] + -s[0] * 1 <= RealNumRep::new(0, 1));
    assert!(-s[3] * 1 + -a[4] * 1 + a[3] + -B * 1 + -C * 1 + s[4] <= RealNumRep::new(0, 1));
    assert!(-a[4] * 1 + a[3] + -B * 1 + -C * 2 + s[4] + -s[2] * 1 <= RealNumRep::new(0, 1));
    assert!(l[1] + -a[1] * 1 + -a[4] * 1 + a[3] + -B * 1 + -C * 2 + s[4] <= RealNumRep::new(0, 1));
    assert!(-a[4] * 1 + a[3] + -B * 1 + -C * 4 + s[4] + -s[0] * 1 <= RealNumRep::new(0, 1));
    assert!(-a[4] * 1 + a[3] + -B * 1 + -C * 3 + s[4] + -s[1] * 1 <= RealNumRep::new(0, 1));
    assert!(-a[4] * 1 + a[3] + -a[0] * 1 + -B * 1 + -C * 3 + s[4] + l[0] <= RealNumRep::new(0, 1));
    assert!(B >= RealNumRep::new(5, 1));
    assert!(C >= RealNumRep::new(5, 1));
    assert!(l[0] >= RealNumRep::new(0, 1));
    assert!(-a[0] * 1 + s[0] + l[0] <= RealNumRep::new(0, 1));
    ...
    assert!(-C * 4 + s[4] + -s[1] * 1 <= RealNumRep::new(0, 1));
    assert!(l[1] + -a[1] * 1 + s[3] + -C * 2 <= RealNumRep::new(0, 1));
    assert!(l[1] + -a[1] * 1 + -C * 3 + s[4] <= RealNumRep::new(0, 1));
    assert!(-s[3] * 1 + -C * 2 + s[4] <= RealNumRep::new(0, 1));
    assert!(-C * 3 + s[4] + -s[2] * 1 <= RealNumRep::new(0, 1));
    let tmp = IntervalList::new(vec![Interval::interval_upper(a[3] + C + -s[4] * 1)]);
    ret = ret.intersection(&tmp);
...
pub fn compute_l_3_t_5_l_3(
    ...
    if !((l[1] == l[0]) || (l[2] == l[1])) {
        let tmp = IntervalList::new(vec![
            ...
            Interval::interval_point(-a[2] * 2 + l[2] * 2 + a[3] + a[1] + -l[1] * 1),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !((l[2] == l[1])
        || (RealNumRep::new(0, 1) <= a[2] * 2 + -l[2] * 1 + -a[3] * 1 + -a[1] * 1 + l[1]))
    {
        let tmp = IntervalList::new(vec![Interval::new(None, None)]);
        ret = ret.intersection(&tmp);
    }
    ...
    assert!(
        (l[1] == l[0])
            || (a[2] + -a[1] * 1 + -s[2] * 1 + s[0] <= RealNumRep::new(0, 1))
            || (!(RealNumRep::new(0, 1) <= -l[2] * 1 + l[1]))
    );
    assert!(
        (a[1] + -l[1] * 1 + -s[2] * 1 <= RealNumRep::new(0, 1))
    ...
    if !((-a[0] * 1 + -s[4] * 1 / 2 + s[1] * 3 / 2 + l[0] <= RealNumRep::new(0, 1))
        || (a[2] + -l[2] * 1 + -a[0] * 1 + -s[4] * 1 + s[1] + l[0] <= RealNumRep::new(0, 1)))
    {
        let tmp = IntervalList::new(vec![Interval::interval_lower(a[3] + -s[4] * 1)]);
        ret = ret.intersection(&tmp);
    }
    ...
    if !((-a[2] * 2 + l[2] * 2 + s[4] + s[1] <= RealNumRep::new(0, 1))
        || (a[2] * 2 + -l[2] * 2 + -s[4] * 2 + s[1] + -s[0] * 1 <= RealNumRep::new(0, 1)))
    {
        let tmp = IntervalList::new(vec![Interval::interval_lower(a[3] + -s[4] * 1)]);
        ret = ret.intersection(&tmp);
    ...
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![Interval::interval_lower(
            -a[2] * 1 + l[2] + a[3] + -s[4] * 1 + s[2],
        )]);
        ret = ret.intersection(&tmp);
    }
    if !((l[1] == l[0])
        || (a[2] + -l[2] * 1 + -a[1] * 1 + -s[4] * 1 + s[2] + l[1] <= RealNumRep::new(0, 1)))
    {
        let tmp = IntervalList::new(vec![Interval::interval_lower(a[3] + -s[4] * 1)]);
        ret = ret.intersection(&tmp);
    }
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_point(l[2]),
            Interval::interval_upper(-a[2] * 2 + l[2] * 2 + a[3] + a[1] + -l[1] * 1),
        ]);
        ret = ret.intersection(&tmp);
    }
    assert!(
    ...
    if !(!(RealNumRep::new(0, 1) <= -l[2] * 1 + l[1])) {
        let tmp = IntervalList::new(vec![
            Interval::interval_point(l[2]),
            Interval::interval_upper(-a[2] * 1 + a[3] + -s[2] * 1 / 3 + s[0] * 1 / 3 + l[1]),
        ]);
        ret = ret.intersection(&tmp);
    }
    let tmp = IntervalList::new(vec![
        Interval::interval_point(l[2]),
        Interval::interval_upper(-a[2] * 1 + l[2] + a[3] + -s[2] * 1 / 3 + s[0] * 1 / 3),
    ]);
    ret = ret.intersection(&tmp);
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![Interval::interval_lower(
            -a[2] * 2 + l[2] * 2 + a[3] + a[1] + -l[1] * 1,
        )]);
        ret = ret.intersection(&tmp);
    }
    if !((l[1] == l[0])
        || (a[2] * 3 + -l[2] * 3 + -a[1] * 3 + -s[4] * 1 + s[0] + l[1] * 3
            <= RealNumRep::new(0, 1)))
    {
        let tmp = IntervalList::new(vec![Interval::interval_lower(a[3] + -s[4] * 1)]);
        ret = ret.intersection(&tmp);
    ...
    if !((l[1] == l[0])
        || (a[2] * 2 + -l[2] * 2 + -a[1] * 2 + -s[4] * 1 + s[1] + l[1] * 2
            <= RealNumRep::new(0, 1)))
    {
        let tmp = IntervalList::new(vec![Interval::interval_lower(a[3] + -s[4] * 1)]);
        ret = ret.intersection(&tmp);
    ...
    if !(!(RealNumRep::new(0, 1) <= -l[2] * 1 + l[1])) {
        let tmp = IntervalList::new(vec![
            Interval::interval_point(l[2]),
            Interval::interval_upper(
                -a[2] * 1 + a[3] + a[0] * 1 / 2 + -s[2] * 1 / 2 + l[1] + -l[0] * 1 / 2,
            ),
        ]);
        ret = ret.intersection(&tmp);
    }
    ...
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(-a[2] * 1 + l[2] + a[3] + -s[4] * 1 / 3 + s[0] * 1 / 3),
            Interval::interval_upper(
    ...
    let tmp = IntervalList::new(vec![
        Interval::interval_point(l[2]),
        Interval::interval_upper(-a[2] * 1 + l[2] + a[3] + -a[1] * 1 + a[0] + l[1] + -l[0] * 1),
    ...
    if !(-s[4] * 1 + s[2] * 3 / 2 + -s[1] * 1 / 2 <= RealNumRep::new(0, 1)) {
        let tmp = IntervalList::new(vec![Interval::interval_lower(a[3] + -s[4] * 1)]);
        ret = ret.intersection(&tmp);
    }
    let tmp = IntervalList::new(vec![
        Interval::interval_point(l[2]),
        Interval::interval_upper(-a[2] * 1 + l[2] + a[3] + -a[1] * 1 + l[1] + s[1]),
    ...
    let tmp = IntervalList::new(vec![
        Interval::interval_point(l[2]),
        Interval::interval_upper(-a[2] * 1 + l[2] + -s[3] * 1 / 3 + a[3] + s[1] * 1 / 3),
    ]);
    ret = ret.intersection(&tmp);
    assert!(
        (l[1] == l[0])
    ...
    let tmp = IntervalList::new(vec![
        ...
        Interval::interval_upper(
            RealNumRep::new(-5, 1) + -a[2] * 1 / 2 + l[2] * 1 / 2 + a[3] + -s[4] * 1 / 2,
        ),
    ]);
    ret = ret.intersection(&tmp);
    if !(RealNumRep::new(0, 1) <= -a[2] * 1 + l[2] + -a[0] * 1 + s[1] * 2 + l[0]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_point(l[2]),
            Interval::interval_upper(
                RealNumRep::new(-5, 1) + a[3] + a[0] * 2 + -s[1] * 3 + -l[0] * 2,
            ),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !(!(RealNumRep::new(0, 1) <= -a[2] * 1 + l[2] + -a[0] * 1 + s[1] * 2 + l[0])) {
        let tmp = IntervalList::new(vec![
            Interval::interval_point(l[2]),
            Interval::interval_upper(
                RealNumRep::new(-5, 1) + -a[2] * 1 + l[2] + a[3] + a[0] + -s[1] * 1 + -l[0] * 1,
            ),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(
                -a[2] * 1 + l[2] + a[3] + a[1] * 1 / 2 + -l[1] * 1 / 2 + -s[4] * 1 / 2,
            ),
            Interval::interval_lower(-a[2] * 1 + l[2] + a[3] + -s[4] * 1 / 3 + s[0] * 1 / 3),
        ]);
        ret = ret.intersection(&tmp);
    ...
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![Interval::interval_lower(
            RealNumRep::new(5, 1) + -a[2] * 2 + l[2] * 2 + a[3] + s[1],
        )]);
        ret = ret.intersection(&tmp);
    }
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(
                RealNumRep::new(5, 1) + -a[2] * 2 + l[2] * 2 + a[3] + a[1] + -l[1] * 1,
            ),
            Interval::interval_lower(
                RealNumRep::new(5, 2) + -a[2] * 3 / 2 + l[2] * 3 / 2 + a[3] + s[0] * 1 / 2,
            ),
        ]);
        ret = ret.intersection(&tmp);
    }
    assert!(
        (l[2] == l[1])
            || (-a[2] * 1 + l[2] + s[3] * 2 / 3 + s[0] * 1 / 3 <= RealNumRep::new(-5, 1))
            || (-a[2] * 2 + l[2] * 2 + s[3] + a[1] + -l[1] * 1 <= RealNumRep::new(-10, 1))
    );
    let tmp = IntervalList::new(vec![
        Interval::interval_point(l[2]),
        Interval::interval_upper(-a[2] * 1 + l[2] + a[3] + -a[1] * 1 + l[1] + s[1]),
    ...
    let tmp = IntervalList::new(vec![
        Interval::interval_point(l[2]),
        Interval::interval_upper(a[3] + -a[1] * 1 + -s[2] * 2 / 3 + s[0] * 2 / 3 + l[1]),
        Interval::interval_upper(-a[2] * 2 + l[2] * 2 + a[3] + -a[1] * 1 + s[4] + s[0] + l[1]),
    ]);
    ret = ret.intersection(&tmp);
    let tmp = IntervalList::new(vec![
        Interval::interval_point(l[2]),
    ...
    assert!(
        (RealNumRep::new(0, 1) <= -l[2] * 1 + l[1])
            || (-a[2] * 3 + l[2] * 3 + a[1] * 2 + s[4] + -l[1] * 2 <= RealNumRep::new(-5, 1))
    );
    let tmp = IntervalList::new(vec![
        Interval::interval_point(l[2]),
        Interval::interval_upper(-a[2] * 1 + l[2] + a[3] + -a[1] * 1 + a[0] + l[1] + -l[0] * 1),
    ...
    let tmp = IntervalList::new(vec![
        Interval::interval_point(l[2]),
        Interval::interval_upper(-a[2] * 1 + l[2] + a[3] + -s[1] * 1 / 2 + s[0] * 1 / 2),
    ]);
    ret = ret.intersection(&tmp);
    if !(!(RealNumRep::new(0, 1) <= -l[2] * 1 + l[1])) {
        let tmp = IntervalList::new(vec![
            Interval::interval_point(l[2]),
            Interval::interval_upper(-a[2] * 1 + a[3] + -s[2] * 1 / 2 + s[1] * 1 / 2 + l[1]),
        ]);
        ret = ret.intersection(&tmp);
    }
    assert!(
    ...
    let tmp = IntervalList::new(vec![
        Interval::interval_point(l[2]),
        Interval::interval_upper(
            -a[2] * 1 / 2 + l[2] * 1 / 2 + a[3] + -a[1] * 1 + -s[4] * 1 / 2 + s[2] + l[1],
        ),
    ...
    let tmp = IntervalList::new(vec![
        Interval::interval_point(l[2]),
        Interval::interval_upper(-a[2] * 1 + l[2] + a[3] + -s[4] * 1 / 4 + s[1] * 1 / 4),
    ]);
    ret = ret.intersection(&tmp);
    assert!(
        (l[2] == l[1])
            || (-a[2] * 4 + l[2] * 4 + a[1] * 4 + s[4] + -s[1] * 1 + -l[1] * 4
                <= RealNumRep::new(0, 1))
    );
    let tmp = IntervalList::new(vec![
        Interval::interval_point(l[2]),
        Interval::interval_upper(-a[2] * 1 + l[2] + a[3] + -s[4] * 1 / 3 + s[2] * 1 / 3),
    ]);
    ret = ret.intersection(&tmp);
    let tmp = IntervalList::new(vec![
        Interval::interval_point(l[2]),
        Interval::interval_upper(-a[2] * 1 + l[2] + a[3] + -s[2] * 1 / 2 + s[1] * 1 / 2),
    ]);
    ret = ret.intersection(&tmp);
    let tmp = IntervalList::new(vec![
        Interval::interval_point(l[2]),
        Interval::interval_upper(-a[2] * 1 + l[2] + a[3] + a[1] + -l[1] * 1 + -s[2] * 1),
    ]);
    ret = ret.intersection(&tmp);
    assert!(
        (l[2] == l[1])
            || (-a[2] * 4 + l[2] * 4 + a[1] * 4 + -a[0] * 1 + s[4] + -l[1] * 4 + l[0]
                <= RealNumRep::new(0, 1))
    );
    assert!(
        (l[2] == l[1])
            || (-a[2] * 5 + l[2] * 5 + a[1] * 5 + s[4] + -s[0] * 1 + -l[1] * 5
                <= RealNumRep::new(0, 1))
    );
    let tmp = IntervalList::new(vec![
        Interval::interval_point(l[2]),
        Interval::interval_upper(-a[2] * 1 + l[2] + a[3] + -a[1] * 1 + a[0] + l[1] + -l[0] * 1),
        Interval::interval_upper(-a[2] * 1 + l[2] + a[3] + a[1] + -s[2] * 1 + -l[1] * 1),
    ]);
    ret = ret.intersection(&tmp);
    let tmp = IntervalList::new(vec![
        Interval::interval_point(l[2]),
    ...
    assert!(
        (l[2] == l[1])
            || (-a[2] * 3 + l[2] * 3 + a[1] * 3 + s[4] + -s[2] * 1 + -l[1] * 3
                <= RealNumRep::new(0, 1))
    );
    let tmp = IntervalList::new(vec![
        Interval::interval_point(l[2]),
    ...
    let tmp = IntervalList::new(vec![
        Interval::interval_point(l[2]),
        Interval::interval_upper(-a[2] * 1 + l[2] + -s[3] * 1 / 2 + a[3] + s[2] * 1 / 2),
    ]);
    ret = ret.intersection(&tmp);
    let tmp = IntervalList::new(vec![
        Interval::interval_point(l[2]),
        Interval::interval_upper(
            RealNumRep::new(-5, 2) + -a[2] * 1 / 2 + l[2] * 1 / 2 + a[3] + -s[4] * 1 / 2,
        ),
    ]);
    ret = ret.intersection(&tmp);
    let tmp = IntervalList::new(vec![
        ...
        Interval::interval_upper(a[3] + -a[1] * 1 + -s[1] * 1 + s[0] + l[1]),
        Interval::interval_upper(
            -a[2] * 1 + l[2] + a[3] + -a[1] * 1 + s[2] * 1 / 2 + s[0] * 1 / 2 + l[1],
        ),
    ]);
    ret = ret.intersection(&tmp);
    let tmp = IntervalList::new(vec![
    ...
    assert!(
        (l[1] == l[0])
            || (-a[2] * 1 / 2 + l[2] * 1 / 2 + -a[1] * 1 + s[4] * 1 / 2 + s[0] + l[1]
                <= RealNumRep::new(-5, 1))
    );
    let tmp = IntervalList::new(vec![
        Interval::interval_point(l[2]),
        Interval::interval_upper(
            -a[2] * 1 + l[2] + -s[3] * 1 / 2 + a[3] + a[1] * 1 / 2 + -l[1] * 1 / 2,
        ),
    ]);
    ret = ret.intersection(&tmp);
    let tmp = IntervalList::new(vec![
        Interval::interval_point(l[2]),
        Interval::interval_upper(
            -a[2] * 1 + l[2] + a[3] + a[1] * 1 / 3 + -l[1] * 1 / 3 + -s[4] * 1 / 3,
        ),
    ]);
    ret = ret.intersection(&tmp);
    let tmp = IntervalList::new(vec![
    ...
    let tmp = IntervalList::new(vec![
        Interval::interval_point(l[2]),
        Interval::interval_upper(-a[2] * 1 + l[2] + a[3] + a[0] + -s[1] * 1 + -l[0] * 1),
    ]);
    ret = ret.intersection(&tmp);
    let tmp = IntervalList::new(vec![
        Interval::interval_point(l[2]),
        Interval::interval_upper(
            -a[2] * 1 + l[2] + a[3] + a[0] * 1 / 4 + -s[4] * 1 / 4 + -l[0] * 1 / 4,
        ),
    ]);
    ret = ret.intersection(&tmp);
    let tmp = IntervalList::new(vec![
        Interval::interval_point(l[2]),
        Interval::interval_upper(
            -a[2] * 1 + l[2] + -s[3] * 1 / 3 + a[3] + a[0] * 1 / 3 + -l[0] * 1 / 3,
        ),
    ]);
    ret = ret.intersection(&tmp);
    if !((a[2] + -l[2] * 1 + -s[4] * 1 <= RealNumRep::new(-5, 1))
        || (a[1] * 1 / 2 + -l[1] * 1 / 2 + -s[4] * 1 / 2 <= RealNumRep::new(-5, 1))
        || (-s[4] * 1 + s[0] <= RealNumRep::new(-15, 1)))
    {
        let tmp = IntervalList::new(vec![Interval::interval_lower(a[3] + -s[4] * 1)]);
        ret = ret.intersection(&tmp);
    }
    let tmp = IntervalList::new(vec![
        Interval::interval_point(l[2]),
        Interval::interval_upper(
            -a[2] * 1 + l[2] + a[3] + a[0] * 1 / 2 + -s[2] * 1 / 2 + -l[0] * 1 / 2,
        ),
    ]);
    ret = ret.intersection(&tmp);
    let tmp = IntervalList::new(vec![
        Interval::interval_point(l[2]),
        Interval::interval_upper(-a[2] * 1 + l[2] + a[3] + -s[4] * 1 / 5 + s[0] * 1 / 5),
    ]);
    ret = ret.intersection(&tmp);
    let tmp = IntervalList::new(vec![
        Interval::interval_point(l[2]),
        Interval::interval_upper(-a[2] * 1 + l[2] + -s[3] * 1 / 4 + a[3] + s[0] * 1 / 4),
    ]);
    ret = ret.intersection(&tmp);
    let tmp = IntervalList::new(vec![
        Interval::interval_point(l[2]),
    ...
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![Interval::interval_upper(
            RealNumRep::new(-5, 1) + a[2] + -l[2] * 1 + a[3] + -s[4] * 1 + -s[1] * 1,
        )]);
        ret = ret.intersection(&tmp);
    }
    let tmp = IntervalList::new(vec![
        Interval::interval_point(l[2]),
        Interval::interval_upper(RealNumRep::new(-10, 1) + -a[2] * 1 + l[2] + a[3]),
    ...
    assert!(
        (l[2] == l[1])
            || (-a[2] * 1 + l[2] + s[4] * 1 / 3 + s[1] * 2 / 3 <= RealNumRep::new(-5, 1))
    );
    let tmp = IntervalList::new(vec![
        Interval::interval_point(l[2]),
    ...
    let tmp = IntervalList::new(vec![
        ...
        Interval::interval_upper(
            RealNumRep::new(-5, 1) + -a[2] * 1 + l[2] + a[3] + -s[1] * 1 / 2 + s[0] * 1 / 2,
        ),
    ]);
    ret = ret.intersection(&tmp);
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_upper(
                RealNumRep::new(-5, 1) + a[2] + -l[2] * 1 + a[3] + -a[1] * 1 + -s[4] * 1 + l[1],
            ),
            Interval::interval_upper(
                RealNumRep::new(-5, 2)
                    + a[2] * 1 / 2
    ...
    assert!(
        (l[2] == l[1])
            || (-a[2] * 1 + l[2] + s[4] * 1 / 2 + s[0] * 1 / 2 <= RealNumRep::new(-5, 1))
            || (-a[2] * 3 + l[2] * 3 + a[1] * 2 + -l[1] * 2 + s[4] <= RealNumRep::new(-15, 1))
    );
    let tmp = IntervalList::new(vec![
        Interval::interval_point(l[2]),
...
pub fn compute_sim_l_3_t_5_l_3(
    ...
    assert!((!(RealNumRep::new(0, 1) <= -l[2] * 1 + l[1])) || (l[2] == l[1]));
    assert!((l[1] == l[0]) || (-a[1] * 1 + s[1] + l[1] + B <= RealNumRep::new(0, 1)));
    assert!((l[2] == l[1]) || (-a[2] * 1 + l[2] + s[2] + B <= RealNumRep::new(0, 1)));
    assert!((l[2] == l[1]) || (-a[2] * 1 + l[2] + s[3] + -C * 1 + B <= RealNumRep::new(0, 1)));
    assert!((l[1] == l[0]) || (-a[1] * 1 + C + s[0] + l[1] + B <= RealNumRep::new(0, 1)));
    assert!(a[2] + -l[2] * 1 + -C * 1 + -s[2] * 1 + -B * 1 <= RealNumRep::new(0, 1));
    assert!(a[2] + -l[2] * 1 + -a[0] * 1 + -C * 2 + -B * 1 + l[0] <= RealNumRep::new(0, 1));
    assert!((l[2] == l[1]) || (-a[2] * 1 + l[2] + -C * 2 + s[4] + B <= RealNumRep::new(0, 1)));
    let tmp = IntervalList::new(vec![
        Interval::interval_point(l[2]),
        Interval::interval_upper(-a[2] * 1 + l[2] + a[3] + -C * 1 + B),
    ]);
    ret = ret.intersection(&tmp);
    assert!(a[1] + -s[2] * 1 + -l[1] * 1 + -B * 1 <= RealNumRep::new(0, 1));
    assert!(-C * 3 + s[4] + -s[2] * 1 <= RealNumRep::new(0, 1));
    let tmp = IntervalList::new(vec![
        Interval::interval_point(l[2]),
        Interval::interval_upper(-a[2] * 1 + l[2] + a[3] + -C * 1),
    ]);
    ret = ret.intersection(&tmp);
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(-a[2] * 1 + l[2] + a[3] + -C * 1),
            Interval::interval_point(-a[2] * 1 + l[2] + a[3] + -C * 1),
        ]);
        ret = ret.intersection(&tmp);
    }
    assert!(
    ...
    if !(a[2] + -l[2] * 1 + -s[4] * 1 + C + -B * 1 <= RealNumRep::new(0, 1)) {
        let tmp = IntervalList::new(vec![Interval::interval_lower(
            -a[2] * 1 + l[2] + a[3] + -C * 1 + B,
        )]);
        ret = ret.intersection(&tmp);
    }
    assert!((l[2] == l[1]) || (-a[2] * 1 + l[2] + C + s[1] + B <= RealNumRep::new(0, 1)));
    assert!(a[1] + -a[0] * 1 + -C * 1 + -l[1] * 1 + -B * 1 + l[0] <= RealNumRep::new(0, 1));
    assert!(
        (l[2] == l[1])
            || (-a[2] * 1 + l[2] + a[1] + C + -l[0] * 1 <= RealNumRep::new(0, 1))
            || (!(l[1] == l[0]))
    );
    assert!((l[1] == l[0]) || (-a[1] * 1 + -C * 1 + s[2] + l[1] + B <= RealNumRep::new(0, 1)));
    assert!((l[1] == l[0]) || (s[3] + -a[1] * 1 + -C * 2 + l[1] + B <= RealNumRep::new(0, 1)));
    if !(C + -s[4] * 1 + s[2] <= RealNumRep::new(0, 1)) {
        let tmp = IntervalList::new(vec![Interval::interval_lower(a[3] + -s[4] * 1)]);
        ret = ret.intersection(&tmp);
    }
    ...
    assert!(a[1] + -C * 2 + -s[0] * 1 + -l[1] * 1 + -B * 1 <= RealNumRep::new(0, 1));
    assert!(a[1] + -C * 1 + -s[1] * 1 + -l[1] * 1 + -B * 1 <= RealNumRep::new(0, 1));
    assert!(a[2] + -l[2] * 1 + -C * 2 + -s[1] * 1 + -B * 1 <= RealNumRep::new(0, 1));
    assert!(a[2] + -l[2] * 1 + -C * 3 + -s[0] * 1 + -B * 1 <= RealNumRep::new(0, 1));
    assert!(
        (l[2] == l[1])
            || (-a[2] * 1 + l[2] + C * 2 + s[0] + B <= RealNumRep::new(0, 1))
            || (RealNumRep::new(0, 1) <= a[2] + -l[2] * 1 + -a[1] * 1 + -C * 1 + l[1] + -B * 1)
    );
    assert!(
        (-a[2] * 1 + l[2] + a[1] + C + -l[1] * 1 + B == RealNumRep::new(0, 1))
            || (!(RealNumRep::new(0, 1) <= a[2] + -l[2] * 1 + -a[1] * 1 + -C * 1 + l[1] + -B * 1))
    );
    assert!(-C * 2 + s[1] + -s[0] * 1 <= RealNumRep::new(0, 1));
    let tmp = IntervalList::new(vec![
        Interval::interval_point(l[2]),
        Interval::interval_upper(-s[3] * 1 + a[3] + -B * 1),
    ]);
    ret = ret.intersection(&tmp);
    let tmp = IntervalList::new(vec![
        Interval::interval_point(l[2]),
    ...
    let tmp = IntervalList::new(vec![
        Interval::interval_point(l[2]),
        Interval::interval_upper(a[3] + -a[1] * 1 + -C * 2 + l[1]),
        Interval::interval_upper(-a[2] * 1 + l[2] + a[3] + -C * 1 + -B * 1),
    ]);
    ret = ret.intersection(&tmp);
    assert!((l[1] == l[0]) || (-a[1] * 1 + -C * 3 + s[4] + l[1] + B <= RealNumRep::new(0, 1)));
    if !((a[1] + C * 2 + -s[4] * 1 + -l[1] * 1 + -B * 1 <= RealNumRep::new(0, 1))
        || (RealNumRep::new(0, 1) <= -a[2] * 1 + l[2] + a[1] + C + -l[1] * 1 + -B * 1))
    {
        let tmp = IntervalList::new(vec![Interval::interval_lower(
            a[3] + -a[1] * 1 + -C * 2 + l[1] + B,
        )]);
    ...
    if !(RealNumRep::new(0, 1) <= -a[2] * 1 + l[2] + a[1] + C + -l[1] * 1 + -B * 1) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(a[3] + -s[4] * 1),
            Interval::interval_upper(a[3] + -a[1] * 1 + -C * 2 + l[1] + B),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !(l[1] == l[0]) {
    ...
    if !(RealNumRep::new(0, 1) <= a[2] + -a[3] * 1 + C + B) {
    ...
    assert!(-C * 3 + s[2] + -s[0] * 1 <= RealNumRep::new(0, 1));
    let tmp = IntervalList::new(vec![
        Interval::interval_point(-a[2] * 1 + l[2] + a[3] + -C * 1 + -B * 1),
        Interval::interval_lower(-a[2] * 1 + l[2] + a[3] + -C * 1 + -B * 1),
    ]);
    ret = ret.intersection(&tmp);
    if !((C * 3 + -s[4] * 1 + s[0] <= RealNumRep::new(0, 1))
        || (a[2] + -l[2] * 1 + C + -s[4] * 1 <= RealNumRep::new(0, 1))
        || (!(RealNumRep::new(0, 1) <= -a[2] * 1 + l[2] + a[1] + C + -l[1] * 1)))
    {
        let tmp = IntervalList::new(vec![Interval::interval_lower(a[3] + -s[4] * 1)]);
        ret = ret.intersection(&tmp);
    }
    if !((RealNumRep::new(0, 1) <= -a[2] * 1 + a[1] + C)
        || (C * 3 + -s[4] * 1 + s[0] <= RealNumRep::new(0, 1))
...
pub fn compute_l_4_t_5_l_4(
    ...
    assert!((!(RealNumRep::new(0, 1) <= l[1] + -l[2] * 1)) || (l[2] == l[1]));
    let tmp = IntervalList::new(vec![
        Interval::interval_upper(l[2] + -a[3] * 1 + a[4] + -a[1] * 1 + s[1] + l[1]),
        Interval::interval_point(l[2]),
    ]);
    ret = ret.intersection(&tmp);
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![Interval::interval_lower(
            l[2] + -a[3] * 1 + a[4] + -a[1] * 1 + s[0] + l[1],
        )]);
        ret = ret.intersection(&tmp);
    }
    let tmp = IntervalList::new(vec![
        Interval::interval_upper(l[2] * 2 + -a[3] * 1 + a[4] + -a[2] * 1 + s[2]),
        Interval::interval_point(l[2]),
    ]);
    ret = ret.intersection(&tmp);
    assert!(
    ...
    assert!(
        (a[1] + -s[2] * 1 + -l[1] * 1 <= RealNumRep::new(0, 1))
            || (-l[2] * 1 / 3 + a[3] * 1 / 3 + -s[2] * 1 + s[0] * 2 / 3 <= RealNumRep::new(0, 1))
    );
    assert!(
        (a[1] + -s[2] * 1 + -l[1] * 1 <= RealNumRep::new(0, 1))
            || (-s[2] * 1 + s[0] <= RealNumRep::new(-5, 1))
    ...
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_point(l[2]),
            Interval::interval_upper(
                RealNumRep::new(-5, 1) + l[2] * 2 + -a[3] * 1 + a[4] + -a[2] * 1 + a[1] + -l[1] * 1,
            ),
        ]);
        ret = ret.intersection(&tmp);
    }
    ...
    assert!(
        (a[1] + -s[2] * 1 + -l[1] * 1 <= RealNumRep::new(0, 1))
            || (l[2] + -a[3] * 1 + s[4] + -s[2] * 1 + s[0] <= RealNumRep::new(0, 1))
    );
    let tmp = IntervalList::new(vec![
        Interval::interval_point(l[2]),
        Interval::interval_upper(l[2] + -a[3] * 1 + a[4] + -a[1] * 1 + a[0] + l[1] + -l[0] * 1),
    ]);
    ret = ret.intersection(&tmp);
    assert!(
        (l[2] == l[1])
    ...
    if !(l[1] == l[0]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_point(l[2]),
            Interval::interval_upper(
                RealNumRep::new(-10, 1) + l[2] + -a[3] * 1 + a[4] + a[1] + -s[2] * 1 + -l[1] * 1,
            ),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![Interval::interval_lower(
            l[2] * 3 + -a[3] * 1 + a[4] + -a[2] * 2 + a[1] + s[2] + -l[1] * 1,
        )]);
        ret = ret.intersection(&tmp);
    }
    assert!(
    ...
    assert!(
        (l[1] == l[0])
            || (l[2] + -a[3] * 1 + -a[1] * 1 + s[4] + s[0] + l[1] <= RealNumRep::new(-5, 1))
    );
    assert!(
        (l[2] == l[1])
            || (l[2] * 2 + -a[3] * 1 + -a[2] * 1 + a[1] + s[4] + -l[1] * 1
                <= RealNumRep::new(0, 1))
    );
    let tmp = IntervalList::new(vec![
        Interval::interval_point(l[2]),
        Interval::interval_upper(
            RealNumRep::new(-5, 1) + l[2] + -a[3] * 1 + a[4] + a[1] + -s[2] * 1 + -l[1] * 1,
        ),
    ]);
    ret = ret.intersection(&tmp);
    assert!(
    ...
    let tmp = IntervalList::new(vec![
        Interval::interval_point(l[2]),
        Interval::interval_upper(RealNumRep::new(-10, 1) + l[2] + -a[3] * 1 + a[4]),
    ]);
    ret = ret.intersection(&tmp);
    let tmp = IntervalList::new(vec![
        Interval::interval_point(l[2]),
        Interval::interval_upper(RealNumRep::new(-5, 1) + l[2] + -a[3] * 2 + a[4] + a[2]),
    ]);
    ret = ret.intersection(&tmp);
    assert!(
        (l[2] == l[1])
    ...
    let tmp = IntervalList::new(vec![
        Interval::interval_point(l[2]),
        Interval::interval_upper(
            l[2] + -a[3] * 1 + a[4] + -a[1] * 1 + s[2] * 1 / 2 + s[0] * 1 / 2 + l[1],
        ),
    ]);
    ret = ret.intersection(&tmp);
    let tmp = IntervalList::new(vec![
    ...
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_point(l[2]),
            Interval::interval_upper(-a[3] * 1 + a[4] + a[2] + -a[1] * 2 + s[0] + l[1] * 2),
        ]);
        ret = ret.intersection(&tmp);
    }
    assert!(
    ...
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_point(l[2]),
            Interval::interval_upper(RealNumRep::new(-10, 1) + l[2] + -a[3] * 2 + a[4] + a[2]),
        ]);
        ret = ret.intersection(&tmp);
    }
    let tmp = IntervalList::new(vec![
        Interval::interval_point(l[2]),
        Interval::interval_upper(
            l[2] * 3 / 2 + -a[3] * 3 / 2 + a[4] + -a[1] * 1 + s[2] * 3 / 2 + l[1],
        ),
    ]);
    ret = ret.intersection(&tmp);
    let tmp = IntervalList::new(vec![
        Interval::interval_point(l[2]),
        Interval::interval_upper(l[2] + -a[3] * 2 + a[4] + a[2] + -a[1] * 1 + s[2] + l[1]),
    ]);
    ret = ret.intersection(&tmp);
    let tmp = IntervalList::new(vec![
        Interval::interval_point(l[2]),
        Interval::interval_upper(
            RealNumRep::new(-5, 1) + l[2] + -a[3] * 1 + a[4] + -a[1] * 1 + s[2] + l[1],
        ),
    ]);
    ret = ret.intersection(&tmp);
    assert!(
    ...
    if !(!(l[2] == l[1])) {
        let tmp = IntervalList::new(vec![
            Interval::interval_point(l[2]),
            Interval::interval_upper(-a[3] * 1 + a[4] + -a[2] * 1 + a[1] + l[1]),
        ]);
        ret = ret.intersection(&tmp);
    }
    let tmp = IntervalList::new(vec![
    ...
    ret = ret.intersection(&tmp);
    if !((l[2] == l[1])
        || (l[2] * 2 + -a[3] * 2 + a[4] + -a[2] * 1 + s[4] + s[0] <= RealNumRep::new(0, 1)))
    {
        let tmp = IntervalList::new(vec![
            Interval::new(None, None),
            Interval::interval_lower(l[2] * 2 + -a[3] * 1 + a[4] + -a[2] * 1 + a[1] + -l[1] * 1),
        ]);
        ret = ret.intersection(&tmp);
    }
    assert!(
    ...
    let tmp = IntervalList::new(vec![
        Interval::interval_point(l[2]),
        Interval::interval_upper(l[2] * 2 + -a[3] * 1 + a[4] + -a[2] * 1 + a[1] + -l[1] * 1),
    ]);
    ret = ret.intersection(&tmp);
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(l[2] * 2 + -a[3] * 1 + a[4] + -a[2] * 1 + a[1] + -l[1] * 1),
            Interval::interval_lower(l[2] * 3 + -a[3] * 2 + a[4] + -a[2] * 1 + s[4] + s[0]),
        ]);
        ret = ret.intersection(&tmp);
    }
    assert!(
        (l[2] == l[1])
            || (l[2] * 2 + -a[3] * 1 + -a[2] * 1 + s[4] + s[1] <= RealNumRep::new(-5, 1))
    );
    assert!(
        (l[2] == l[1])
            || (l[2] * 2 + -a[3] * 1 + -a[2] * 1 + a[1] + s[4] + -l[1] * 1
                <= RealNumRep::new(-5, 1))
            || (l[2] * 3 + -a[3] * 2 + -a[2] * 1 + s[4] * 2 + s[0] <= RealNumRep::new(-5, 1))
    );
    let tmp = IntervalList::new(vec![
        Interval::interval_point(l[2]),
        Interval::interval_upper(
    ...
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(l[2] * 2 + -a[3] * 1 + a[4] + -a[2] * 1 + a[1] + -l[1] * 1),
            Interval::interval_lower(
                l[2] * 2 + -a[3] * 1 + a[4] + -a[2] * 1 + s[2] * 1 / 2 + s[0] * 1 / 2,
            ),
        ]);
        ret = ret.intersection(&tmp);
    }
    let tmp = IntervalList::new(vec![
        Interval::interval_point(l[2]),
        Interval::interval_upper(
            RealNumRep::new(-5, 2) + l[2] * 3 / 2 + -a[3] * 1 + a[4] + -a[2] * 1 / 2 + s[1] * 1 / 2,
        ),
    ]);
    ret = ret.intersection(&tmp);
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(l[2] * 2 + -a[3] * 1 + a[4] + -a[2] * 1 + a[1] + -l[1] * 1),
            Interval::interval_lower(
                l[2] * 5 / 3 + -a[3] * 2 / 3 + a[4] + -a[2] * 1 + s[0] * 2 / 3,
            ),
        ]);
        ret = ret.intersection(&tmp);
    }
    ...
    let tmp = IntervalList::new(vec![
        Interval::interval_point(l[2]),
        Interval::interval_upper(
            RealNumRep::new(-5, 1) + l[2] + -a[3] * 1 + a[4] + -s[1] * 1 / 2 + s[0] * 1 / 2,
        ),
    ]);
    ret = ret.intersection(&tmp);
    let tmp = IntervalList::new(vec![
        Interval::interval_point(l[2]),
        Interval::interval_upper(
            RealNumRep::new(-5, 1) + l[2] + -a[3] * 1 + a[4] + a[0] + -s[1] * 1 + -l[0] * 1,
        ),
    ]);
    ret = ret.intersection(&tmp);
    let tmp = IntervalList::new(vec![
    ...
    let tmp = IntervalList::new(vec![
        Interval::interval_point(l[2]),
        Interval::interval_upper(
            RealNumRep::new(-5, 1) + l[2] + -a[3] * 1 + a[4] + -s[2] * 1 / 2 + s[1] * 1 / 2,
        ),
    ]);
    ret = ret.intersection(&tmp);
    let tmp = IntervalList::new(vec![
    ...
    let tmp = IntervalList::new(vec![
        Interval::interval_point(l[2]),
        Interval::interval_upper(
            RealNumRep::new(-5, 1) + l[2] * 4 / 3 + -a[3] * 4 / 3 + a[4] + s[1] * 1 / 3,
        ),
    ]);
    ret = ret.intersection(&tmp);
    let tmp = IntervalList::new(vec![
        Interval::interval_point(l[2]),
        Interval::interval_upper(
            RealNumRep::new(-5, 1) + l[2] + -a[3] * 1 + a[4] + -s[2] * 1 / 3 + s[0] * 1 / 3,
        ),
    ]);
    ret = ret.intersection(&tmp);
    let tmp = IntervalList::new(vec![
        Interval::interval_point(l[2]),
        Interval::interval_upper(
            RealNumRep::new(-5, 1) + l[2] * 3 / 2 + -a[3] * 3 / 2 + a[4] + s[2] * 1 / 2,
        ),
    ]);
    ret = ret.intersection(&tmp);
    let tmp = IntervalList::new(vec![
    ...
    let tmp = IntervalList::new(vec![
        Interval::interval_point(l[2]),
        Interval::interval_upper(
            RealNumRep::new(-5, 1) + l[2] * 5 / 4 + -a[3] * 5 / 4 + a[4] + s[0] * 1 / 4,
        ),
    ]);
    ret = ret.intersection(&tmp);
    assert!(l[0] >= RealNumRep::new(0, 1));
...
pub fn compute_sim_l_4_t_5_l_4(
    ...
    assert!((l[1] == l[0]) || (-a[1] * 1 + s[1] + l[1] + B <= RealNumRep::new(0, 1)));
    assert!((l[1] == l[0]) || (-a[1] * 1 + -C * 1 + s[2] + l[1] + B <= RealNumRep::new(0, 1)));
    if !(!(RealNumRep::new(0, 1) <= a[3] + -a[4] * 1 + C + B)) {
        let tmp = IntervalList::new(vec![Interval::interval_point(l[2])]);
        ret = ret.intersection(&tmp);
    }
    assert!((l[1] == l[0]) || (RealNumRep::new(0, 1) <= -a[2] * 1 + a[1] + C) || (!(l[2] == l[1])));
    assert!((l[1] == l[0]) || (-a[1] * 1 + C + s[0] + l[1] + B <= RealNumRep::new(0, 1)));
    ...
    assert!(l[2] + -a[3] * 1 + -C * 1 + s[4] <= RealNumRep::new(0, 1));
    assert!((l[2] == l[1]) || (!(RealNumRep::new(0, 1) <= l[1] + -l[2] * 1)));
    assert!((l[2] == l[1]) || (-a[2] * 1 + s[2] + l[2] + B <= RealNumRep::new(0, 1)));
    assert!((l[2] == l[1]) || (-a[2] * 1 + C + s[1] + l[2] + B <= RealNumRep::new(0, 1)));
    assert!((l[2] == l[1]) || (a[3] + -a[2] * 1 + -C * 1 + B <= RealNumRep::new(0, 1)));
    ...
    let tmp = IntervalList::new(vec![
        Interval::interval_point(l[2]),
        Interval::interval_point(l[2] + -a[3] * 1 + a[4] + -C * 1 + -B * 1),
    ]);
    ret = ret.intersection(&tmp);
    assert!(-C * 2 + s[1] + -s[0] * 1 <= RealNumRep::new(0, 1));
    assert!(-a[1] * 1 + -C * 1 + s[2] + l[1] <= RealNumRep::new(0, 1));
...
pub fn compute_a_4_3_t_5_l_1(
    ...
    if !(!(RealNumRep::new(0, 1) <= loss_rate_tol)) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(s[3] * 3 + l[0] + -s[2] * 2),
    ...
    if !(!(RealNumRep::new(0, 1) <= loss_rate_tol)) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(-a[0] * 4 / 3 + s[3] * 7 / 3 + l[0] * 7 / 3),
            Interval::interval_lower(
                -a[0] * 2 / 3 + s[3] * 2 / 3 + l[0] * 2 / 3 + a[2] + loss_rate_tol,
            ),
        ]);
        ret = ret.intersection(&tmp);
    }
    ...
    if !(!(RealNumRep::new(0, 1) <= loss_rate_tol)) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(s[3] * 2 + l[0] + -s[0] * 1),
    ...
    if !(!(RealNumRep::new(0, 1) <= loss_rate_tol)) {
        let tmp = IntervalList::new(vec![
            ...
            Interval::interval_lower(RealNumRep::new(35, 1) + l[0] + s[0]),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !(!(RealNumRep::new(0, 1) <= loss_rate_tol)) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(s[3] * 7 / 3 + l[0] + -s[1] * 4 / 3),
    ...
    if !(!(RealNumRep::new(0, 1) <= loss_rate_tol)) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(-a[0] * 1 + s[3] + l[0] + a[1] + loss_rate_tol),
            Interval::interval_lower(-a[0] * 4 / 3 + s[3] * 7 / 3 + l[0] * 7 / 3),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !(!(RealNumRep::new(0, 1) <= loss_rate_tol)) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(-a[0] * 4 / 3 + s[3] * 7 / 3 + l[0] * 7 / 3),
            Interval::interval_lower(
                -a[0] * 1 / 3 + s[3] * 1 / 3 + l[0] * 1 / 3 + a[3] + loss_rate_tol,
            ),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !(!(RealNumRep::new(0, 1) <= loss_rate_tol)) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(-a[0] * 6 + l[0] * 7 + s[1] * 7),
            Interval::interval_lower(-a[0] * 1 + s[3] + l[0] + a[3] + loss_rate_tol),
            Interval::interval_lower(-a[0] * 3 + l[0] * 3 + a[1] + s[1] * 3 + loss_rate_tol),
            Interval::interval_lower(-a[0] * 4 + l[0] * 4 + a[3] + s[1] * 4),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !(!(RealNumRep::new(0, 1) <= loss_rate_tol)) {
    ...
    if !(!(RealNumRep::new(0, 1) <= loss_rate_tol)) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(-a[0] * 5 / 2 + l[0] * 7 / 2 + s[2] * 7 / 2),
            Interval::interval_lower(-a[0] * 1 + s[3] + l[0] + a[3] + loss_rate_tol),
            Interval::interval_lower(
                -a[0] * 3 / 2 + l[0] * 3 / 2 + a[1] + s[2] * 3 / 2 + loss_rate_tol,
            ),
            Interval::interval_lower(-a[0] * 2 + l[0] * 2 + a[3] + s[2] * 2),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !(!(RealNumRep::new(0, 1) <= loss_rate_tol)) {
    ...
    if !(!(RealNumRep::new(0, 1) <= loss_rate_tol)) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(RealNumRep::new(20, 1) + a[3]),
            Interval::interval_lower(RealNumRep::new(5, 1) + a[3] + loss_rate_tol),
            Interval::interval_lower(RealNumRep::new(30, 1) + l[0] + s[1]),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !(!(RealNumRep::new(0, 1) <= loss_rate_tol)) {
    ...
    if !(!(RealNumRep::new(0, 1) <= loss_rate_tol)) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(-a[0] * 5 / 2 + l[0] * 7 / 2 + s[2] * 7 / 2),
            Interval::interval_lower(-a[0] * 1 + l[0] + a[2] + s[2] + loss_rate_tol),
            Interval::interval_lower(-a[0] * 2 + l[0] * 2 + a[3] + s[2] * 2),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !(RealNumRep::new(-5, 1) <= l[0] * 1 / 3 + -a[3] * 1 / 3 + s[0] * 1 / 3) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(RealNumRep::new(35, 1) + l[0] + s[0]),
            Interval::interval_lower(RealNumRep::new(10, 1) + a[2] + loss_rate_tol),
            Interval::interval_upper(RealNumRep::new(10, 1) + a[2]),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !(!(RealNumRep::new(0, 1) <= loss_rate_tol)) {
    ...
    if !((-s[3] * 3 / 2 + -l[0] * 1 + a[3] + s[0] * 1 / 2 <= RealNumRep::new(0, 1))
        || (!(RealNumRep::new(0, 1) <= loss_rate_tol)))
    {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(-a[0] * 5 / 2 + l[0] * 7 / 2 + s[2] * 7 / 2),
            Interval::interval_lower(
                -a[0] * 1 / 2 + l[0] * 1 / 2 + a[3] + s[2] * 1 / 2 + loss_rate_tol,
            ),
        ]);
        ret = ret.intersection(&tmp);
    }
    ...
    if !((!(RealNumRep::new(0, 1) <= loss_rate_tol))
        || (RealNumRep::new(-5, 1) <= l[0] * 1 / 3 + -a[3] * 1 / 3 + s[0] * 1 / 3))
    {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(RealNumRep::new(5, 1) + a[3] + loss_rate_tol),
            Interval::interval_lower(RealNumRep::new(35, 1) + l[0] + s[0]),
    ...
    if !(!(RealNumRep::new(0, 1) <= loss_rate_tol)) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(l[0] + s[1] * 4 + -s[0] * 3),
    ...
    let tmp = IntervalList::new(vec![
        Interval::interval_lower(RealNumRep::new(30, 1) + l[0] + s[1]),
        Interval::interval_lower(RealNumRep::new(15, 1) + a[1] + loss_rate_tol),
        Interval::interval_lower(RealNumRep::new(5, 1) + s[3] + a[3] + -s[2] * 1 + loss_rate_tol),
        Interval::interval_lower(RealNumRep::new(20, 1) + a[3]),
        Interval::interval_upper(RealNumRep::new(15, 1) + a[1]),
    ]);
    ret = ret.intersection(&tmp);
    if !(!(RealNumRep::new(0, 1) <= loss_rate_tol)) {
        let tmp = IntervalList::new(vec![
    ...
    if !((!(RealNumRep::new(0, 1) <= loss_rate_tol))
        || (RealNumRep::new(0, 1) <= s[3] + -a[3] * 1 + a[1] + -s[1] * 1))
    {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(RealNumRep::new(30, 1) + l[0] + s[1]),
            Interval::interval_lower(RealNumRep::new(10, 1) + a[2] + loss_rate_tol),
    ...
    if !(!(RealNumRep::new(0, 1) <= loss_rate_tol)) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(-a[0] * 6 + l[0] * 7 + s[1] * 7),
            Interval::interval_lower(-a[0] * 2 + l[0] * 2 + a[2] + s[1] * 2 + loss_rate_tol),
            Interval::interval_lower(-a[0] * 4 + l[0] * 4 + a[3] + s[1] * 4),
        ]);
        ret = ret.intersection(&tmp);
    }
    ...
    if !(!(RealNumRep::new(0, 1) <= loss_rate_tol)) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(-a[0] * 6 + l[0] * 7 + s[1] * 7),
            Interval::interval_lower(-a[0] * 1 + l[0] + a[3] + s[1] + loss_rate_tol),
            Interval::interval_lower(-a[0] * 4 + l[0] * 4 + a[3] + s[1] * 4),
        ]);
        ret = ret.intersection(&tmp);
    }
    ...
    if !(!(RealNumRep::new(0, 1) <= loss_rate_tol)) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(RealNumRep::new(30, 1) + l[0] + s[1]),
            Interval::interval_lower(RealNumRep::new(15, 1) + a[1] + loss_rate_tol),
            Interval::interval_lower(RealNumRep::new(5, 1) + s[3] + a[3] + -s[1] * 1),
            Interval::interval_lower(s[3] + a[3] + -s[2] * 1 / 2 + -s[0] * 1 / 2 + loss_rate_tol),
        ]);
        ret = ret.intersection(&tmp);
    }
...
pub fn compute_a_4_3_t_5_l_2(
    ...
    if !((l[1] == l[0]) || (!(RealNumRep::new(0, 1) <= loss_rate_tol))) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(l[1] * 2 + -a[1] * 2 + s[3] * 2 + a[2] + loss_rate_tol),
            Interval::interval_lower(
                RealNumRep::new(5, 1) + l[1] + -a[1] * 1 + s[3] + a[3] + loss_rate_tol,
            ),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !((l[1] == l[0])
        || (!(RealNumRep::new(0, 1) <= loss_rate_tol))
        || (!(RealNumRep::new(0, 1) <= l[1] + -a[1] * 1 + -a[3] * 1 + a[2] + s[2])))
    {
        let tmp = IntervalList::new(vec![Interval::interval_lower(
            RealNumRep::new(10, 1) + l[1] + -a[1] * 1 + a[3] + s[2] + loss_rate_tol,
        )]);
        ret = ret.intersection(&tmp);
    }
    if !((l[1] == l[0]) || (!(RealNumRep::new(0, 1) <= loss_rate_tol))) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(l[1] * 2 + -a[1] * 2 + s[3] * 2 + a[2] + loss_rate_tol),
            Interval::interval_lower(
                -l[1] * 1 + a[1] + a[3] + -s[2] * 1 / 2 + -s[0] * 1 / 2 + loss_rate_tol,
            ),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !((l[1] == l[0]) || (!(RealNumRep::new(0, 1) <= loss_rate_tol))) {
        let tmp = IntervalList::new(vec![
            ...
            Interval::interval_lower(-l[1] * 1 + a[1] + a[3] + -a[0] * 1 + loss_rate_tol + l[0]),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !((l[1] == l[0]) || (!(RealNumRep::new(0, 1) <= loss_rate_tol))) {
        let tmp = IntervalList::new(vec![Interval::interval_lower(
            a[1] + s[3] + -a[0] * 1 + loss_rate_tol + l[0],
        )]);
        ret = ret.intersection(&tmp);
    }
    if !((l[1] == l[0])
    ...
    {
        let tmp = IntervalList::new(vec![Interval::interval_lower(
            RealNumRep::new(10, 1) + l[1] * 2 + -a[1] * 2 + a[2] + s[2] * 2 + loss_rate_tol,
        )]);
        ret = ret.intersection(&tmp);
    }
    if !((l[1] == l[0]) || (!(RealNumRep::new(0, 1) <= loss_rate_tol))) {
    ...
    if !((l[1] == l[0]) || (!(RealNumRep::new(0, 1) <= loss_rate_tol))) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(RealNumRep::new(15, 1) + a[1] + loss_rate_tol),
            Interval::interval_lower(
                -l[1] * 1 + a[1] + -s[3] * 1 / 3 + a[3] + -s[0] * 2 / 3 + loss_rate_tol,
            ),
        ]);
        ret = ret.intersection(&tmp);
    }
    ...
    if !((l[1] == l[0]) || (!(RealNumRep::new(0, 1) <= loss_rate_tol))) {
        let tmp = IntervalList::new(vec![Interval::interval_lower(
            a[1] + s[3] * 3 / 2 + -s[2] * 3 / 2 + loss_rate_tol,
        )]);
        ret = ret.intersection(&tmp);
    }
    if !(!(RealNumRep::new(0, 1) <= loss_rate_tol)) {
    ...
    if !(!(RealNumRep::new(0, 1) <= loss_rate_tol)) {
        let tmp = IntervalList::new(vec![
            ...
            Interval::interval_lower(l[1] + -a[1] * 1 + s[3] + a[3] + loss_rate_tol),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !((l[1] == l[0]) || (!(RealNumRep::new(0, 1) <= loss_rate_tol))) {
    ...
    if !((l[1] == l[0]) || (!(RealNumRep::new(0, 1) <= loss_rate_tol))) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(-l[1] * 1 + a[1] + a[3] + -s[1] * 1 + loss_rate_tol),
            Interval::interval_lower(a[2] + s[2] + -s[1] * 1 + loss_rate_tol),
        ]);
        ret = ret.intersection(&tmp);
    }
    ...
    if !(!(RealNumRep::new(0, 1) <= loss_rate_tol)) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(
                RealNumRep::new(5, 1) + l[1] + -a[1] * 1 + a[3] + s[2] + loss_rate_tol,
            ),
            Interval::interval_lower(l[1] * 2 + -a[1] * 2 + a[2] + s[2] * 2 + loss_rate_tol),
            Interval::interval_lower(l[1] * 6 + -a[1] * 5 + s[2] * 6),
            Interval::interval_lower(l[1] * 4 + -a[1] * 4 + a[3] + s[2] * 4),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !(!(RealNumRep::new(0, 1) <= loss_rate_tol)) {
    ...
    if !(!(RealNumRep::new(0, 1) <= loss_rate_tol)) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(l[1] + -a[1] * 1 + s[3] + a[2] + loss_rate_tol),
            Interval::interval_lower(l[1] * 3 + -a[1] * 2 + s[3] * 3),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !(!(RealNumRep::new(0, 1) <= loss_rate_tol)) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(l[1] * 3 + -a[1] * 2 + s[3] * 3),
            Interval::interval_lower(
                l[1] * 1 / 2 + -a[1] * 1 / 2 + s[3] * 1 / 2 + a[3] + loss_rate_tol,
            ),
        ]);
        ret = ret.intersection(&tmp);
    }
    ...
    if !(!(RealNumRep::new(0, 1) <= loss_rate_tol)) {
        let tmp = IntervalList::new(vec![
            ...
            Interval::interval_lower(RealNumRep::new(30, 1) + l[1] + s[1]),
            Interval::interval_lower(
                RealNumRep::new(5, 1) + -l[1] * 1 + a[1] + a[3] + -s[2] * 1 + loss_rate_tol,
            ),
            Interval::interval_lower(RealNumRep::new(20, 1) + a[3]),
        ]);
        ret = ret.intersection(&tmp);
    ...
    if !((!(l[1] == l[0])) || (!(RealNumRep::new(0, 1) <= loss_rate_tol))) {
        let tmp = IntervalList::new(vec![
            ...
            Interval::interval_lower(a[3] + s[2] * 4 / 3 + -s[0] * 4 / 3),
            Interval::interval_lower(l[1] + a[1] + s[2] + -s[0] * 1 + loss_rate_tol + -l[0] * 1),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !((l[1] == l[0]) || (!(RealNumRep::new(0, 1) <= loss_rate_tol))) {
    ...
    if !((l[1] == l[0]) || (!(RealNumRep::new(0, 1) <= loss_rate_tol))) {
        let tmp = IntervalList::new(vec![Interval::interval_lower(
            l[1] + -a[1] * 1 + s[3] + a[3] + loss_rate_tol,
        )]);
        ret = ret.intersection(&tmp);
    }
    if !((l[1] == l[0]) || (!(RealNumRep::new(0, 1) <= loss_rate_tol))) {
    ...
    if !((!(RealNumRep::new(0, 1) <= loss_rate_tol))
        || (!(RealNumRep::new(0, 1) <= a[1] * 2 + -a[2] * 2 + s[2] + -s[1] * 1)))
    {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(RealNumRep::new(35, 1) + l[1] + s[0]),
            Interval::interval_lower(-l[1] * 1 + a[1] + a[3] + -s[1] * 1 + loss_rate_tol),
    ...
    if !((l[1] == l[0])
        || (-l[1] * 2 / 3 + -s[3] * 1 + a[3] * 2 / 3 + s[0] * 1 / 3 <= RealNumRep::new(0, 1))
        || (!(RealNumRep::new(0, 1) <= loss_rate_tol)))
    {
        let tmp = IntervalList::new(vec![Interval::interval_lower(
            a[1] + s[2] * 3 / 2 + -s[1] * 3 / 2 + loss_rate_tol,
        )]);
        ret = ret.intersection(&tmp);
    }
    if !((l[1] == l[0]) || (!(RealNumRep::new(0, 1) <= loss_rate_tol))) {
    ...
    if !(!(RealNumRep::new(0, 1) <= loss_rate_tol)) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(l[1] + s[3] * 7 / 3 + -a[0] * 4 / 3 + l[0] * 4 / 3),
            Interval::interval_lower(a[1] + s[3] + -a[0] * 1 + loss_rate_tol + l[0]),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !(!(RealNumRep::new(0, 1) <= loss_rate_tol)) {
    ...
    if !(!(RealNumRep::new(0, 1) <= loss_rate_tol)) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(l[1] * 6 + -a[1] * 5 + s[2] * 6),
            Interval::interval_lower(l[1] * 4 + -a[1] * 4 + a[3] + s[2] * 4),
            Interval::interval_lower(l[1] + -a[1] * 1 + a[3] + s[2] + loss_rate_tol),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !(!(RealNumRep::new(0, 1) <= loss_rate_tol)) {
...
pub fn compute_a_4_3_t_5_l_3(
    ...
    if !((l[1] == l[0]) || (!(RealNumRep::new(0, 1) <= loss_rate_tol))) {
        let tmp = IntervalList::new(vec![Interval::interval_lower(
            a[2] + -l[2] * 1 + a[3] + -a[1] * 1 + l[1] + loss_rate_tol,
        )]);
        ret = ret.intersection(&tmp);
    }
    assert!((l[2] == l[1]) || (!(RealNumRep::new(0, 1) <= -l[2] * 1 + l[1])));
    ...
    assert!((l[1] == l[0]) || (s[3] + -a[1] * 3 + s[0] * 2 + l[1] * 3 <= RealNumRep::new(-15, 1)));
    assert!(
        (l[1] == l[0])
            || (a[2] + -l[2] * 1 + -a[1] * 1 + -s[2] * 1 + s[0] + l[1] <= RealNumRep::new(0, 1))
    );
    ...
    if !((l[1] == l[0]) || (!(RealNumRep::new(0, 1) <= loss_rate_tol))) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(a[2] * 3 + -l[2] * 2 + -a[1] * 2 + l[1] * 2),
    ...
    if !((l[1] == l[0]) || (!(RealNumRep::new(0, 1) <= loss_rate_tol))) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(a[2] * 3 + -l[2] * 2 + -a[1] * 2 + l[1] * 2),
            Interval::interval_lower(a[2] + -l[2] * 1 + a[3] + -s[2] * 1 + loss_rate_tol),
        ]);
        ret = ret.intersection(&tmp);
    }
    assert!(
    ...
    if !((l[1] == l[0]) || (!(RealNumRep::new(0, 1) <= loss_rate_tol))) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(a[2] * 3 + -l[2] * 2 + -a[1] * 2 + l[1] * 2 + loss_rate_tol),
            Interval::interval_lower(a[3] + a[1] + -a[0] * 1 + -l[1] * 1 + loss_rate_tol + l[0]),
        ]);
        ret = ret.intersection(&tmp);
    }
    ...
    if !((l[1] == l[0]) || (!(RealNumRep::new(0, 1) <= loss_rate_tol))) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(a[2] * 3 + -l[2] * 2 + -a[1] * 2 + l[1] * 2 + loss_rate_tol),
            Interval::interval_lower(
                RealNumRep::new(5, 1) + a[2] + -l[2] * 1 + a[3] + -a[1] * 1 + l[1] + loss_rate_tol,
            ),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !(!(RealNumRep::new(0, 1) <= loss_rate_tol)) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(a[2] + s[1] * 2 + -s[0] * 2),
            Interval::interval_lower(a[2] + a[1] + -s[0] * 1 + -l[1] * 1 + loss_rate_tol),
            Interval::interval_lower(a[3] + a[1] + -a[0] * 1 + -l[1] * 1 + loss_rate_tol + l[0]),
            Interval::interval_lower(
        ...
        || (!(RealNumRep::new(0, 1) <= loss_rate_tol)))
    {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(a[2] * 3 + -l[2] * 2 + -a[1] * 2 + l[1] * 2),
            Interval::interval_lower(
                -a[2] * 1 + l[2] + a[3] + a[1] * 2 + -s[0] * 1 + -l[1] * 2 + loss_rate_tol,
            ),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !((RealNumRep::new(0, 1) <= -l[2] * 1 + l[1]) || (!(RealNumRep::new(0, 1) <= loss_rate_tol)))
    {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(a[2] + s[3] * 2 / 3 + -s[1] * 2 / 3 + loss_rate_tol),
            Interval::interval_lower(
                RealNumRep::new(5, 2)
                    + a[2] * 1 / 2
                    + -l[2] * 1 / 2
    ...
    if !((RealNumRep::new(0, 1) <= -l[2] * 1 + l[1]) || (!(RealNumRep::new(0, 1) <= loss_rate_tol)))
    {
        let tmp = IntervalList::new(vec![
            ...
            Interval::interval_lower(a[2] + s[3] * 1 / 2 + -s[0] * 1 / 2 + loss_rate_tol),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !((RealNumRep::new(0, 1) <= -l[2] * 1 + l[1]) || (!(RealNumRep::new(0, 1) <= loss_rate_tol)))
    ...
    assert!(
        (l[2] == l[1]) || (-a[2] * 2 + l[2] * 2 + s[1] * 3 + -s[0] * 1 <= RealNumRep::new(-10, 1))
    );
    assert!((l[2] == l[1]) || (-a[2] * 2 + l[2] * 2 + s[3] + s[1] <= RealNumRep::new(-10, 1)));
    assert!(
        (a[1] + -s[2] * 1 + -l[1] * 1 <= RealNumRep::new(0, 1))
            || (-s[2] * 1 + s[0] <= RealNumRep::new(-5, 1))
    );
    if !(!(RealNumRep::new(0, 1) <= loss_rate_tol)) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(-a[2] * 4 + a[3] * 5),
    ...
    if !((!(RealNumRep::new(0, 1) <= loss_rate_tol))
        || (RealNumRep::new(-5, 1) <= -a[2] * 1 + l[2] + s[1]))
    {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(-a[2] * 4 + a[3] * 5),
            Interval::interval_lower(RealNumRep::new(5, 1) + a[3] + loss_rate_tol),
    ...
    assert!(
        (l[2] == l[1])
            || (-a[2] * 1 + l[2] + s[3] * 2 / 3 + s[0] * 1 / 3 <= RealNumRep::new(-5, 1))
            || (-a[2] * 1 + l[2] + s[3] * 1 / 2 + a[1] * 1 / 2 + -l[1] * 1 / 2
                <= RealNumRep::new(-5, 1))
    );
    if !((l[1] == l[0]) || (!(RealNumRep::new(0, 1) <= loss_rate_tol))) {
        let tmp = IntervalList::new(vec![Interval::interval_lower(
    ...
    if !(!(RealNumRep::new(0, 1) <= loss_rate_tol)) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(-a[2] * 1 + l[2] + s[3] + a[3] + loss_rate_tol),
            Interval::interval_lower(-a[2] * 4 + l[2] * 5 + s[3] * 5),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !((l[1] == l[0]) || (!(RealNumRep::new(0, 1) <= loss_rate_tol))) {
    ...
    if !((l[1] == l[0]) || (!(RealNumRep::new(0, 1) <= loss_rate_tol))) {
        let tmp = IntervalList::new(vec![Interval::interval_lower(
            -a[2] * 1 + l[2] + s[3] + a[3] + loss_rate_tol,
        )]);
        ret = ret.intersection(&tmp);
    }
    if !((l[1] == l[0]) || (!(RealNumRep::new(0, 1) <= loss_rate_tol))) {
    ...
    if !((l[2] == l[1]) || (!(RealNumRep::new(0, 1) <= loss_rate_tol))) {
        let tmp = IntervalList::new(vec![Interval::interval_lower(
            RealNumRep::new(10, 1) + -a[2] * 1 + l[2] * 2 + s[3] * 2 + loss_rate_tol,
        )]);
        ret = ret.intersection(&tmp);
    }
    if !(!(RealNumRep::new(0, 1) <= loss_rate_tol)) {
        let tmp = IntervalList::new(vec![
            ...
            Interval::interval_lower(l[2] + -a[1] * 5 + s[2] * 6 + l[1] * 5),
            Interval::interval_upper(l[2] + -a[1] * 2 + s[2] * 3 + l[1] * 2 + loss_rate_tol),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !(!(RealNumRep::new(0, 1) <= loss_rate_tol)) {
    ...
    {
        let tmp = IntervalList::new(vec![Interval::interval_lower(
            a[2] + s[3] + -a[1] * 1 + l[1] + loss_rate_tol,
        )]);
        ret = ret.intersection(&tmp);
    }
    if !((RealNumRep::new(0, 1) <= -l[2] * 1 + l[1]) || (!(RealNumRep::new(0, 1) <= loss_rate_tol)))
    ...
    if !(!(RealNumRep::new(0, 1) <= loss_rate_tol)) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(-a[2] * 4 + l[2] * 5 + s[3] * 5),
            Interval::interval_lower(
                RealNumRep::new(5, 1) + -a[2] * 1 + l[2] * 2 + s[3] * 2 + loss_rate_tol,
            ),
        ]);
        ret = ret.intersection(&tmp);
    }
    ...
    if !((-a[2] * 1 + l[2] + a[1] + -l[1] * 1 <= RealNumRep::new(-5, 1))
        || (!(RealNumRep::new(0, 1) <= loss_rate_tol))
        || (RealNumRep::new(-5, 1) <= l[2] * 1 / 3 + -a[3] * 1 / 3 + s[0] * 1 / 3))
    {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(RealNumRep::new(5, 1) + a[3] + loss_rate_tol),
    ...
    if !((RealNumRep::new(0, 1) <= -l[2] * 1 + l[1]) || (!(RealNumRep::new(0, 1) <= loss_rate_tol)))
    {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(a[3] + a[1] + -a[0] * 1 + -l[1] * 1 + loss_rate_tol + l[0]),
            Interval::interval_lower(
                a[2] + s[3] * 2 / 3 + -a[0] * 2 / 3 + loss_rate_tol + l[0] * 2 / 3,
            ),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !((l[2] == l[1]) || (!(RealNumRep::new(0, 1) <= loss_rate_tol))) {
        let tmp = IntervalList::new(vec![Interval::interval_lower(
            RealNumRep::new(5, 1) + -a[2] * 1 + l[2] + s[3] + a[3] + loss_rate_tol,
        )]);
        ret = ret.intersection(&tmp);
    }
    if !(!(RealNumRep::new(0, 1) <= loss_rate_tol)) {
    ...
    if !(!(RealNumRep::new(0, 1) <= loss_rate_tol)) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(a[2] + -l[2] * 1 + a[3] + -a[1] * 1 + l[1] + loss_rate_tol),
            Interval::interval_lower(a[3] + -a[0] * 4 + s[1] * 4 + l[0] * 4),
            Interval::interval_lower(a[2] + -a[0] * 2 + s[1] * 2 + loss_rate_tol + l[0] * 2),
            Interval::interval_lower(l[2] + -a[0] * 6 + s[1] * 7 + l[0] * 6),
            Interval::interval_lower(a[2] + -a[0] * 5 + s[1] * 5 + l[0] * 5),
    ...
    if !((l[1] == l[0]) || (!(RealNumRep::new(0, 1) <= loss_rate_tol))) {
        let tmp = IntervalList::new(vec![Interval::interval_lower(
            -a[2] * 1 + l[2] * 2 + s[3] * 2 + a[1] + -s[2] * 1 + -l[1] * 1 + loss_rate_tol,
        )]);
        ret = ret.intersection(&tmp);
    }
    if !(!(RealNumRep::new(0, 1) <= loss_rate_tol)) {
    ...
    if !((a[2] + -a[3] * 1 <= RealNumRep::new(-5, 1))
        || (!(RealNumRep::new(0, 1) <= loss_rate_tol)))
    {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(a[3] + a[1] + -a[0] * 1 + -l[1] * 1 + loss_rate_tol + l[0]),
    ...
    if !(!(RealNumRep::new(0, 1) <= loss_rate_tol)) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(a[2] + s[3] + -a[1] * 1 + l[1] + loss_rate_tol),
            Interval::interval_lower(l[2] + s[3] * 3 + -a[1] * 2 + l[1] * 2),
        ]);
        ret = ret.intersection(&tmp);
    }
    ...
    if !((RealNumRep::new(0, 1) <= -l[2] * 1 + l[1]) || (!(RealNumRep::new(0, 1) <= loss_rate_tol)))
    {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(a[2] + -l[2] * 1 + a[3] + -a[1] * 1 + l[1] + loss_rate_tol),
            Interval::interval_lower(a[2] + -a[1] * 2 + s[2] * 2 + l[1] * 2 + loss_rate_tol),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !((RealNumRep::new(0, 1) <= -l[2] * 1 + l[1]) || (!(RealNumRep::new(0, 1) <= loss_rate_tol)))
    ...
    if !((-a[2] * 1 + l[2] + a[1] + -l[1] * 1 <= RealNumRep::new(-5, 1))
        || (!(RealNumRep::new(0, 1) <= loss_rate_tol))
        || (!(-a[2] * 1 + l[2] + s[2] <= RealNumRep::new(-5, 1)))
        || (!(RealNumRep::new(-5, 1) <= l[2] * 1 / 3 + -a[3] * 1 / 3 + s[0] * 1 / 3)))
    {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(
    ...
    if !((l[1] == l[0])
        || (a[2] * 2 + -a[3] * 2 + s[1] + -s[0] * 1 <= RealNumRep::new(0, 1))
        || (!(RealNumRep::new(0, 1) <= loss_rate_tol)))
    {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(
    ...
    if !(!(RealNumRep::new(0, 1) <= loss_rate_tol)) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(a[2] + s[3] + -s[2] * 1 + loss_rate_tol),
            Interval::interval_lower(l[2] + s[3] * 3 + -s[2] * 2),
        ]);
        ret = ret.intersection(&tmp);
    }
    ...
    {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(RealNumRep::new(5, 1) + -a[2] * 1 + a[3] * 2 + loss_rate_tol),
            Interval::interval_lower(
                RealNumRep::new(15, 1) + l[2] + a[1] + -l[1] * 1 + loss_rate_tol,
            ),
            Interval::interval_lower(RealNumRep::new(30, 1) + l[2] + s[1]),
    ...
    if !((l[1] == l[0])
        || (!(RealNumRep::new(0, 1) <= loss_rate_tol))
        || (!(RealNumRep::new(0, 1) <= a[2] + -l[2] * 1 + -s[3] * 1)))
    {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(
                l[2] + s[3] * 3 / 4 + a[1] + -s[0] * 3 / 4 + -l[1] * 1 + loss_rate_tol,
    ...
    if !((l[1] == l[0]) || (!(RealNumRep::new(0, 1) <= loss_rate_tol))) {
        let tmp = IntervalList::new(vec![
            Interval::interval_upper(-a[2] * 4 + -l[2] * 5 + a[3] * 5 + l[1] * 5),
            Interval::interval_lower(a[3] + a[1] + -a[0] * 1 + -l[1] * 1 + loss_rate_tol + l[0]),
            Interval::interval_lower(
                l[2] + a[1] + s[1] * 3 / 2 + -s[0] * 3 / 2 + -l[1] * 1 + loss_rate_tol,
            ),
        ...
        || (!(RealNumRep::new(0, 1) <= loss_rate_tol)))
    {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(a[2] + -l[2] * 1 + a[3] + -a[1] * 1 + l[1] + loss_rate_tol),
            Interval::interval_lower(
                a[2] + l[2] + s[3] * 2 / 3 + -s[1] * 2 / 3 + -l[1] * 1 + loss_rate_tol,
            ),
            Interval::interval_lower(l[2] + s[3] * 7 / 3 + -s[1] * 4 / 3),
        ]);
        ret = ret.intersection(&tmp);
...
pub fn compute_a_4_3_t_5_l_4(
    ...
    if !(!(RealNumRep::new(0, 1) <= loss_rate_tol)) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(a[3] * 5 + -a[2] * 4),
            Interval::interval_lower(RealNumRep::new(5, 1) + a[3] * 2 + -a[2] * 1 + loss_rate_tol),
        ]);
        ret = ret.intersection(&tmp);
    }
    assert!(
    ...
    if !((l[1] == l[0]) || (!(RealNumRep::new(0, 1) <= loss_rate_tol))) {
        let tmp = IntervalList::new(vec![Interval::interval_lower(
            RealNumRep::new(5, 1) + a[3] + a[2] + -a[1] * 1 + -l[2] * 1 + l[1] + loss_rate_tol,
        )]);
        ret = ret.intersection(&tmp);
    }
    if !(!(RealNumRep::new(0, 1) <= loss_rate_tol)) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(-l[2] * 2 + a[3] * 3 + -a[1] * 2 + l[1] * 2),
            Interval::interval_lower(a[3] + a[1] + -a[0] * 1 + -l[1] * 1 + loss_rate_tol + l[0]),
        ]);
        ret = ret.intersection(&tmp);
    }
    ...
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(a[3] + a[1] + -a[0] * 1 + -l[1] * 1 + loss_rate_tol + l[0]),
            Interval::interval_upper(a[3] + a[2] * 2 + -a[1] * 1 + -s[2] * 1 + l[1] + -l[2] * 2),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !(l[2] == l[1]) {
        let tmp = IntervalList::new(vec![
            Interval::interval_upper(-l[2] * 2 + a[3] * 3 + -a[1] * 2 + l[1] * 2),
            Interval::interval_lower(a[3] + a[1] + -a[0] * 1 + -l[1] * 1 + loss_rate_tol + l[0]),
        ]);
        ret = ret.intersection(&tmp);
    }
    ...
    if !((l[2] == l[1]) || (!(RealNumRep::new(0, 1) <= loss_rate_tol))) {
        let tmp = IntervalList::new(vec![Interval::interval_lower(
            RealNumRep::new(10, 1) + a[3] * 2 + -a[2] * 1 + loss_rate_tol,
        )]);
        ret = ret.intersection(&tmp);
    }
    assert!(
    ...
    {
        let tmp = IntervalList::new(vec![Interval::interval_lower(
            a[3] + a[1] + -a[0] * 1 + -l[1] * 1 + loss_rate_tol + l[0],
        )]);
        ret = ret.intersection(&tmp);
    }
    if !((l[1] == l[0]) || (!(RealNumRep::new(0, 1) <= loss_rate_tol))) {
    ...
    {
        let tmp = IntervalList::new(vec![Interval::interval_lower(
            a[3] + a[1] + -s[1] * 1 + -l[1] * 1 + loss_rate_tol,
        )]);
        ret = ret.intersection(&tmp);
    }
    if !((RealNumRep::new(0, 1) <= -l[1] * 1 + l[0]) || (!(RealNumRep::new(0, 1) <= loss_rate_tol)))
    {
        let tmp = IntervalList::new(vec![Interval::interval_lower(
            a[3] * 2 + -a[2] * 1 + a[1] + -s[2] * 1 + -l[1] * 1 + loss_rate_tol,
        )]);
        ret = ret.intersection(&tmp);
    }
    if !((RealNumRep::new(0, 1) <= -l[1] * 1 + l[0]) || (!(RealNumRep::new(0, 1) <= loss_rate_tol)))
    {
        let tmp = IntervalList::new(vec![Interval::interval_lower(
            -l[2] * 1 / 2 + a[3] * 3 / 2 + a[1] + -s[2] * 3 / 2 + -l[1] * 1 + loss_rate_tol,
        )]);
        ret = ret.intersection(&tmp);
    }
    if !((l[1] == l[0]) || (!(RealNumRep::new(0, 1) <= loss_rate_tol))) {
        let tmp = IntervalList::new(vec![Interval::interval_lower(
            a[3] + a[2] + -s[2] * 1 + -l[2] * 1 + loss_rate_tol,
        )]);
        ret = ret.intersection(&tmp);
    }
    if !((RealNumRep::new(0, 1) <= l[1] + -l[2] * 1) || (!(RealNumRep::new(0, 1) <= loss_rate_tol)))
    {
        let tmp = IntervalList::new(vec![Interval::interval_lower(
            a[3] + a[2] + -a[1] * 1 + l[1] + -l[2] * 1 + loss_rate_tol,
        )]);
        ret = ret.intersection(&tmp);
    }
    if !((RealNumRep::new(0, 1) <= -l[1] * 1 + l[0]) || (!(RealNumRep::new(0, 1) <= loss_rate_tol)))
    ...
    if !(!(RealNumRep::new(0, 1) <= loss_rate_tol)) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(-l[2] * 4 / 3 + a[3] * 7 / 3 + -a[0] * 4 / 3 + l[0] * 4 / 3),
            Interval::interval_lower(
                RealNumRep::new(5, 1)
                    + -l[2] * 1 / 3
                    + a[3] * 4 / 3
    ...
    if !(!(RealNumRep::new(0, 1) <= loss_rate_tol)) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(-l[2] * 2 + a[3] * 3 + -s[2] * 2),
            Interval::interval_lower(
                RealNumRep::new(5, 1)
                    + -l[2] * 1 / 2
                    + a[3] * 3 / 2
    ...
    if !(!(RealNumRep::new(0, 1) <= loss_rate_tol)) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(a[3] + a[2] + -a[1] * 1 + l[1] + -l[2] * 1 + loss_rate_tol),
            Interval::interval_lower(-l[2] * 4 / 3 + a[3] * 7 / 3 + -s[1] * 4 / 3),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !((!(l[2] == l[1])) || (!(RealNumRep::new(0, 1) <= loss_rate_tol))) {
    ...
    if !(!(RealNumRep::new(0, 1) <= loss_rate_tol)) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(-l[2] * 1 + a[3] * 2 + -s[0] * 1),
            Interval::interval_lower(
                RealNumRep::new(5, 1)
                    + -l[2] * 1 / 4
                    + a[3] * 5 / 4
    ...
    if !((!(l[1] == l[0])) || (!(RealNumRep::new(0, 1) <= loss_rate_tol))) {
        let tmp = IntervalList::new(vec![
            Interval::interval_lower(RealNumRep::new(20, 1) + a[3]),
            Interval::interval_lower(a[3] + a[1] + -s[1] * 1 + loss_rate_tol + -l[0] * 1),
        ]);
        ret = ret.intersection(&tmp);
    }
    if !(!(RealNumRep::new(0, 1) <= loss_rate_tol)) {
    ...
    assert!(l[0] >= RealNumRep::new(0, 1));
    assert!(l[2] + -a[2] * 1 + s[2] <= RealNumRep::new(0, 1));
    let tmp = IntervalList::new(vec![Interval::interval_lower(l[2] + s[3])]);
    ret = ret.intersection(&tmp);
    assert!(l[2] + s[3] + -a[3] * 1 <= RealNumRep::new(0, 1));
    assert!(-a[0] * 1 + s[0] + l[0] <= RealNumRep::new(0, 1));
    assert!(-a[1] * 1 + s[1] + l[1] <= RealNumRep::new(0, 1));
